...
console.log('🧪 Testing Notification Redirect Fix...\n')

// Test 1: Check if meditation-length page sets userId properly
console.log('✅ Test 1: Meditation-length page userId setting')
...
console.log('✅ Test 2: Homepage dual-check system')
