(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function m(e) {
      ...
      let B = I ? n && 'object' == typeof n && n.ref : L,
        z = i.default.useCallback(
          (e) => (
            null !== U && (b.current = (0, f.mountLinkInstance)(e, D, U, F, k, x)),
            () => {
      ...
      return (
        (0, u.isAbsoluteUrl)(K)
          ? (Y.href = K)
          : (I && !S && ('a' !== n.type || 'href' in n.props)) || (Y.href = (0, c.addBasePath)(K)),
        (a = I ? i.default.cloneElement(n, Y) : (0, o.jsx)('a', { ...M, ...Y, children: r })),
      ...
      return ((0, r.useEffect)(() => {
        setTimeout(async () => {
          try {
            ...
            e
              ? (localStorage.setItem('pendingInviteCode', e),
                a({ inviterName: 'Your Partner', inviterImage: '/icons/meditation-1.svg' }))
