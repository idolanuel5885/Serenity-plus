(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function N(e, t, r) {
      if ('pending' === t.status || 'blocked' === t.status) {
        e = t.value;
        var n = t.reason;
        ((t.status = 'resolved_module'), (t.value = r), null !== e && (C(t), w(t, e, n)));
      }
    }
    ...
    function U(e) {
      ...
      try {
        var o = JSON.parse(r, n._fromJSON),
          u = e.value;
        if ((null !== u && ((e.value = null), (e.reason = null), R(u, o)), null !== k)) {
    ...
    function $(e, t, r, n, o, u) {
      if (k) {
        var a = k;
        a.deps++;
      } else a = k = { parent: null, chunk: null, value: null, reason: null, deps: 1, errored: !1 };
      return (
            ...
            for (; a.$$typeof === p; ) {
              ...
              switch (a.status) {
                ...
                default:
                  return (
                    k
                      ? ((k.errored = !0), (k.value = null), (k.reason = a.reason))
                      : (k = {
                          parent: null,
                          chunk: null,
                          value: null,
        ...
        (this._fromJSON =
          ...
          function (e, t) {
            ...
            if ('object' == typeof t && null !== t) {
              if (t[0] === d) {
                if (
                  ((e = { $$typeof: d, type: t[1], key: t[2], ref: null, props: t[3] }), null !== k)
                ) {
    ...
    function et(e, t, r) {
      ...
      ((a[v] = function () {
        ...
        Q(e, t, r ? a[v]() : a, {
          ...
          enqueueModel: function (t) {
            (u === n.length ? (n[u] = A(e, t, !1)) : j(e, n[u], t, !1), u++);
          },
          close: function (t) {
            for (
              o = !0, u === n.length ? (n[u] = A(e, t, !0)) : j(e, n[u], t, !0), u++;
              u < n.length;
    ...
    function ea(e, t, r) {
      ...
      a.read()
        .then(function t(i) {
          var l = i.value;
          if (i.done) r || D(e, Error('Connection closed.'));
          else {
            var c = 0,
              d = u._rowState;
            i = u._rowID;
            for (var p = u._rowTag, h = u._rowLength, v = u._buffer, _ = l.length; c < _; ) {
              var y = -1;
              switch (d) {
                case 0:
                  58 === (y = l[c++]) ? (d = 1) : (i = (i << 4) | (96 < y ? y - 87 : y - 48));
                  continue;
                case 1:
                  84 === (d = l[c]) ||
                  65 === d ||
                  ...
                  continue;
                case 2:
                  44 === (y = l[c++]) ? (d = 4) : (h = (h << 4) | (96 < y ? y - 87 : y - 48));
                  continue;
                case 3:
                  y = l.indexOf(10, c);
                  break;
              ...
              if (-1 < y)
                ((function (e, t, r, n, u) {
                  ...
                  for (var a = e._stringDecoder, i = '', l = 0; l < n.length; l++)
                    i += a.decode(n[l], o);
                  switch (((n = i += a.decode(u)), r)) {
                    case 73:
                      ...
                      } else v ? N(c, v, _) : h.set(d, new E('resolved_module', _, null));
                      break;
                    case 72:
                      switch (
                    ...
                    case 69:
                      ((u = (r = e._chunks).get(t)),
                        ...
                        u ? P(e, u, a) : r.set(t, new E('rejected', null, a)));
                      break;
                    case 84:
                ...
                })(e, i, p, v, (h = new Uint8Array(l.buffer, g, y - c))),
                  (c = y),
                  3 === d && c++,
                  (h = i = p = d = 0),
                  (v.length = 0));
            ...
            function a(e, E) {
              ...
              if ('object' == typeof E) {
                ...
                if (void 0 !== (P = f.get(E)))
                  ...
                  -1 === e.indexOf(':') &&
                    void 0 !== (P = f.get(this)) &&
                    ((e = P + ':' + e), f.set(E, e), void 0 !== r && r.set(e, E));
                if (_(E)) return E;
                ...
                if ('function' == typeof (e = E[v]))
                  return (
                    ...
                    S.next().then(function e(r) {
                      if (r.done) {
                        if (void 0 === r.value) T.append(t + w, 'C');
                        else
                          try {
                        ...
                        try {
                          ...
                          (T.append(t + w, i), S.next().then(e, o));
                        } catch (e) {
                          o(e);
                        }
                    }, o),
  ...
  (e, t, r) => {
    ...
    let l = e.r(12354),
      s = e.r(82604),
      c = 'undefined' != typeof window && (0, s.isBot)(window.navigator.userAgent);
    class f extends u.default.Component {
      ...
      render() {
        return this.state.error && !c
          ? (0, o.jsxs)(o.Fragment, {
              children: [
                (0, o.jsx)(l.HandleISRError, { error: this.state.error }),
  ...
  (e, t, r) => {
    ...
    async function v(e, t) {
      let { flightRouterState: r, nextUrl: n, prefetchKind: u } = t,
        a = {
          [o.RSC_HEADER]: '1',
          [o.NEXT_ROUTER_STATE_TREE_HEADER]: (0, l.prepareFlightRouterStateForRequest)(
            r,
            t.isHmrRefresh,
          ),
        };
      ...
      try {
        ...
        (e = new URL(e)).pathname.endsWith('/')
          ...
          : (e.pathname += '.txt');
        let r = await _(e, a, t, h.signal),
          n = (0, f.urlToUrlWithoutFlightMarker)(new URL(r.url)),
          d = r.redirected ? n : void 0,
          v = r.headers.get('content-type') || '',
          g = !!(null == (c = r.headers.get('vary')) ? void 0 : c.includes(o.NEXT_URL)),
          b = !!r.headers.get(o.NEXT_DID_POSTPONE_HEADER),
          m = r.headers.get(o.NEXT_ROUTER_STALE_TIME_HEADER),
          E = null !== m ? 1e3 * parseInt(m, 10) : -1,
          O = v.startsWith(o.RSC_CONTENT_TYPE_HEADER);
        if ((O || (O = v.startsWith('text/plain')), !O || !r.ok || !r.body))
        ...
        let R = b
            ...
            : r.body,
          S = await y(R);
        if ((0, s.getAppBuildId)() !== S.b) return p(r.url);
        return {
    ...
    async function _(e, t, r, n) {
      ...
      let a = await fetch(u, {
        ...
        l = new URL(a.url, u);
      return (
        l.searchParams.delete(o.NEXT_RSC_UNION_QUERY),
        { url: l.href, redirected: i, ok: a.ok, headers: a.headers, body: a.body, status: a.status }
      );
    }
    function y(e) {
