(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    ((r.isValid = function (t) {
      ...
      (r.getPenaltyN1 = function (t) {
        ...
        for (let l = 0; l < e; l++) {
          ...
          for (let u = 0; u < e; u++) {
            let e = t.get(l, u);
            (e === a ? o++ : (o >= 5 && (r += n.N1 + (o - 5)), (a = e), (o = 1)),
              (e = t.get(u, l)) === s ? i++ : (i >= 5 && (r += n.N1 + (i - 5)), (s = e), (i = 1)));
          }
  ...
  (t, e, r) => {
    ...
    (!(function () {
      let t = 1;
      for (let e = 0; e < 255; e++) ((n[e] = t), (o[t] = e), 256 & (t <<= 1) && (t ^= 285));
    ...
    var n = {
      single_source_shortest_paths: function (t, e, r) {
        ...
        for (f.push(e, 0); !f.empty(); )
          for (a in ((i = (o = f.pop()).value), (s = o.cost), (l = t[i] || {})))
            l.hasOwnProperty(a) &&
              ((u = s + l[a]),
              (c = d[a]),
              (void 0 === d[a] || c > u) && ((d[a] = u), f.push(a, u), (h[a] = i)));
  ...
  (t, e, r) => {
    ...
    function f(t) {
      let e,
        r,
        o = d(l.NUMERIC, n.NUMERIC, t),
        i = d(l.ALPHANUMERIC, n.ALPHANUMERIC, t);
      return (
        u.isKanjiModeEnabled()
          ? ((e = d(l.BYTE, n.BYTE, t)), (r = d(l.KANJI, n.KANJI, t)))
          : ((e = d(l.BYTE_KANJI, n.BYTE, t)), (r = [])),
        o
          .concat(i, e, r)
          .sort(function (t, e) {
    ...
    ((r.fromArray = function (t) {
              ...
              for (let t = 0; t < s.length; t++) {
                ...
                for (let t = 0; t < i.length; t++) {
                  ...
                  r[a] && r[a].node.mode === u.mode
                    ? ((o[a][c] = g(r[a].lastCount + u.length, u.mode) - g(r[a].lastCount, u.mode)),
      ...
      (r.rawSplit = function (t) {
        return r.fromArray(f(t, u.isKanjiModeEnabled()));
      }));
  },
  30671,
  (t, e, r) => {
    ...
    r.create = function (t, e) {
      ...
      return (
        ...
        (function (t, e, r, o) {
          let f;
          if (Array.isArray(t)) f = p.fromArray(t);
          else if ('string' == typeof t) {
            let n = e;
            if (!n) {
              let e = p.rawSplit(t);
              n = d.getBestVersionForData(e, r);
            }
            f = p.fromString(t, n || 40);
          } else throw Error('Invalid data');
          let y = d.getBestVersionForData(f, r);
          ...
          let w = (function (t, e, r) {
              ...
              return (function (t, e, r) {
                ...
                let b = new Uint8Array(a),
                  v = 0;
                for (o = 0; o < N; o++)
                  for (i = 0; i < l; i++) o < E[i].length && (b[v++] = E[i][o]);
                for (o = 0; o < m; o++) for (i = 0; i < l; i++) b[v++] = x[i][o];
                return b;
              })(o, t, e);
            })(e, r, f),
          ...
          return (
            ...
            u.applyMask(o, E),
            m(E, r, o),
            { modules: E, version: e, errorCorrectionLevel: r, maskPattern: o, segments: f }
          );
        })(t, r, y, f)
      );
    };
        ...
        for (let e = 0; e < s; e++)
          for (let r = 0; r < s; r++) {
            ...
            (e >= l &&
              ...
              e < s - l &&
              r < s - l &&
              (h = u[+!!i[Math.floor((e - l) / a) * o + Math.floor((r - l) / a)]]),
              (t[c++] = h.r),
              (t[c++] = h.g),
              (t[c++] = h.b),
              (t[c] = h.a));
        ...
        (0, r.useEffect)(() => {
          (async () => {
            try {
              ...
              if (t) {
                let e = ['demo123', 'test456', 'sample789'],
                  r = e[(parseInt(t.slice(-1)) || 0) % e.length];
                (i(r),
                  localStorage.setItem('userInviteCode', r),
                  console.log('Created invite code:', r));
              } else i('demo123');
            } catch (t) {
              (console.error('Error getting invite code:', t), i('demo123'));
            }
          })();
        }, []),
        (0, r.useEffect)(() => {
          let e = async () => {
            try {
              let e = ''.concat(window.location.origin, '/join/').concat(t),
                r = await o.default.toDataURL(e, {
                  width: 192,
                  margin: 2,
              ...
              console.error('Error generating QR code:', t);
            }
          };
          t && e();
        }, [t]),
          ...
          children: [
            (0, e.jsxs)('div', {
              ...
              children: [
                ...
                (0, e.jsx)('h1', { className: 'text-xl font-bold', children: 'Invite Partners' }),
              ],
            }),
            (0, e.jsxs)('div', {
              ...
              children: [
                (0, e.jsxs)('div', {
                  ...
                  children: [
                    (0, e.jsx)('h2', {
                      ...
                      children: 'Invite Your Meditation Partners',
                    }),
                    (0, e.jsx)('p', {
                      className: 'text-gray-600',
                      children: "Share this link with a person you'd like to meditate with.",
                    }),
                  ],
                }),
                (0, e.jsxs)('div', {
                  ...
                  children: [
                    (0, e.jsx)('h3', { className: 'font-semibold', children: 'Your Invite Link' }),
                    (0, e.jsxs)('div', {
                      className: 'flex items-center gap-2',
                      children: [
                        (0, e.jsx)('input', {
                          type: 'text',
                          value: ''.concat(window.location.origin, '/join/').concat(t),
                          readOnly: !0,
                          className:
                            'flex-1 p-3 border border-gray-300 rounded-lg bg-white text-sm',
                        }),
                        (0, e.jsx)('button', {
                          onClick: () => {
                            (navigator.clipboard.writeText(
                              ''.concat(window.location.origin, '/join/').concat(t),
                            ),
                              s(!0),
                              setTimeout(() => s(!1), 2e3));
                          },
                          className:
                            'px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors',
                ...
                (0, e.jsxs)('div', {
                  ...
                  children: [
                    (0, e.jsx)('h3', {
                      ...
                      children: 'Or share via QR Code',
                    }),
                    (0, e.jsx)('div', {
                      className:
                        'w-48 h-48 mx-auto bg-white rounded-lg border-2 border-gray-200 flex items-center justify-center',
                      children: l
                        ? (0, e.jsx)('img', { src: l, alt: 'QR Code', className: 'w-44 h-44' })
                        : (0, e.jsx)('span', {
                    ...
                    (0, e.jsx)('p', {
                      className: 'text-sm text-gray-500',
                      children: "Scan this code with your phone's camera",
                    }),
                  ],
                }),
                (0, e.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, e.jsxs)('ol', {
                      ...
                      children: [
                        (0, e.jsx)('li', {
                          children: '1. Share the link or QR code with your meditation partners',
                        }),
                        (0, e.jsx)('li', {
                          children:
                            "2. They'll create an account and complete their own meditation plan",
                        }),
                        (0, e.jsx)('li', {
                          children:
                            "3. Once they accept, you'll be connected as accountability partners",
                        }),
                        (0, e.jsx)('li', {
                          children: '4. Start meditating together and supporting each other!',
                        }),
                      ],
                    }),
                  ],
                ...
                (0, e.jsx)('div', {
                  ...
                  children: (0, e.jsx)(n.default, {
                    href: '/',
                    className:
                      'inline-block bg-gray-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-700 transition-colors',
