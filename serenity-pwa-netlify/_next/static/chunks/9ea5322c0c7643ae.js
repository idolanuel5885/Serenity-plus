(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    async function o(e) {
      ...
      if (p && p !== s && 'refresh' === h && !c.has(p)) {
        ...
        let e = (0, l.fetchServerResponse)(new URL(p, location.origin), {
          ...
          let { flightData: r } = e;
          if ('string' != typeof r) for (let e of r) (0, n.applyFlightData)(t, u, u, e);
        });
        y.push(e);
      }
      for (let e in d) {
  ...
  (e, t, r) => {
    ...
    function i(e) {
      ...
      if (r === l.DEFAULT_SEGMENT_KEY || n.INTERCEPTION_ROUTE_MARKERS.some((e) => r.startsWith(e)))
        return;
  ...
  (e, t, r) => {
    ...
    class c {
      enqueue(e) {
        ...
        return (n._(this, o)[o].push({ promiseFn: l, task: a }), n._(this, i)[i](), l);
      }
      bump(e) {
  ...
  (e, t, r) => {
    ...
    function i(e) {
      let { url: t, nextUrl: r, tree: n, prefetchCache: a, kind: o, allowAliasing: i = !0 } = e,
      ...
      return c
        ? ((c.status = h(c)),
          ...
          c)
        : f({ tree: n, url: t, nextUrl: r, prefetchCache: a, kind: o || l.PrefetchKind.TEMPORARY });
    }
    function c(e) {
    ...
    function f(e) {
      let { url: t, kind: r, tree: u, nextUrl: i, prefetchCache: c } = e,
        ...
        s = a.prefetchQueue.enqueue(() =>
          (0, n.fetchServerResponse)(t, { flightRouterState: u, nextUrl: i, prefetchKind: r }).then(
            (e) => {
              let r;
              if (
  ...
  (e, t, r) => {
    ...
    function P(e, t) {
      let r = p.get(e);
      void 0 !== r &&
        ((r.isVisible = t), t ? h.add(r) : h.delete(r), E(r, l.PrefetchPriority.Default));
    }
    function m(e, t) {
      let r = p.get(e);
  ...
  (e, t, r) => {
    ...
    function c(e) {
      let { children: t, errorComponent: r, errorStyles: n, errorScripts: o } = e;
      return i
    ...
    function L(e) {
      ...
      (0, u.useEffect)(() => {
        ...
        ((window.history.pushState = function (t, n, l) {
          return (
            (null == t ? void 0 : t.__NA) || (null == t ? void 0 : t._N) || ((t = x(t)), l && r(l)),
            e(t, n, l)
          );
        }),
      ...
      let { cache: M, tree: A, nextUrl: N, focusAndScrollRef: L } = c,
        ...
        F = (0, u.useMemo)(
          () => ({ parentTree: A, parentCacheNode: M, parentSegmentPath: null, url: d }),
          [A, M, d],
        ),
        k = (0, u.useMemo)(() => ({ tree: A, focusAndScrollRef: L, nextUrl: N }), [A, L, N]);
      if (null !== I) {
        let [e, r, n] = I;
        t = (0, a.jsx)(U, { headCacheNode: e }, 'undefined' == typeof window ? n : r);
      } else t = null;
      ...
      return (
        (K = (0, a.jsx)(T.default, { errorComponent: l[0], errorStyles: l[1], children: K })),
        (0, a.jsxs)(a.Fragment, {
          children: [
  ...
  (e, t, r) => {
    ...
    function c(e, t, r, u, o, c, d, p, h) {
      return (function e(t, r, u, o, c, d, p, h, y, g, _) {
        ...
        return { route: s(o, E), node: w, dynamicRequestTree: T ? s(o, j) : null, children: O };
      })(e, t, r, u, !1, o, c, d, p, [], h);
    }
                      ...
                      null !== i &&
                        ((function e(t, r, n, u, o) {
                          ...
                          for (let t in i) {
                            ...
                            void 0 !== g &&
                              (void 0 !== n && (0, l.matchSegment)(p, n[0]) && null != u
                                ? e(g, r, n, u, o)
                                : y(r, g, null));
                          }
                          let d = t.rsc,
            ...
            (function e(t, r, l, a, u) {
              if (0 !== Object.keys(a[1]).length)
                for (let i in a[1]) {
                  ...
                  (h ? h.set(d, c) : r.parallelRoutes.set(i, new Map([[d, c]])), e(t, c, l, f, p));
                }
            })(e, P, g, r, u));
        } else
          ((P.rsc = g.rsc),
            ...
            return (
              ...
              N.then(
                (d) => {
                  ...
                  if (w && t.canonicalUrl.split('#', 1)[0] === x.split('#', 1)[0])
                    return (
                      (j.onlyHashChange = !0),
                      (j.canonicalUrl = x),
                      (j.shouldScroll = O),
                  ...
                  for (let e of g) {
                    ...
                    if (
                      (null === O && (O = (0, u.applyRouterStatePatchToTree)(m, C, v, S)),
                      null !== O)
                    ) {
                      if (l && g && E) {
                        let e = (0, y.startPPRNavigation)(T, L, U, v, l, f, d, !1, I);
                        if (null !== e) {
                        ...
                        let n = (0, p.createEmptyCacheNode)(),
                          l = !1;
                        for (let t of (A.status !== c.PrefetchCacheEntryStatus.stale || N
                        ...
                        (0, o.shouldHardNavigate)(m, U)
                          ? ((n.rsc = L.rsc),
                            ...
                            (0, a.invalidateCacheBelowFlightSegmentPath)(n, L, r),
                            (j.cache = n))
                          : l && ((j.cache = n), (L = n)),
                        b(v))) {
                          let e = [...r, ...t];
    ...
    function f(e, t) {
      ...
      for (let t of r) {
        let { segmentPath: r, tree: i } = t,
          y = (0, l.applyRouterStatePatchToTree)(['', ...r], p, i, e.canonicalUrl);
        if (null === y) return e;
          ...
          for (let r of ((_.lazyData = null), n)) {
            ...
            if ((f && (h.canonicalUrl = m), null !== i)) {
              ...
              ((_.rsc = e),
                (_.prefetchRsc = null),
                (_.loading = t),
                (0, c.fillLazyItemsTillLeafWithHead)(R, _, void 0, n, i, d, void 0),
      ...
      return S(e, u, t).then(
        async (c) => {
          ...
          if (
            ...
            return (r(b), w) ? (0, s.handleExternalUrl)(e, l, w.href, e.pushRef.pendingPush) : e;
          if ('string' == typeof j)
            return (r(b), (0, s.handleExternalUrl)(e, l, j, e.pushRef.pendingPush));
          ...
          for (let n of j) {
            ...
            if ((0, p.isNavigatingToNewRootLayout)(a, P))
              return (
                r(b),
                (0, s.handleExternalUrl)(e, l, _ || e.canonicalUrl, e.pushRef.pendingPush)
              );
            if (null !== c) {
              let t = c[1],
              ...
              ((r.rsc = t),
                (r.prefetchRsc = null),
                (r.loading = c[3]),
                (0, y.fillLazyItemsTillLeafWithHead)(o, r, void 0, i, c, f, void 0),
                (l.cache = r),
  ...
  (e, t, r) => {
    ...
    function R(e, t) {
      let r = _();
      (null !== r && r(e, 'traverse'),
        (0, o.dispatchAppRouterAction)({ type: n.ACTION_RESTORE, url: new URL(e), tree: t }));
    }
    let b = {
