(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    !(function () {
          ...
          72: function (e, t, r) {
            ...
            ((o.isBuffer = function (e) {
              ...
              (o.prototype.compare = function (e, t, r, n, i) {
                if ((x(e, Uint8Array) && (e = o.from(e, e.offset, e.byteLength)), !o.isBuffer(e)))
                  throw TypeError(
            ...
            ((o.prototype.write = function (e, t, r, n) {
              ...
              for (var d = !1; ; )
                switch (n) {
                  ...
                  case 'utf8':
                  case 'utf-8':
                    return ((i = t), (s = r), D(S(e, this.length - i), this, i, s));
                  case 'ascii':
                    return ((a = t), (o = r), D(C(e), this, a, o));
                  case 'latin1':
                  case 'binary':
                    return (function (e, t, r, n) {
                      return D(C(t), e, r, n);
          ...
          783: function (e, t) {
            ((t.read = function (e, t, r, n, i) {
              var s,
                ...
                d = e[t + c];
              for (
                c += f, s = d & ((1 << -u) - 1), d >>= -u, u += o;
                u > 0;
                s = 256 * s + e[t + c], c += f, u -= 8
              );
              for (
                a = s & ((1 << -u) - 1), s >>= -u, u += n;
                u > 0;
              ...
              (t.write = function (e, t, r, n, i, s) {
                ...
                for (
                  isNaN((t = Math.abs(t))) || t === 1 / 0
                    ...
                    : ((a = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      a + c >= 1 ? (t += f / l) : (t += f * Math.pow(2, 1 - c)),
                      t * l >= 2 && (a++, (l /= 2)),
                      a + c >= u
                        ? ((o = 0), (a = u))
                        : a + c >= 1
                ...
                for (a = (a << i) | o, h += i; h > 0; e[r + d] = 255 & a, d += p, a /= 256, h -= 8);
                e[r + d - p] |= 128 * g;
              }));
          },
        },
      ...
      ((n.ab = '/ROOT/node_modules/next/dist/compiled/buffer/'), (t.exports = n(72)));
    })();
  },
  98480,
  (e) => {
      ...
      b = function (e) {
        ...
        for (; r < e.length; ) {
          ...
          if (i < 128) t[n++] = String.fromCharCode(i);
            ...
            let s = e[r++],
              a =
                (((7 & i) << 18) | ((63 & s) << 12) | ((63 & e[r++]) << 6) | (63 & e[r++])) - 65536;
      ...
      E = {
        ...
        encodeByteArray(e, t) {
          ...
          for (let t = 0; t < e.length; t += 3) {
            let i = e[t],
              ...
              c = ((15 & a) << 2) | (l >> 6),
              f = 63 & l;
            (!o && ((f = 64), s || (c = 64)), n.push(r[h], r[u], r[c], r[f]));
          }
          return n.join('');
        },
        encodeString(e, t) {
          return this.HAS_NATIVE_SUPPORT && !t ? btoa(e) : this.encodeByteArray(w(e), t);
        },
        decodeString(e, t) {
          return this.HAS_NATIVE_SUPPORT && !t ? atob(e) : b(this.decodeStringToByteArray(e, t));
        },
        decodeStringToByteArray(e, t) {
          ...
          for (let t = 0; t < e.length; ) {
            ...
            if ((++t, null == i || null == s || null == a || null == o)) throw new _();
            let l = (i << 2) | (s >> 4);
            if ((n.push(l), 64 !== a)) {
              let e = ((s << 4) & 240) | (a >> 2);
              if ((n.push(e), 64 !== o)) {
    ...
    let T = function (e) {
      ...
      C = () => {
        try {
          return (
            ('undefined' != typeof self ? self : 'undefined' != typeof window ? window : e.g)
              .__FIREBASE_DEFAULTS__ ||
            (() => {
              if (void 0 === v.default || void 0 === v.default.env) return;
              let e = v.default.env.__FIREBASE_DEFAULTS__;
      ...
      A = () => {
        var e;
        return null == (e = C()) ? void 0 : e.config;
      };
    class D {
      wrapCallback(e) {
        return (t, r) => {
    ...
    class N extends Error {
      constructor(e, t, r) {
        (super(t),
          ...
          Error.captureStackTrace && Error.captureStackTrace(this, k.prototype.create));
      }
    }
    class k {
      create(e) {
        for (var t, r, n = arguments.length, i = Array(n > 1 ? n - 1 : 0), s = 1; s < n; s++)
          i[s - 1] = arguments[s];
        let a = i[0] || {},
          o = ''.concat(this.service, '/').concat(e),
          l = this.errors[e],
          h = l
            ? ((t = l),
              (r = a),
              t.replace(R, (e, t) => {
                let n = r[t];
                return null != n ? String(n) : '<'.concat(t, '?>');
              }))
            : 'Error',
          u = ''.concat(this.serviceName, ': ').concat(h, ' (').concat(o, ').');
        return new N(o, u, a);
      }
      constructor(e, t, r) {
    ...
    class F {
      ...
      setComponent(e) {
        if (e.name !== this.name)
          throw Error(
            'Mismatching Component '.concat(e.name, ' for Provider ').concat(this.name, '.'),
          );
        if (this.component)
      ...
      initialize() {
        ...
        let n = this.getOrInitializeService({ instanceIdentifier: r, options: t });
        for (let [e, t] of this.instancesDeferred.entries())
      ...
      getOrInitializeService(e) {
        var t;
        let { instanceIdentifier: r, options: n = {} } = e,
          i = this.instances.get(r);
        if (
          !i &&
          this.component &&
          ((i = this.component.instanceFactory(this.container, {
            instanceIdentifier: (t = r) === V ? void 0 : t,
            options: n,
          })),
          this.instances.set(r, i),
          this.instancesOptions.set(r, n),
          this.invokeOnInitCallbacks(i, r),
    ...
    class U {
      addComponent(e) {
        ...
        if (t.isComponentSet())
          throw Error(
            'Component '.concat(e.name, ' has already been registered with ').concat(this.name),
          );
        t.setComponent(e);
      }
    ...
    let j = {
      ...
      K = function (e, t) {
        ...
        let s = new Date().toISOString(),
          a = z[t];
        if (a) console[a]('['.concat(s, ']  ').concat(e.name, ':'), ...n);
        else
          throw Error('Attempted to log a message with an invalid logType (value: '.concat(t, ')'));
      };
    class G {
      get logLevel() {
      ...
      set logLevel(e) {
        if (!(e in n)) throw TypeError('Invalid value "'.concat(e, '" assigned to `logLevel`'));
        this._logLevel = e;
      }
      setLogLevel(e) {
    ...
    function $(e) {
            ...
            ? (
              ...
              ? function () {
                  for (var t = arguments.length, r = Array(t), n = 0; n < t; n++)
                    r[n] = arguments[n];
                  return (e.apply(Z(this), r), $(H.get(this)));
                }
              : function () {
                  for (var t = arguments.length, r = Array(t), n = 0; n < t; n++)
                    r[n] = arguments[n];
                  return $(e.apply(Z(this), r));
                }
            : function (t) {
                for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), i = 1; i < r; i++)
                  n[i - 1] = arguments[i];
                let s = e.call(Z(this), t, ...n);
                return (W.set(s, t.sort ? t.sort() : [t]), $(s));
              };
        return (
      ...
      return (n !== e && (X.set(e, n), Y.set(n, e)), n);
    }
    let Z = (e) => Y.get(e),
    ...
    function en(e, t) {
      ...
      let r = t.replace(/FromIndex$/, ''),
        n = t !== r,
        i = et.includes(r);
      if (!(r in (n ? IDBIndex : IDBObjectStore).prototype) || !(i || ee.includes(r))) return;
      let s = async function (e) {
        for (var t = arguments.length, s = Array(t > 1 ? t - 1 : 0), a = 1; a < t; a++)
          s[a - 1] = arguments[a];
        let o = this.transaction(e, i ? 'readwrite' : 'readonly'),
          l = o.store;
        return (n && (l = l.index(s.shift())), (await Promise.all([l[r](...s), i && o.done]))[0]);
      };
      return (er.set(t, s), s);
    }
    J = ((e) => ({
    ...
    function eg(e) {
      let t = e.name;
      if (ef.has(t))
        return (eo.debug('There were multiple attempts to register component '.concat(t, '.')), !1);
      for (let r of (ef.set(t, e), eu.values())) ed(r, e);
      for (let t of ec.values()) ed(t, e);
      return !0;
    }
    function em(e, t) {
      let r = e.container.getProvider('heartbeat').getImmediate({ optional: !0 });
      return (r && r.triggerHeartbeat(), e.container.getProvider(t));
    }
    function ey(e, t) {
      let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : el;
      em(e, t).clearInstance(r);
    }
    function ev(e) {
    ...
    class eT extends e_ {
      ...
      checkDestroyed() {
        if (this.isDeleted) throw eE.create('server-app-deleted');
      }
      constructor(e, t, r, n) {
        let i = void 0 !== t.automaticDataCollectionEnabled && t.automaticDataCollectionEnabled,
    ...
    function eS(e) {
      ...
      let n = Object.assign({ name: el, automaticDataCollectionEnabled: !1 }, t),
        i = n.name;
      if ('string' != typeof i || !i) throw eE.create('bad-app-name', { appName: String(i) });
      if ((r || (r = A()), !r)) throw eE.create('no-options');
      let s = eu.get(i);
      if (s)
        if (L(r, s.options) && L(n, s.config)) return s;
        else throw eE.create('duplicate-app', { appName: i });
      let a = new U(i);
      for (let e of ef.values()) a.addComponent(e);
      let o = new e_(r, n, a);
      return (eu.set(i, o), o);
    }
    function eC(e, t) {
      let r;
      if (('undefined' != typeof window || x()) && !x())
        throw eE.create('invalid-server-app-environment');
      (void 0 === t.automaticDataCollectionEnabled && (t.automaticDataCollectionEnabled = !1),
        (r = ev(e) ? e.options : e));
      let n = Object.assign(Object.assign({}, t), r);
      if (
        (void 0 !== n.releaseOnDeref && delete n.releaseOnDeref,
        void 0 !== t.releaseOnDeref && 'undefined' == typeof FinalizationRegistry)
      )
        throw eE.create('finalization-registry-not-supported', {});
      let i =
          '' + [...JSON.stringify(n)].reduce((e, t) => (Math.imul(31, e) + t.charCodeAt(0)) | 0, 0),
        s = ec.get(i);
      if (s) return (s.incRefCount(t.releaseOnDeref), s);
      let a = new U(i);
      for (let e of ef.values()) a.addComponent(e);
      let o = new eT(r, t, i, a);
      return (ec.set(i, o), o);
    }
    function eA() {
      let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : el,
        t = eu.get(e);
      if (!t && e === el && A()) return eS();
      if (!t) throw eE.create('no-app', { appName: e });
      return t;
    }
    function eD() {
      return Array.from(eu.values());
    }
    async function ex(e) {
      let t = !1,
        r = e.name;
      (eu.has(r)
        ? ((t = !0), eu.delete(r))
        : ec.has(r) && 0 >= e.decRefCount() && (ec.delete(r), (t = !0)),
        t &&
    ...
    function eN(e, t, r) {
      var n;
      let i = null != (n = eh[e]) ? n : e;
      r && (i += '-'.concat(r));
      let s = i.match(/\s|\//),
        a = t.match(/\s|\//);
      if (s || a) {
        let e = ['Unable to register library "'.concat(i, '" with version "').concat(t, '":')];
        (s &&
          e.push('library name "'.concat(i, '" contains illegal characters (whitespace or "/")')),
          s && a && e.push('and'),
          a &&
            e.push('version name "'.concat(t, '" contains illegal characters (whitespace or "/")')),
          eo.warn(e.join(' ')));
        return;
      }
      eg(new P(''.concat(i, '-version'), () => ({ library: i, version: t }), 'VERSION'));
    }
    function ek(e, t) {
      if (null !== e && 'function' != typeof e) throw eE.create('invalid-log-argument');
      for (let r of B) {
        let i = null;
        (t && t.level && (i = j[t.level]),
          null === e
            ? (r.userLogHandler = null)
            : (r.userLogHandler = function (t, r) {
                for (var s = arguments.length, a = Array(s > 2 ? s - 2 : 0), o = 2; o < s; o++)
                  a[o - 2] = arguments[o];
                let l = a
                  .map((e) => {
                  ...
                  .filter((e) => e)
                  .join(' ');
                r >= (null != i ? i : t.logLevel) &&
                  e({ level: n[r].toLowerCase(), message: l, args: a, type: t.name });
              }));
      }
    }
    function eR(e) {
    ...
    let eL = 'firebase-heartbeat-store',
      eO = null;
    function eM() {
      return (
        eO ||
            ...
            return (
              n &&
                a.addEventListener('upgradeneeded', (e) => {
                  n($(a.result), e.oldVersion, e.newVersion, $(a.transaction), e);
                }),
    ...
    async function eP(e) {
      try {
        let t = (await eM()).transaction(eL),
          r = await t.objectStore(eL).get(eF(e));
        return (await t.done, r);
      } catch (e) {
        if (e instanceof N) eo.warn(e.message);
        else {
          let t = eE.create('idb-get', { originalErrorMessage: null == e ? void 0 : e.message });
          eo.warn(t.message);
        }
      }
    }
    async function eV(e, t) {
      try {
        let r = (await eM()).transaction(eL, 'readwrite'),
          n = r.objectStore(eL);
        (await n.put(t, eF(e)), await r.done);
      } catch (e) {
        if (e instanceof N) eo.warn(e.message);
        else {
          let t = eE.create('idb-set', { originalErrorMessage: null == e ? void 0 : e.message });
          eo.warn(t.message);
        }
      }
    }
      ...
      async triggerHeartbeat() {
        ...
        try {
          let r = this.container
            ...
            n = eB();
          if (
            ((null == (e = this._heartbeatsCache) ? void 0 : e.heartbeats) == null &&
              ((this._heartbeatsCache = await this._heartbeatsCachePromise),
              (null == (t = this._heartbeatsCache) ? void 0 : t.heartbeats) == null)) ||
          ...
          let t = eB(),
            { heartbeatsToSend: r, unsentEntries: n } = (function (e) {
              ...
              for (let i of e) {
                ...
                if (e) {
                  if ((e.dates.push(i.date), eq(r) > t)) {
                    e.dates.pop();
                    break;
                  }
                } else if ((r.push({ agent: i.agent, dates: [i.date] }), eq(r) > t)) {
                  r.pop();
                  break;
                }
                n = n.slice(1);
            ...
            i = I(JSON.stringify({ version: 2, heartbeats: r }));
          return (
        ...
        if (await this._canUseIndexedDBPromise) {
          ...
          return eV(this.app, {
            lastSentHeartbeatDate:
              null != (t = e.lastSentHeartbeatDate) ? t : r.lastSentHeartbeatDate,
    ...
    (eg(new P('platform-logger', (e) => new ei(e), 'PRIVATE')),
      eg(new P('heartbeat', (e) => new eU(e), 'PRIVATE')),
      eN(es, ea, ''),
      eN(es, ea, 'esm2017'),
      eN('fire-js', ''),
      eN('firebase', '10.14.1', 'app'),
      e.i(85086));
    var ez = e.i(67034),
      eK =
        'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof window ? window : e.g,
      eG = {};
    (function () {
      function e() {
        ((this.blockSize = -1),
      ...
      function n(e, t, r) {
        ...
        if ('string' == typeof t)
          ...
          for (i = 0; 16 > i; ++i) n[i] = t[r++] | (t[r++] << 8) | (t[r++] << 16) | (t[r++] << 24);
      ...
      ((r.prototype = t.prototype),
        ...
        (e.prototype.v = function () {
          ...
          var r = 8 * this.o;
          for (t = e.length - 8; t < e.length; ++t) ((e[t] = 255 & r), (r /= 256));
      ...
      function u(e) {
        ...
        if (0 > e) return m(u(-e));
        for (var t = [], r = 1, n = 0; e >= r; n++) ((t[n] = (e / r) | 0), (r *= 0x100000000));
        return new a(t, 0);
      }
      var c = h(0),
        f = h(1),
      ...
      function b(e, t) {
        ...
        if (30 < e.g.length) {
          ...
          for (var r = f, n = t; 0 >= n.l(e); ) ((r = E(r)), (n = E(n)));
          var i = _(r, 1),
            s = _(n, 1);
          for (n = _(n, 2), r = _(r, 2); !p(n); ) {
            var a = s.add(n);
            (0 >= a.l(e) && ((i = i.add(r)), (s = a)), (n = _(n, 1)), (r = _(r, 1)));
          }
        ...
        for (i = c; 0 <= e.l(t); ) {
          for (
            n =
              48 >=
              (n = Math.ceil(Math.log((r = Math.max(1, Math.floor(e.m() / t.m())))) / Math.LN2))
                ? 1
                : Math.pow(2, n - 48),
              a = (s = u(r)).j(t);
            g(a) || 0 < a.l(e);
      ...
      (((o = a.prototype).m = function () {
        ...
        (o.toString = function (e) {
          ...
          for (var t = u(Math.pow(e, 6)), r = this, n = ''; ; ) {
            var i = b(r, t).g,
              s = ((0 < (r = y(r, i.j(t))).g.length ? r.g[0] : r.h) >>> 0).toString(e);
            if (p((r = i))) return s + n;
        ...
        (o.add = function (e) {
          for (var t = Math.max(this.g.length, e.g.length), r = [], n = 0, i = 0; i <= t; i++) {
            var s = n + (65535 & this.i(i)) + (65535 & e.i(i)),
              o = (s >>> 16) + (this.i(i) >>> 16) + (e.i(i) >>> 16);
            ((n = o >>> 16), (s &= 65535), (o &= 65535), (r[i] = (o << 16) | s));
          }
        ...
        (o.j = function (e) {
          ...
          if (0 > this.l(d) && 0 > e.l(d)) return u(this.m() * e.m());
          for (var t = this.g.length + e.g.length, r = [], n = 0; n < 2 * t; n++) r[n] = 0;
    ...
    (function () {
      ...
      var A =
        -1 != S().indexOf('Gecko') &&
        (-1 == S().toLowerCase().indexOf('webkit') || -1 != S().indexOf('Edge')) &&
        -1 == S().indexOf('Trident') &&
        -1 == S().indexOf('MSIE') &&
        -1 == S().indexOf('Edge');
      function D(e, t, r) {
      ...
      function k(e, t) {
        ...
        for (let t = 1; t < arguments.length; t++) {
          ...
          for (let t = 0; t < N.length; t++)
            ((r = N[t]), Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]));
        }
      }
      var R = new (class {
        get() {
      ...
      var F = () => {
        ...
        for (
          var t;
          (e = null),
            P.g && ((e = P.g), (P.g = P.g.next), P.g || (P.h = null), (e.next = null)),
            (t = e);
          ...
          (R.j(t), 100 > R.h && (R.h++, (t.next = R.g), (R.g = t)));
        }
        M = !1;
      };
      function U() {
      ...
      var j = (function () {
        ...
        try {
          let e = () => {};
          (p.addEventListener('test', e, t), p.removeEventListener('test', e, t));
        } catch (e) {}
        return e;
      })();
      function q(e, t) {
        if (
          (B.call(this, e ? e.type : ''),
          ...
          ((this.relatedTarget = t),
            ...
            (this.pointerType =
              'string' == typeof e.pointerType ? e.pointerType : z[e.pointerType] || ''),
            (this.state = e.state),
            (this.i = e),
      ...
      function Y(e, t, r, n) {
        for (var i = 0; i < e.length; ++i) {
          var s = e[i];
          if (!s.da && s.listener == t && !!r == s.capture && s.ha == n) return i;
        }
        return -1;
      }
      W.prototype.add = function (e, t, r, n, i) {
        var s = e.toString();
        ...
        return (
          -1 < a
            ? ((t = e[a]), r || (t.fa = !1))
            : (((t = new H(t, this.src, s, !!n, i)).fa = r), e.push(t)),
          t
        );
      };
      ...
      function Z(e, t, r, n, i, s) {
        ...
        var a = m(i) ? !!i.capture : !!i,
          o = en(e);
        if ((o || (e[J] = o = new W(e)), (r = o.add(t, r, n, a, s)).proxy)) return r;
        if (
          ((n = function e(t) {
            return er.call(e.src, e.listener, t);
          }),
          (r.proxy = n),
          (n.src = e),
          (n.listener = r),
          ...
          (j || (i = a), void 0 === i && (i = !1), e.addEventListener(t.toString(), n, i));
        else if (e.attachEvent) e.attachEvent(et(t.toString()), n);
        ...
        if ('number' != typeof e && e && !e.da) {
          ...
          if (t && t[K]) X(t.i, e);
            ...
            (t.removeEventListener
              ...
              : t.detachEvent
                ? t.detachEvent(et(r), n)
                : t.addListener && t.removeListener && t.removeListener(n),
              (r = en(t)) ? (X(r, e), 0 == r.h && ((r.src = null), (t[J] = null))) : Q(e));
          }
        }
      }
      function et(e) {
      ...
      function er(e, t) {
        if (e.da) e = !0;
          ...
          var r = e.listener,
            n = e.ha || e.src;
          (e.fa && ee(e), (e = r.call(n, t)));
        }
        return e;
      }
      function en(e) {
        return (e = e[J]) instanceof W ? e : null;
      }
      ...
      function ea() {
        (U.call(this), (this.i = new W(this)), (this.M = this), (this.F = null));
      }
      function eo(e, t) {
        var r,
          n = e.F;
        if (n) for (r = []; n; n = n.F) r.push(n);
        if (((e = e.M), (n = t.type || t), 'string' == typeof t)) t = new B(t, e);
        else if (t instanceof B) t.target = t.target || e;
        else {
          var i = t;
          k((t = new B(n, e)), i);
        }
        ...
        if (((i = el((a = t.g = e), n, !0, t) && i), (i = el(a, n, !1, t) && i), r))
          for (s = 0; s < r.length; s++) i = el((a = t.g = r[s]), n, !1, t) && i;
      }
      function el(e, t, r, n) {
      ...
      (E(ea, U),
        (ea.prototype[K] = !0),
        (ea.prototype.removeEventListener = function (e, t, r, n) {
          !(function e(t, r, n, i, s) {
            if (Array.isArray(r)) for (var a = 0; a < r.length; a++) e(t, r[a], n, i, s);
            else
              ((i = m(i) ? !!i.capture : !!i), (n = es(n)), t && t[K])
                ? ((t = t.i),
        ...
        (ea.prototype.K = function (e, t, r, n) {
          return this.i.add(String(e), t, !1, r, n);
        }),
        (ea.prototype.L = function (e, t, r, n) {
      ...
      class eu extends U {
        ...
        N() {
          (super.N(),
            this.g && (p.clearTimeout(this.g), (this.g = null), (this.i = !1), (this.h = null)));
        }
        constructor(e, t) {
      ...
      ((ec.prototype.N = function () {
        (ec.aa.N.call(this), ed(this));
      }),
        (ec.prototype.handleEvent = function () {
          throw Error('EventHandler.handleEvent not implemented');
        }));
      var ep = p.JSON.stringify,
        eg = p.JSON.parse,
        em = class {
          stringify(e) {
      ...
      function eD(e, t) {
        (B.call(this, eT.STAT_EVENT, e), (this.stat = t));
      }
      function ex(e) {
        let t = eS();
        eo(t, new eD(t, e));
      ...
      function eN(e, t) {
        (B.call(this, eT.Ma, e), (this.size = t));
      }
      function ek(e, t) {
      ...
      ((eT.La = 'serverreachability'),
        ...
        (eR.prototype.info = function () {}));
      var eO = { NO_ERROR: 0, gb: 1, tb: 2, sb: 3, nb: 4, rb: 5, ub: 6, Ia: 7, TIMEOUT: 8, xb: 9 },
        eM = {
          lb: 'complete',
          Hb: 'success',
          Ja: 'error',
      ...
      function eq(e, t) {
        ...
        (Array.isArray(h) || (h = [String(h)]),
          ...
          0 < e.O && (e.M = new eu(w(e.Y, e, e.g), e.O)),
          (t = e.U),
          (l = e.g),
          (h = e.ca));
        var u = 'readystatechange';
        Array.isArray(u) || (u && (ef[0] = u.toString()), (u = ef));
        for (var c = 0; c < u.length; c++) {
          var f = (function e(t, r, n, i, s) {
            if (i && i.once)
              return (function e(t, r, n, i, s) {
                ...
                return (
                  (n = es(n)),
                  t && t[K] ? t.L(r, n, m(i) ? !!i.capture : !!i, s) : Z(t, r, n, !0, i, s)
                );
              })(t, r, n, i, s);
            if (Array.isArray(r)) {
              for (var a = 0; a < r.length; a++) e(t, r[a], n, i, s);
            ...
            return (
              (n = es(n)),
              t && t[K] ? t.K(r, n, m(i) ? !!i.capture : !!i, s) : Z(t, r, n, !1, i, s)
            );
          })(l, u[c], h || t.handleEvent, !1, t.h || t);
          if (!f) break;
          t.g[f.key] = f;
        }
        ((t = e.H ? x(e.H) : {}),
                ...
                if (((r.T = o[0]), (o = o[1]), 2 == r.G))
                  if ('c' == o[0]) {
                    ...
                    (null != l &&
                      'number' == typeof l &&
                      0 < l &&
                      ((r.L = n = 1.5 * l), r.j.info('backChannelRequestTimeoutMs_=' + n)),
                      (n = r));
                    let h = e.g;
                    if (h) {
                      let e = h.g ? h.g.getResponseHeader('X-Client-Wire-Protocol') : null;
                      if (e) {
                        var s = n.h;
                        s.g ||
                          (-1 == e.indexOf('spdy') &&
                            -1 == e.indexOf('quic') &&
                            -1 == e.indexOf('h2')) ||
                          ((s.j = s.l), (s.g = new Set()), s.h && (e3(s, s.h), (s.h = null)));
                      }
                      if (n.D) {
                        let e = h.g ? h.g.getResponseHeader('X-HTTP-Session-Id') : null;
                    ...
                    if (
                      ((r.G = 3),
                      r.l && r.l.ua(),
                      r.ba && ((r.R = Date.now() - e.F), r.j.info('Handshake RTT: ' + r.R + 'ms')),
                      ((n = r).qa = t2(n, n.J ? n.ia : null, n.W)),
                      e.K)
                    ) {
                      e6(n.h, e);
                      var a = n.L;
                      (a && (e.I = a), e.B && (eW(e), eK(e)), (n.g = e));
                    } else tQ(n);
                    0 < r.i.length && tz(r);
      ...
      ((eV.prototype.ca = function (e) {
        e = e.target;
        let t = this.M;
        t && 3 == tP(e) ? t.j() : this.Y(e);
      }),
        (eV.prototype.Y = function (e) {
          try {
            if (e == this.g)
              e: {
                let v = tP(this.g);
                var t = this.g.Ba();
                let w = this.g.Z();
                if (!(3 > v) && (3 != v || (this.g && (this.h.h || this.g.oa() || tV(this.g))))) {
                  (this.J || 4 != v || 7 == t || (8 == t || 0 >= w ? eA(3) : eA(2)), eW(this));
                  var r = this.g.Z();
                  this.X = r;
                  t: if (ez(this)) {
                    var n = tV(this.g);
                    ...
                    for (t = 0; t < i; t++)
                      ((this.h.h = !0),
                        (e += this.h.i.decode(n[t], { stream: !(s && t == i - 1) })));
                    ((n.length = 0), (this.h.g += e), (this.C = 0), (a = this.h.g));
                  } else a = this.g.oa();
                  if (
                    ((this.o = 200 == r),
                    (o = this.i),
                    ...
                    if (this.T && !this.K) {
                      t: {
                        if (this.g) {
                          var o,
                            ...
                            g = this.g;
                          if (
                            (d = g.g ? g.g.getResponseHeader('X-HTTP-Initial-Response') : null) &&
                            !I(d)
                          ) {
                            var m = d;
                            break t;
                      ...
                      if ((r = m))
                        ...
                        ((this.o = !1), (this.s = 3), ex(12), eY(this), eX(this));
                        break e;
                      }
                    }
                    if (this.P) {
                      ...
                      for (r = !0; !this.J && this.C < a.length; )
                        if (
                          ...
                          ((this.s = 4),
                            ...
                            (r = !1));
                          break;
                        } else (eL(this.i, this.l, e, null), eJ(this, e));
                      if (
                        (ez(this) &&
                          0 != this.C &&
                          ((this.h.g = this.h.g.slice(this.C)), (this.C = 0)),
                        4 != v || 0 != a.length || this.h.h || ((this.s = 1), ex(16), (r = !1)),
                        (this.o = this.o && r),
                        r)
                      ) {
                        if (0 < a.length && !this.W) {
                          ...
                          y.g == this &&
                            ...
                            !y.M &&
                            (y.j.info(
                              'Great, no buffering proxy detected. Bytes received: ' + a.length,
                            ),
                            tX(y),
                            (y.M = !0),
                            ex(11));
                        ...
                        (eL(this.i, this.l, a, '[Invalid Chunked Response]'), eY(this), eX(this));
                    } else (eL(this.i, this.l, a, null), eJ(this, a));
                    (4 == v && eY(this),
                      this.o && !this.J && (4 == v ? t$(this.j, this) : ((this.o = !1), eK(this))));
                  } else
                    ((function (e) {
                      let t = {};
                      e = ((e.g && 2 <= tP(e) && e.g.getAllResponseHeaders()) || '').split('\r\n');
                      for (let n = 0; n < e.length; n++) {
                        if (I(e[n])) continue;
                        var r = (function (e) {
                          var t = 1;
      ...
      function e7(e) {
        if (
          ...
          var t = e.i,
            r = new td();
          ((r.i = t.i), t.g && ((r.g = new Map(t.g)), (r.h = t.h)), tr(this, r), (this.m = e.m));
        } else
          e && (t = String(e).match(e4))
            ? ((this.h = !1),
              te(this, t[1] || '', !0),
              (this.o = ts(t[2] || '')),
              (this.g = ts(t[3] || '', !0)),
      ...
      function tt(e, t) {
        if (t) {
          if (isNaN((t = Number(t))) || 0 > t) throw Error('Bad port number ' + t);
          e.s = t;
        } else e.s = null;
      }
      function tr(e, t, r) {
        ...
        return (
          tn(
            ...
            Math.floor(0x80000000 * Math.random()).toString(36) +
              Math.abs(Math.floor(0x80000000 * Math.random()) ^ Date.now()).toString(36),
          ),
          e
        );
      }
      ...
      e7.prototype.toString = function () {
        ...
        return (
          ...
          (r = this.l) &&
            ...
            e.push(ta(r, '/' == r.charAt(0) ? tu : th, !0))),
      ...
      function ty(e, t, r) {
        (tg(e, t), 0 < r.length && ((e.i = null), e.g.set(tv(e, t), _(r)), (e.h += r.length)));
      }
      function tv(e, t) {
      ...
      function tA(e, t, r) {
        ...
        n ||
          ((r = tC(r)),
          'string' == typeof e ? null != r && encodeURIComponent(String(r)) : tn(e, t, r));
      }
      function tD(e) {
        (ea.call(this),
      ...
      (((r = td.prototype).add = function (e, t) {
        ...
        (r.V = function (e) {
          tp(this);
          let t = [];
          if ('string' == typeof e) tm(this, e) && (t = t.concat(this.g.get(tv(this, e))));
          else {
        ...
        (r.toString = function () {
          ...
          for (var r = 0; r < t.length; r++) {
            ...
            for (n = 0; n < a.length; n++) {
              var i = s;
              ('' !== a[n] && (i += '=' + encodeURIComponent(String(a[n]))), e.push(i));
            }
          }
        ...
        (r.send = function (e) {
          ...
          this.g = !0;
          let t = { headers: this.u, method: this.B, credentials: this.m, cache: void 0 };
          (e && (t.body = e),
            (this.D || p)
        ...
        (r.abort = function () {
          ((this.response = this.responseText = ''),
            ...
            1 <= this.readyState && this.g && 4 != this.readyState && ((this.g = !1), tI(this)),
            (this.readyState = 0));
        }),
        (r.Sa = function (e) {
          if (
        ...
        (r.Pa = function (e) {
          if (this.g) {
            ...
            (e.done ? tI(this) : tS(this), 3 == this.readyState && tT(this));
          }
        }),
        (r.Ra = function (e) {
          this.g && ((this.response = this.responseText = e), tI(this));
        }),
        (r.Qa = function (e) {
          this.g && ((this.response = e), tI(this));
        }),
        (r.ga = function () {
          this.g && tI(this);
        }),
      ...
      function tR(e) {
        e.A || ((e.A = !0), eo(e, 'complete'), eo(e, 'error'));
      }
      function tL(e) {
        if (e.h && void 0 !== s && (!e.v[1] || 4 != tP(e) || 2 != e.Z())) {
          if (e.u && 4 == tP(e)) eh(e.Ea, 0, e);
          else if ((eo(e, 'readystatechange'), 4 == tP(e))) {
            e.h = !1;
            try {
              let s = e.Z();
              switch (s) {
              ...
              if (!(t = n)) {
                if ((r = 0 === s)) {
                  var i = String(e.D).match(e4)[1] || null;
                  (!i && p.self && p.self.location && (i = p.self.location.protocol.slice(0, -1)),
                    (r = !tx.test(i ? i.toLowerCase() : '')));
                }
                t = r;
              }
              if (t) (eo(e, 'complete'), eo(e, 'success'));
              else {
                e.m = 6;
                try {
                  var a = 2 < tP(e) ? e.g.statusText : '';
                } catch (e) {
                  a = '';
                }
                ((e.l = a + ' [' + e.Z() + ']'), tR(e));
      ...
      function tO(e, t) {
        if (e.g) {
          ...
          let r = e.g,
            n = e.v[0] ? () => {} : null;
          ((e.g = null), (e.v = null), t || eo(e, 'ready'));
          try {
        ...
        ((this.Aa = 0),
          ...
          (this.ia =
            ...
            this.o =
              null),
          (this.Ya = this.U = 0),
          (this.Va = tF('failFast', !1, e)),
          (this.F = this.C = this.u = this.s = this.l = null),
          (this.X = !0),
          (this.za = this.T = -1),
          (this.Y = this.v = this.B = 0),
          (this.Ta = tF('baseRetryDelayMs', 5e3, e)),
          (this.cb = tF('retryDelaySeedMs', 1e4, e)),
          (this.Wa = tF('forwardChannelMaxRetries', 2, e)),
          (this.wa = tF('forwardChannelRequestTimeoutMs', 2e4, e)),
      ...
      function tq(e) {
        (tj(e),
          ...
          tJ(e),
          e.h.cancel(),
          e.s && ('number' == typeof e.s && p.clearTimeout(e.s), (e.s = null)));
      }
      function tz(e) {
        if (!e0(e.h) && !e.s) {
          e.s = !0;
          var t = e.Ga;
          (O || V(), M || (O(), (M = !0)), P.add(t, e), (e.B = 0));
        }
      }
      function tK(e, t) {
        var r;
        ...
        (tn(n, 'SID', e.K),
          ...
          (r = new eV(e, e.j, r, e.B + 1)),
          null === e.m && (r.H = e.o),
          t && (e.i = t.D.concat(e.i)),
          (t = tH(e, r, 1e3)),
          (r.I = Math.round(0.5 * e.wa) + Math.round(0.5 * e.wa * Math.random())),
          e3(e.h, r),
          ej(r, n, t));
      }
      function tG(e, t) {
      ...
      function tH(e, t, r) {
        ...
        e: {
          ...
          for (;;) {
            let e = ['count=' + r];
            -1 == t ? (0 < r ? ((t = i[0].g), e.push('ofs=' + t)) : (t = 0)) : e.push('ofs=' + t);
            let s = !0;
            for (let a = 0; a < r; a++) {
              let r = i[a].g,
                o = i[a].map;
                ...
                try {
                  !(function (e, t, r) {
                    ...
                    try {
                      e8(e, function (e, r) {
                        let i = e;
                        (m(e) && (i = ep(e)), t.push(n + r + '=' + encodeURIComponent(i)));
                      });
                    } catch (e) {
                      throw (t.push(n + 'type=' + encodeURIComponent('_badmap')), e);
                    }
                  })(o, e, 'req' + r + '_');
                } catch (e) {
                  n && n(o);
      ...
      function tQ(e) {
        if (!e.g && !e.u) {
          e.Y = 1;
          var t = e.Fa;
          (O || V(), M || (O(), (M = !0)), P.add(t, e), (e.v = 0));
        }
      }
      function tW(e) {
        return (
          !e.g && !e.u && !(3 <= e.v) && (e.Y++, (e.u = ek(w(e.Fa, e), tZ(e, e.v))), e.v++, !0)
        );
      }
      function tX(e) {
      ...
      function tY(e) {
        ((e.g = new eV(e, e.j, 'rpc', e.Y)), null === e.m && (e.g.H = e.o), (e.g.O = 0));
        var t = e9(e.qa);
        (tn(t, 'RID', 'rpc'),
          tn(t, 'SID', e.K),
          tn(t, 'AID', e.T),
          ...
          e.L && (e.g.I = e.L));
        var r = e.g;
        ((e = e.ia), (r.L = 1), (r.v = ti(e9(t))), (r.m = null), (r.P = !0), eq(r, e));
      }
      function tJ(e) {
                ...
                !(e1(e.h) >= e.h.j - !!e.s) &&
                  (e.s
                    ...
                    : 1 != e.G &&
                      2 != e.G &&
                      !(e.B >= (e.Va ? 0 : e.Wa)) &&
                      ((e.s = ek(w(e.Ga, e, r), tZ(e, e.B))), e.B++, !0)))) ||
              (2 == i && tW(e))
            )
          )
          ...
          ((n = new e7(n || '//www.google.com/images/cleardot.gif')),
            ...
            t
              ? (function (e, t) {
                  ...
                  if (p.Image) {
                    let n = new Image();
                    ((n.onload = b(tw, r, 'TestLoadImage: loaded', !0, t, n)),
                      (n.onerror = b(tw, r, 'TestLoadImage: error', !1, t, n)),
                      (n.onabort = b(tw, r, 'TestLoadImage: abort', !1, t, n)),
                      (n.ontimeout = b(tw, r, 'TestLoadImage: timeout', !1, t, n)),
              ...
              : (function (e, t) {
                  let r = new eR(),
                    ...
                    i = setTimeout(() => {
                      (n.abort(), tw(r, 'TestPingServer: timeout', !1, t));
                    }, 1e4);
                  fetch(e, { signal: n.signal })
                    .then((e) => {
                      (clearTimeout(i),
                        e.ok
                          ? tw(r, 'TestPingServer: ok', !0, t)
                          : tw(r, 'TestPingServer: server error', !1, t));
                    })
                    .catch(() => {
                      (clearTimeout(i), tw(r, 'TestPingServer: error', !1, t));
                    });
                })(n.toString(), r));
        } else ex(2);
      ...
      function t1(e) {
        if (((e.G = 0), (e.ka = []), e.l)) {
          ...
          ((0 != t.length || 0 != e.i.length) &&
            (T(e.ka, t), T(e.ka, e.i), (e.h.i.length = 0), _(e.i), (e.i.length = 0)),
            e.l.ra());
        }
      }
      function t2(e, t, r) {
        ...
        return ((r = e.D), (t = e.ya), r && t && tn(n, r, t), tn(n, 'VER', e.la), tG(e, n), n);
      }
      function t3(e, t, r) {
        if (t && !e.J) throw Error("Can't create secondary domain capable XhrIo object.");
        return ((t = new tD(e.Ca && !e.pa ? new tE({ eb: r }) : e.pa)).Ha(e.J), t);
      }
      function t6() {}
      function t5() {}
      function t8(e, t) {
      ...
      (((r = tD.prototype).Ha = function (e) {
        ...
        (r.ea = function (e, r, n, i) {
          ...
          (this.H && (this.g.responseType = this.H),
            'withCredentials' in this.g &&
              ...
              (this.g.withCredentials = this.J));
          try {
            (tM(this), (this.u = !0), this.g.send(e), (this.u = !1));
          } catch (e) {
            tk(this, e);
          }
        }),
        ...
        (r.N = function () {
          (this.g &&
            (this.h && ((this.h = !1), (this.j = !0), this.g.abort(), (this.j = !1)), tO(this, !0)),
            tD.aa.N.call(this));
        }),
        (r.Ea = function () {
          this.s || (this.B || this.u || this.j ? tL(this) : this.bb());
        }),
        (r.bb = function () {
          tL(this);
        }),
        ...
        (r.Z = function () {
          try {
            return 2 < tP(this) ? this.g.status : -1;
          } catch (e) {
            return -1;
          }
        }),
        ...
        (r.Oa = function (e) {
          if (this.g) {
            ...
            return (e && 0 == t.indexOf(e) && (t = t.substring(e.length)), eg(t));
          }
        }),
        (r.Ba = function () {
          return this.m;
          ...
          if (this.s)
            if (((this.s = null), 1 == this.G)) {
              if (!e) {
                ...
                let i = new eV(this, this.j, e),
                  s = this.o;
                if (
                  (this.S && (s ? k((s = x(s)), this.S) : (s = this.S)),
                ...
                ((t = tH(this, i, t)),
                  ...
                  s &&
                    (this.O
                      ? (t = 'headers=' + encodeURIComponent(String(tC(s))) + '&' + t)
                      : this.m && tA(r, this.m, s)),
                  e3(this.h, i),
                  this.Ua && tn(r, 'TYPE', 'init'),
                  this.P
                    ? (tn(r, '$req', t), tn(r, 'SID', 'null'), (i.T = !0), ej(i, r, null))
                    : ej(i, r, t),
                  (this.G = 2));
              }
            } else 3 == this.G && (e ? tK(this, e) : 0 == this.i.length || e0(this.h) || tK(this));
        }),
        (r.Fa = function () {
          if (((this.u = null), tY(this), this.ba && !(this.M || null == this.g || 0 >= this.R))) {
            var e = 2 * this.R;
            (this.j.info('BP detection timer enabled: ' + e), (this.A = ek(w(this.ab, this), e)));
          }
        }),
        (r.ab = function () {
          this.A &&
        ...
        (r.Za = function () {
          null != this.C && ((this.C = null), tj(this), tW(this), ex(19));
        }),
        (r.fb = function (e) {
          e
        ...
        (t8.prototype.o = function (e) {
          ...
          if ('string' == typeof e) {
            var r = {};
            ((r.__data__ = e), (e = r));
          } else this.u && (((r = {}).__data__ = ep(e)), (e = r));
          (t.i.push(new e$(t.Ya++, e)), 3 == t.G && tz(t));
        }),
        (t8.prototype.N = function () {
          ((this.g.l = null), delete this.j, tB(this.g), delete this.g, t8.aa.N.call(this));
        }),
        E(t4, eE),
        E(t7, e_),
        E(t9, t6),
        ...
        (d = eQ.createWebChannelTransport =
          function () {
            return new t5();
          }),
        (f = eQ.getStatEventTarget =
          function () {
            return eS();
          }),
        (c = eQ.Event = eT),
        ...
        (eb.ERROR = 'c'),
        (eb.MESSAGE = 'd'),
        (ea.prototype.listen = ea.prototype.K),
        (o = eQ.WebChannel = ew),
        (eQ.FetchXmlHttpFactory = tE),
    ...
    ((eX.UNAUTHENTICATED = new eX(null)),
      (eX.GOOGLE_CREDENTIALS = new eX('google-credentials-uid')),
      (eX.FIRST_PARTY = new eX('first-party-uid')),
      (eX.MOCK_USER = new eX('mock-user')));
    let eY = '10.14.0',
      eJ = new G('@firebase/firestore');
    function e$() {
      return eJ.logLevel;
    }
    function eZ(e) {
      for (var t = arguments.length, r = Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++)
        r[i - 1] = arguments[i];
      if (eJ.logLevel <= n.DEBUG) {
        let t = r.map(e2);
        eJ.debug('Firestore ('.concat(eY, '): ').concat(e), ...t);
      }
    }
    function e0(e) {
      for (var t = arguments.length, r = Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++)
        r[i - 1] = arguments[i];
      if (eJ.logLevel <= n.ERROR) {
        let t = r.map(e2);
        eJ.error('Firestore ('.concat(eY, '): ').concat(e), ...t);
      }
    }
    function e1(e) {
      for (var t = arguments.length, r = Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++)
        r[i - 1] = arguments[i];
      if (eJ.logLevel <= n.WARN) {
        let t = r.map(e2);
        eJ.warn('Firestore ('.concat(eY, '): ').concat(e), ...t);
      }
    }
    function e2(e) {
      if ('string' == typeof e) return e;
    ...
    function e3() {
      let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'Unexpected state',
        t = 'FIRESTORE ('.concat(eY, ') INTERNAL ASSERTION FAILED: ') + e;
      throw (e0(t), Error(t));
    }
    let e6 = {
      OK: 'ok',
    ...
    class e5 extends N {
      constructor(e, t) {
        (super(e, t),
          ...
          (this.message = t),
          (this.toString = () =>
            ''.concat(this.name, ': [code=').concat(this.code, ']: ').concat(this.message)));
      }
    }
    class e8 {
      constructor() {
    ...
    class e7 {
      ...
      invalidateToken() {}
      start(e, t) {
        e.enqueueRetryable(() => t(eX.UNAUTHENTICATED));
      }
      shutdown() {}
    }
    class e9 {
    ...
    class te {
      start(e, t) {
        ...
        let s = () => {
          ...
          a = (e) => {
            (eZ('FirebaseAuthCredentialsProvider', 'Auth detected'),
              (this.auth = e),
        ...
        (this.t.onInit((e) => a(e)),
          setTimeout(() => {
            if (!this.auth) {
              ...
              e
                ? a(e)
                : (eZ('FirebaseAuthCredentialsProvider', 'Auth not yet detected'),
                  i.resolve(),
                  (i = new e8()));
            }
          }, 0),
                ...
                .then((t) =>
                  this.i !== e
                    ? (eZ(
                      ...
                      this.getToken())
                    : t
                      ? ('string' == typeof t.accessToken || e3(),
                        new e4(t.accessToken, this.currentUser))
                      : null,
                )
      ...
      u() {
        ...
        return (null === e || 'string' == typeof e || e3(), new eX(e));
      }
      constructor(e) {
        ((this.t = e),
          (this.currentUser = eX.UNAUTHENTICATED),
          (this.i = 0),
          (this.forceRefresh = !1),
          (this.auth = null));
      }
    ...
    class tt {
      ...
      constructor(e, t, r) {
        ((this.l = e),
          ...
          (this.user = eX.FIRST_PARTY),
          (this.I = new Map()));
      }
    }
    class tr {
      getToken() {
        return Promise.resolve(new tt(this.l, this.h, this.P));
      }
      start(e, t) {
        e.enqueueRetryable(() => t(eX.FIRST_PARTY));
      }
      shutdown() {}
      invalidateToken() {}
      constructor(e, t, r) {
    ...
    class ti {
      start(e, t) {
        ...
        let r = (e) => {
          null != e.error &&
            eZ(
              ...
              'Error getting App Check token; using placeholder token instead. Error: '.concat(
                e.error.message,
              ),
            );
          ...
          return (
            ...
            eZ(
              'FirebaseAppCheckTokenProvider',
              'Received '.concat(r ? 'new' : 'existing', ' token.'),
            ),
        ...
        let n = (e) => {
          (eZ('FirebaseAppCheckTokenProvider', 'AppCheck detected'),
            (this.appCheck = e),
        ...
        (this.A.onInit((e) => n(e)),
          setTimeout(() => {
            if (!this.appCheck) {
              ...
              e ? n(e) : eZ('FirebaseAppCheckTokenProvider', 'AppCheck not yet detected');
            }
          }, 0));
      }
      getToken() {
        ...
        return (
          ...
          this.appCheck
            ? this.appCheck
                ...
                .then((e) =>
                  e
                    ? ('string' == typeof e.token || e3(), (this.R = e.token), new tn(e.token))
                    : null,
                )
            : Promise.resolve(null)
        );
      ...
      static newId() {
        ...
        for (; r.length < 20; ) {
          let n = (function (e) {
            ...
            else for (let e = 0; e < 40; e++) r[e] = Math.floor(256 * Math.random());
            return r;
          })(40);
          for (let i = 0; i < n.length; ++i)
            r.length < 20 && n[i] < t && (r += e.charAt(n[i] % e.length));
        }
        return r;
      }
    }
    ...
    class tl {
      static now() {
        return tl.fromMillis(Date.now());
      }
      static fromDate(e) {
        return tl.fromMillis(e.getTime());
      }
      static fromMillis(e) {
      ...
      _compareTo(e) {
        return this.seconds === e.seconds
          ? ta(this.nanoseconds, e.nanoseconds)
          : ta(this.seconds, e.seconds);
      }
      isEqual(e) {
      ...
      constructor(e, t) {
        if (((this.seconds = e), (this.nanoseconds = t), t < 0 || t >= 1e9))
          throw new e5(e6.INVALID_ARGUMENT, 'Timestamp nanoseconds out of range: ' + t);
        if (e < -0xe7791f700 || e >= 0x3afff44180)
          throw new e5(e6.INVALID_ARGUMENT, 'Timestamp seconds out of range: ' + e);
      }
    }
    class th {
      ...
      static min() {
        return new th(new tl(0, 0));
      }
      static max() {
        return new th(new tl(0x3afff4417f, 0x3b9ac9ff));
      }
      compareTo(e) {
    ...
    class tu {
      ...
      constructor(e, t, r) {
        (void 0 === t ? (t = 0) : t > e.length && e3(),
          void 0 === r ? (r = e.length - t) : r > e.length - t && e3(),
          (this.segments = e),
          (this.offset = t),
          (this.len = r));
      }
      ...
      static fromString() {
        ...
        for (let e of t) {
          if (e.indexOf('//') >= 0)
            throw new e5(
              e6.INVALID_ARGUMENT,
              'Invalid segment ('.concat(e, '). Paths must not contain // in them.'),
            );
    ...
    class td extends tu {
      ...
      static fromServerFormat(e) {
        ...
        for (; n < e.length; ) {
          ...
          if ('\\' === t) {
            if (n + 1 === e.length)
              throw new e5(e6.INVALID_ARGUMENT, 'Path has trailing escape character: ' + e);
            let t = e[n + 1];
            if ('\\' !== t && '.' !== t && '`' !== t)
              throw new e5(e6.INVALID_ARGUMENT, 'Path has invalid escape sequence: ' + e);
            ((r += t), (n += 2));
          } else ('`' === t ? (s = !s) : '.' !== t || s ? (r += t) : i(), n++);
        }
        if ((i(), s)) throw new e5(e6.INVALID_ARGUMENT, 'Unterminated ` in path: ' + e);
        return new td(t);
      }
      static emptyPath() {
        return new td([]);
    ...
    class tp {
      static fromPath(e) {
        return new tp(tc.fromString(e));
      }
      static fromName(e) {
        return new tp(tc.fromString(e).popFirst(5));
      }
      static empty() {
        return new tp(tc.emptyPath());
      }
      get collectionGroup() {
      ...
      isEqual(e) {
        return null !== e && 0 === tc.comparator(this.path, e.path);
      }
      toString() {
        return this.path.toString();
      }
      static comparator(e, t) {
        return tc.comparator(e.path, t.path);
      }
      static isDocumentKey(e) {
        return e.length % 2 == 0;
      }
      static fromSegments(e) {
        return new tp(new tc(e.slice()));
      }
      constructor(e) {
        this.path = e;
      }
    ...
    class tg {
      static min() {
        return new tg(th.min(), tp.empty(), -1);
      }
      static max() {
        return new tg(th.max(), tp.empty(), -1);
      }
      constructor(e, t, r) {
    ...
    async function ty(e) {
      if (
        e.code !== e6.FAILED_PRECONDITION ||
        'The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.' !==
          e.message
      )
        throw e;
      eZ('LocalStore', 'Unexpectedly lost primary lease');
    }
    class tv {
      catch(e) {
      ...
      wrapUserFunction(e) {
        try {
          let t = e();
          return t instanceof tv ? t : tv.resolve(t);
        } catch (e) {
          return tv.reject(e);
        }
      }
      wrapSuccess(e, t) {
        return e ? this.wrapUserFunction(() => e(t)) : tv.resolve(t);
      }
      wrapFailure(e, t) {
        return e ? this.wrapUserFunction(() => e(t)) : tv.reject(t);
      }
      static resolve(e) {
        return new tv((t, r) => {
          t(e);
      ...
      static or(e) {
        let t = tv.resolve(!1);
        for (let r of e) t = t.next((e) => (e ? tv.resolve(e) : r()));
        return t;
      }
      static forEach(e, t) {
        let r = [];
    ...
    class tS {
      insert(e, t) {
        return new tS(
          this.comparator,
          this.root.insert(e, t, this.comparator).copy(null, null, tA.BLACK, null, null),
        );
      }
      remove(e) {
        return new tS(
          this.comparator,
          this.root.remove(e, this.comparator).copy(null, null, tA.BLACK, null, null),
        );
      }
      get(e) {
        let t = this.root;
      ...
      toString() {
        let e = [];
        return (
          this.inorderTraversal((t, r) => (e.push(''.concat(t, ':').concat(r)), !1)),
          '{'.concat(e.join(', '), '}')
        );
      }
      reverseTraversal(e) {
      ...
      getIterator() {
        return new tC(this.root, null, this.comparator, !1);
      }
      getIteratorFrom(e) {
        return new tC(this.root, e, this.comparator, !1);
      }
      getReverseIterator() {
        return new tC(this.root, null, this.comparator, !0);
      }
      getReverseIteratorFrom(e) {
        return new tC(this.root, e, this.comparator, !0);
      }
      constructor(e, t) {
        ((this.comparator = e), (this.root = t || tA.EMPTY));
      }
    }
    class tC {
      getNext() {
    ...
    class tA {
        ...
        return (n =
          i < 0
            ...
            : 0 === i
              ...
              : n.copy(null, null, null, null, n.right.insert(e, t, r))).fixUp();
      }
      removeMin() {
        if (this.left.isEmpty()) return tA.EMPTY;
        let e = this;
        return (
      ...
      remove(e, t) {
        ...
        if (0 > t(e, n.key))
          ...
          if (
            ...
            if (n.right.isEmpty()) return tA.EMPTY;
      ...
      rotateLeft() {
        let e = this.copy(null, null, tA.RED, null, this.right.left);
        return this.right.copy(null, null, this.color, e, null);
      }
      rotateRight() {
        let e = this.copy(null, null, tA.RED, this.left.right, null);
      ...
      check() {
        if ((this.isRed() && this.left.isRed()) || this.right.isRed()) throw e3();
        let e = this.left.check();
        if (e !== this.right.check()) throw e3();
        return e + +!this.isRed();
      }
      constructor(e, t, r, n, i) {
        ((this.key = e),
          (this.value = t),
          (this.color = null != r ? r : tA.RED),
          (this.left = null != n ? n : tA.EMPTY),
    ...
    class tD {
      ...
      getIterator() {
        return new tx(this.data.getIterator());
      }
      getIteratorFrom(e) {
        return new tx(this.data.getIteratorFrom(e));
      }
      add(e) {
      ...
      isEqual(e) {
        if (!(e instanceof tD) || this.size !== e.size) return !1;
      ...
      copy(e) {
        let t = new tD(this.comparator);
        return ((t.data = e), t);
      }
      constructor(e) {
        ((this.comparator = e), (this.data = new tS(this.comparator)));
      }
    }
    class tx {
      getNext() {
    ...
    class tN {
      ...
      isEqual(e) {
        return to(this.fields, e.fields, (e, t) => e.isEqual(t));
      }
      constructor(e) {
        ((this.fields = e), e.sort(td.comparator));
      }
    }
    ...
    class tR {
          ...
          (function (e) {
            try {
              ...
              throw 'undefined' != typeof DOMException && e instanceof DOMException
                ? new tk('Invalid base64 string: ' + e)
                : e;
            }
          })(e),
        );
      ...
      compareTo(e) {
        return ta(this.binaryString, e.binaryString);
      }
      isEqual(e) {
    ...
    tR.EMPTY_BYTE_STRING = new tR('');
    let tL = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
    function tO(e) {
      if ((e || e3(), 'string' == typeof e)) {
        let t = 0,
          r = tL.exec(e);
        if ((r || e3(), r[1])) {
          let e = r[1];
      ...
      return { seconds: tM(e.seconds), nanos: tM(e.nanos) };
    }
    function tM(e) {
      return 'number' == typeof e ? e : 'string' == typeof e ? Number(e) : 0;
    }
    function tP(e) {
      return 'string' == typeof e ? tR.fromBase64String(e) : tR.fromUint8Array(e);
    }
    function tV(e) {
      var t, r;
      return (
        'server_timestamp' ===
        (null ==
        (r = ((null == (t = null == e ? void 0 : e.mapValue) ? void 0 : t.fields) || {}).__type__)
          ? void 0
          : r.stringValue)
      );
    }
    ...
    function tU(e) {
      let t = tO(e.mapValue.fields.__local_write_time__.timestampValue);
      return new tl(t.seconds, t.nanos);
    }
    class tB {
    ...
    class tj {
      ...
      isEqual(e) {
        return e instanceof tj && e.projectId === this.projectId && e.database === this.database;
      }
      constructor(e, t) {
        ((this.projectId = e), (this.database = t || '(default)'));
      }
    }
    let tq = { mapValue: { fields: { __type__: { stringValue: '__max__' } } } };
    function tz(e) {
    ...
    function tK(e, t) {
      ...
      switch (r) {
        ...
        case 3:
          ...
          let n = tO(e.timestampValue),
            i = tO(t.timestampValue);
          return n.seconds === i.seconds && n.nanos === i.nanos;
        case 5:
          return e.stringValue === t.stringValue;
        case 6:
          return tP(e.bytesValue).isEqual(tP(t.bytesValue));
        case 7:
          return e.referenceValue === t.referenceValue;
        case 8:
          return (
            tM(e.geoPointValue.latitude) === tM(t.geoPointValue.latitude) &&
            tM(e.geoPointValue.longitude) === tM(t.geoPointValue.longitude)
          );
        case 2:
          if ('integerValue' in e && 'integerValue' in t)
            return tM(e.integerValue) === tM(t.integerValue);
          if ('doubleValue' in e && 'doubleValue' in t) {
            let r = tM(e.doubleValue),
              n = tM(t.doubleValue);
            return r === n ? tE(r) === tE(n) : isNaN(r) && isNaN(n);
          }
          return !1;
        case 9:
          return to(e.arrayValue.values || [], t.arrayValue.values || [], tK);
        case 10:
        case 11:
          let s = e.mapValue.fields || {},
            a = t.mapValue.fields || {};
          if (t_(s) !== t_(a)) return !1;
          for (let e in s)
            if (s.hasOwnProperty(e) && (void 0 === a[e] || !tK(s[e], a[e]))) return !1;
          return !0;
        default:
          return e3();
      }
    ...
    function tG(e, t) {
      return void 0 !== (e.values || []).find((e) => tK(e, t));
    }
    function tH(e, t) {
      if (e === t) return 0;
      let r = tz(e),
      ...
      switch (r) {
        ...
        case 0x1fffffffffffff:
          return 0;
        case 1:
          return ta(e.booleanValue, t.booleanValue);
        case 2:
          let i = tM(e.integerValue || e.doubleValue),
            s = tM(t.integerValue || t.doubleValue);
          return i < s ? -1 : i > s ? 1 : i === s ? 0 : isNaN(i) ? (isNaN(s) ? 0 : -1) : 1;
        case 3:
          return tQ(e.timestampValue, t.timestampValue);
        case 4:
          return tQ(tU(e), tU(t));
        case 5:
          return ta(e.stringValue, t.stringValue);
        case 6:
          return (function (e, t) {
            let r = tP(e),
              n = tP(t);
        ...
        case 7:
          return (function (e, t) {
            ...
            return ta(r.length, n.length);
          })(e.referenceValue, t.referenceValue);
        case 8:
          return (function (e, t) {
            let r = ta(tM(e.latitude), tM(t.latitude));
            return 0 !== r ? r : ta(tM(e.longitude), tM(t.longitude));
          })(e.geoPointValue, t.geoPointValue);
        case 9:
          return tW(e.arrayValue, t.arrayValue);
        case 10:
          return (function (e, t) {
            var r, n, i, s;
            let a = e.fields || {},
              o = t.fields || {},
              l = null == (r = a.value) ? void 0 : r.arrayValue,
              h = null == (n = o.value) ? void 0 : n.arrayValue,
              u = ta(
                (null == (i = null == l ? void 0 : l.values) ? void 0 : i.length) || 0,
                (null == (s = null == h ? void 0 : h.values) ? void 0 : s.length) || 0,
              );
            return 0 !== u ? u : tW(l, h);
          })(e.mapValue, t.mapValue);
        case 11:
          return (function (e, t) {
            if (e === tq.mapValue && t === tq.mapValue) return 0;
            if (e === tq.mapValue) return 1;
            if (t === tq.mapValue) return -1;
            let r = e.fields || {},
              n = Object.keys(r),
              i = t.fields || {},
              s = Object.keys(i);
            ...
            for (let e = 0; e < n.length && e < s.length; ++e) {
              let t = ta(n[e], s[e]);
              if (0 !== t) return t;
              let a = tH(r[n[e]], i[s[e]]);
              if (0 !== a) return a;
            }
            return ta(n.length, s.length);
          })(e.mapValue, t.mapValue);
        default:
          throw e3();
      }
    ...
    function tQ(e, t) {
      if ('string' == typeof e && 'string' == typeof t && e.length === t.length) return ta(e, t);
      let r = tO(e),
        n = tO(t),
        i = ta(r.seconds, n.seconds);
      return 0 !== i ? i : ta(r.nanos, n.nanos);
    }
    function tW(e, t) {
      let r = e.values || [],
        n = t.values || [];
            ...
            : 'doubleValue' in e
              ...
              : 'timestampValue' in e
                ...
                : 'stringValue' in e
                  ? e.stringValue
                  : 'bytesValue' in e
                    ? tP(e.bytesValue).toBase64()
                    : 'referenceValue' in e
                      ? ((t = e.referenceValue), tp.fromName(t).toString())
                      : 'geoPointValue' in e
                        ? ((r = e.geoPointValue),
                          'geo('.concat(r.latitude, ',').concat(r.longitude, ')'))
                        : 'arrayValue' in e
                          ? (function (e) {
                              let t = '[',
                                r = !0;
                          ...
                          : 'mapValue' in e
                            ? (function (e) {
                                ...
                                for (let i of t)
                                  (n ? (n = !1) : (r += ','),
                                    (r += ''.concat(i, ':').concat(tX(e.fields[i]))));
                                return r + '}';
                              })(e.mapValue)
                            : e3();
    }
    ...
    function t3(e) {
      ...
      if (e.mapValue) {
        ...
        return (tT(e.mapValue.fields, (e, r) => (t.mapValue.fields[e] = t3(r))), t);
      }
      if (e.arrayValue) {
        let t = { arrayValue: { values: [] } };
        for (let r = 0; r < (e.arrayValue.values || []).length; ++r)
          t.arrayValue.values[r] = t3(e.arrayValue.values[r]);
        return t;
      }
    ...
    class t5 {
      ...
      field(e) {
        if (e.isEmpty()) return this.value;
        {
          ...
          for (let r = 0; r < e.length - 1; ++r)
            if (!t1((t = (t.mapValue.fields || {})[e.get(r)]))) return null;
          return (t = (t.mapValue.fields || {})[e.lastSegment()]) || null;
        }
      }
      set(e, t) {
        this.getFieldsMap(e.popLast())[e.lastSegment()] = t3(t);
      }
      setAll(e) {
        let t = td.emptyPath(),
          r = {},
        ...
        e.forEach((e, i) => {
          ...
          e ? (r[i.lastSegment()] = t3(e)) : n.push(i.lastSegment());
        });
      ...
      delete(e) {
        ...
        t1(t) && t.mapValue.fields && delete t.mapValue.fields[e.lastSegment()];
      }
      isEqual(e) {
        return tK(this.value, e.value);
      }
      getFieldsMap(e) {
        let t = this.value;
        ...
        for (let r = 0; r < e.length; ++r) {
          ...
          ((t1(n) && n.mapValue.fields) ||
            ((n = { mapValue: { fields: {} } }), (t.mapValue.fields[e.get(r)] = n)),
            (t = n));
        }
        return t.mapValue.fields;
      }
      applyChanges(e, t, r) {
        for (let n of (tT(t, (t, r) => (e[t] = r)), r)) delete e[n];
      }
      clone() {
        return new t5(t3(this.value));
      }
      constructor(e) {
        this.value = e;
      }
    ...
    class t8 {
      static newInvalidDocument(e) {
        return new t8(e, 0, th.min(), th.min(), th.min(), t5.empty(), 0);
      }
      static newFoundDocument(e, t, r, n) {
        return new t8(e, 1, t, th.min(), r, n, 0);
      }
      static newNoDocument(e, t) {
        return new t8(e, 2, t, th.min(), th.min(), t5.empty(), 0);
      }
      static newUnknownDocument(e, t) {
        return new t8(e, 3, t, th.min(), th.min(), t5.empty(), 2);
      }
      convertToFoundDocument(e, t) {
        return (
          this.createTime.isEqual(th.min()) &&
      ...
      setHasLocalMutations() {
        return ((this.documentState = 1), (this.version = th.min()), this);
      }
      setReadTime(e) {
      ...
      for (let i = 0; i < e.position.length; i++) {
        ...
        if (
          ((n = s.field.isKeyField()
            ? tp.comparator(tp.fromName(a.referenceValue), r.key)
            : tH(a, r.data.field(s.field))),
          'desc' === s.dir && (n *= -1),
          0 !== n)
        )
          break;
    ...
    function t9(e, t) {
      ...
      if (null === t || e.inclusive !== t.inclusive || e.position.length !== t.position.length)
        return !1;
      for (let r = 0; r < e.position.length; r++) if (!tK(e.position[r], t.position[r])) return !1;
      return !0;
    }
    class re {
      constructor(e, t = 'asc') {
    ...
    class rr extends rt {
      ...
      static createKeyFieldInFilter(e, t, r) {
        return 'in' === t ? new ro(e, r) : new rl(e, r);
      }
      matches(e) {
        let t = e.data.field(this.field);
        return '!=' === this.op
          ? null !== t && this.matchesComparison(tH(t, this.value))
          : null !== t && tz(this.value) === tz(t) && this.matchesComparison(tH(t, this.value));
      }
      matchesComparison(e) {
        switch (this.op) {
          case '<':
    ...
    function rs(e) {
      for (let t of e.filters) if (t instanceof rn) return !1;
      return !0;
    }
    class ra extends rr {
      matches(e) {
        let t = tp.comparator(e.key, this.key);
        return this.matchesComparison(t);
      }
      constructor(e, t, r) {
        (super(e, t, r), (this.key = tp.fromName(r.referenceValue)));
      }
    }
    class ro extends rr {
      matches(e) {
    ...
    function rh(e, t) {
      ...
      return ((null == (r = t.arrayValue) ? void 0 : r.values) || []).map((e) =>
        tp.fromName(e.referenceValue),
      );
    }
    class ru extends rr {
      matches(e) {
        let t = e.data.field(this.field);
        return t$(t) && tG(t.arrayValue, this.value);
      }
      constructor(e, t) {
    ...
    class rc extends rr {
      matches(e) {
        let t = e.data.field(this.field);
        return null !== t && tG(this.value.arrayValue, t);
      }
      constructor(e, t) {
        super(e, 'in', t);
      }
    ...
    class rf extends rr {
      matches(e) {
        if (tG(this.value.arrayValue, { nullValue: 'NULL_VALUE' })) return !1;
        let t = e.data.field(this.field);
        return null !== t && !tG(this.value.arrayValue, t);
      }
      constructor(e, t) {
    ...
    class rd extends rr {
      matches(e) {
        let t = e.data.field(this.field);
        return (
          !(!t$(t) || !t.arrayValue.values) &&
          t.arrayValue.values.some((e) => tG(this.value.arrayValue, e))
        );
      }
      constructor(e, t) {
        ...
        (null !== e.collectionGroup && (t += '|cg:' + e.collectionGroup),
          ...
          (t += e.filters
            .map((e) =>
              (function e(t) {
                if (t instanceof rr)
                  return t.field.canonicalString() + t.op.toString() + tX(t.value);
                if (rs(t) && ri(t)) return t.filters.map((t) => e(t)).join(',');
                {
                  let r = t.filters.map((t) => e(t)).join(',');
                  return ''.concat(t.op, '(').concat(r, ')');
                }
              })(e),
            )
            .join(',')),
          ...
          e.startAt &&
            ...
            (t += e.startAt.position.map((e) => tX(e)).join(','))),
          e.endAt &&
            ((t += '|ub:'),
            (t += e.endAt.inclusive ? 'a:' : 'b:'),
            (t += e.endAt.position.map((e) => tX(e)).join(','))),
          (e.ue = t));
      }
      return e.ue;
    }
    function ry(e, t) {
      ...
      for (let i = 0; i < e.orderBy.length; i++) {
        var r, n;
        if (
          ((r = e.orderBy[i]), (n = t.orderBy[i]), !(r.dir === n.dir && r.field.isEqual(n.field)))
        )
          return !1;
      }
        ...
        if (
          !(function e(t, r) {
            return t instanceof rr
              ? r instanceof rr && t.op === r.op && t.field.isEqual(r.field) && tK(t.value, r.value)
              : t instanceof rn
                ? r instanceof rn &&
                  t.op === r.op &&
      ...
      return (
        ...
        !!t9(e.startAt, t.startAt) &&
        t9(e.endAt, t.endAt)
      );
    }
    function rv(e) {
      return tp.isDocumentKey(e.path) && null === e.collectionGroup && 0 === e.filters.length;
    }
    class rw {
    ...
    function r_(e) {
      if (null === e.ce) {
        ...
        e.ce = [];
        let r = new Set();
        for (let t of e.explicitOrderBy) (e.ce.push(t), r.add(t.field.canonicalString()));
        let n =
          e.explicitOrderBy.length > 0
            ? e.explicitOrderBy[e.explicitOrderBy.length - 1].dir
            : 'asc';
        (((t = new tD(td.comparator)),
        e.filters.forEach((e) => {
        ...
        t).forEach((t) => {
          r.has(t.canonicalString()) || t.isKeyField() || e.ce.push(new re(t, n));
        }),
          r.has(td.keyField().canonicalString()) || e.ce.push(new re(td.keyField(), n)));
      }
      return e.ce;
    }
    function rT(e) {
      return (
        e.le ||
          (e.le = (function (e, t) {
            if ('F' === e.limitType)
              return rg(e.path, e.collectionGroup, t, e.filters, e.limit, e.startAt, e.endAt);
            {
              t = t.map((e) => {
                let t = 'desc' === e.dir ? 'asc' : 'desc';
                return new re(e.field, t);
              });
              let r = e.endAt ? new t4(e.endAt.position, e.endAt.inclusive) : null,
                n = e.startAt ? new t4(e.startAt.position, e.startAt.inclusive) : null;
              return rg(e.path, e.collectionGroup, t, e.filters, e.limit, r, n);
            }
          })(e, r_(e))),
        e.le
      );
    ...
    function rC(e, t) {
      return ry(rT(e), rT(t)) && e.limitType === t.limitType;
    }
    function rA(e) {
      return ''.concat(rm(rT(e)), '|lt:').concat(e.limitType);
    }
    function rD(e) {
      var t;
      let r;
      return 'Query(target='
        .concat(
              ...
              t.filters
                .map((e) =>
                  (function e(t) {
                    return t instanceof rr
                      ? ''
                          .concat(t.field.canonicalString(), ' ')
                          .concat(t.op, ' ')
                          .concat(tX(t.value))
                      : t instanceof rn
                        ? t.op.toString() + ' {' + t.getFilters().map(e).join(' ,') + '}'
                        : 'Filter';
                  })(e),
                )
                .join(', '),
          ...
          t.orderBy.length > 0 &&
            (r += ', orderBy: ['.concat(
              t.orderBy
                .map((e) => ''.concat(e.field.canonicalString(), ' (').concat(e.dir, ')'))
                .join(', '),
              ']',
            )),
          t.startAt &&
            ...
            (r += t.startAt.position.map((e) => tX(e)).join(','))),
          t.endAt &&
            ((r += ', endAt: '),
            (r += t.endAt.inclusive ? 'a:' : 'b:'),
            (r += t.endAt.position.map((e) => tX(e)).join(','))),
          'Target('.concat(r, ')')),
          '; limitType=',
        )
        .concat(e.limitType, ')');
      ...
      return (
        ...
        (function (e, t) {
          ...
          return null !== e.collectionGroup
            ...
            : tp.isDocumentKey(e.path)
              ? e.path.isEqual(r)
              : e.path.isImmediateParentOf(r);
        })(e, t) &&
        (function (e, t) {
          for (let r of r_(e))
            if (!r.field.isKeyField() && null === t.data.field(r.field)) return !1;
          return !0;
        })(e, t) &&
        (function (e, t) {
        ...
        for (let i of r_(e)) {
          let e = (function (e, t, r) {
            let n = e.field.isKeyField()
              ? tp.comparator(t.key, r.key)
              : (function (e, t, r) {
                  let n = t.data.field(e),
                    i = r.data.field(e);
                  return null !== n && null !== i ? tH(n, i) : e3();
                })(e.field, t, r);
            switch (e.dir) {
              case 'asc':
                return n;
    ...
    class rk {
      ...
      set(e, t) {
        let r = this.mapKeyFn(e),
          n = this.inner[r];
        if (void 0 === n) return ((this.inner[r] = [[e, t]]), void this.innerSize++);
      ...
      delete(e) {
        ...
        for (let n = 0; n < r.length; n++)
          if (this.equalsFn(r[n][0], e))
            return (1 === r.length ? delete this.inner[t] : r.splice(n, 1), this.innerSize--, !0);
        return !1;
      }
      forEach(e) {
        tT(this.inner, (t, r) => {
    ...
    let rR = new tS(tp.comparator),
      rL = new tS(tp.comparator);
    function rO() {
      for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
      let n = rL;
      for (let e of t) n = n.insert(e.key, e);
      return n;
    }
    function rM(e) {
      let t = rL;
    ...
    let rV = new tS(tp.comparator),
      rF = new tD(tp.comparator);
    function rU() {
      for (var e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
      let n = rF;
    ...
    function rQ(e, t) {
      let r = r$(t);
      for (let t of e.elements) r.some((e) => tK(e, t)) || r.push(t);
    ...
    function rX(e, t) {
      let r = r$(t);
      for (let t of e.elements) r = r.filter((e) => !tK(e, t));
      return { arrayValue: { values: r } };
    }
    class rY extends rz {
      constructor(e, t) {
    ...
    function rJ(e) {
      return tM(e.integerValue || e.doubleValue);
    }
    function r$(e) {
      return t$(e) && e.arrayValue.values ? e.arrayValue.values.slice() : [];
    }
    class rZ {
      constructor(e, t) {
    ...
    function r3(e, t) {
      ...
      if (null === t)
        return e.isNoDocument() ? new nt(e.key, r0.none()) : new r8(e.key, e.data, r0.none());
      {
        let r = e.data,
          n = t5.empty(),
          i = new tD(td.comparator);
        ...
        return new r4(e.key, n, new tN(i.toArray()), r0.none());
      }
    }
    function r6(e, t, r, n) {
      return e instanceof r8
        ? (function (e, t, r, n) {
            if (!r1(e.precondition, t)) return r;
            let i = e.value.clone(),
              s = ne(e.fieldTransforms, n, t);
            return (
              i.setAll(s),
        ...
        : e instanceof r4
          ? (function (e, t, r, n) {
              if (!r1(e.precondition, t)) return r;
              let i = ne(e.fieldTransforms, n, t),
                s = t.data;
              return (s.setAll(r7(e)),
              s.setAll(i),
              t.convertToFoundDocument(t.version, s).setHasLocalMutations(),
              null === r)
                ? null
                : r.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map((e) => e.field));
            })(e, t, r, n)
          : r1(e.precondition, t)
          ...
          (!(!r || !n) &&
            to(r, n, (e, t) => {
              ...
              return (
                ...
                ((r = e.transform),
                (n = t.transform),
                (r instanceof rH && n instanceof rH) || (r instanceof rW && n instanceof rW)
                  ? to(r.elements, n.elements, tK)
                  : r instanceof rY && n instanceof rY
                    ? tK(r.Pe, n.Pe)
                    : r instanceof rG && n instanceof rG)
              );
            }))
        )) &&
        (0 === e.type
    ...
    function r9(e, t, r) {
      var n;
      let i = new Map();
      e.length === r.length || e3();
      for (let s = 0; s < r.length; s++) {
        let a = e[s],
          o = a.transform,
          l = t.data.field(a.field);
        i.set(a.field, ((n = r[s]), o instanceof rH ? rQ(o, l) : o instanceof rW ? rX(o, l) : n));
      }
      return i;
    }
    function ne(e, t, r) {
            ...
            : e instanceof rH
              ...
              : e instanceof rW
                ...
                : (function (e, t) {
                    let r = rK(e, t),
                      n = rJ(r) + rJ(e.Pe);
                    return tJ(r) && tJ(e.Pe) ? rq(n) : rj(e.serializer, n);
                  })(e, s),
        );
      }
      return n;
    ...
    class nn {
          ...
          n.key.isEqual(e.key) &&
            (function (e, t, r) {
              e instanceof r8
                ? (function (e, t, r) {
                    let n = e.value.clone(),
                      i = r9(e.fieldTransforms, t, r.transformResults);
                    (n.setAll(i),
                      t.convertToFoundDocument(r.version, n).setHasCommittedMutations());
                  })(e, t, r)
                : e instanceof r4
                  ? (function (e, t, r) {
                      if (!r1(e.precondition, t)) return t.convertToUnknownDocument(r.version);
                      let n = r9(e.fieldTransforms, t, r.transformResults),
                        i = t.data;
                      (i.setAll(r7(e)),
                        i.setAll(n),
      ...
      applyToLocalView(e, t) {
        for (let r of this.baseMutations)
          r.key.isEqual(e.key) && (t = r6(r, e, t, this.localWriteTime));
        ...
        return (
          this.mutations.forEach((n) => {
            let i = e.get(n.key),
              ...
              o = r3(s, (a = t.has(n.key) ? null : a));
            (null !== o && r.set(n.key, o), s.isValidDocument() || s.convertToNoDocument(th.min()));
          }),
          r
        );
      }
      keys() {
        return this.mutations.reduce((e, t) => e.add(t.key), rU());
      }
      isEqual(e) {
        return (
          this.batchId === e.batchId &&
          to(this.mutations, e.mutations, (e, t) => r5(e, t)) &&
          to(this.baseMutations, e.baseMutations, (e, t) => r5(e, t))
        );
      }
      constructor(e, t, r, n) {
        ((this.batchId = e),
    ...
    class ni {
      static from(e, t, r) {
        e.mutations.length === r.length || e3();
        let n = rV,
          i = e.mutations;
    ...
    function no(e) {
      if (void 0 === e) return (e0('GRPC error has no .code'), e6.UNKNOWN);
      switch (e) {
        case p.OK:
          return e6.OK;
        case p.CANCELLED:
        ...
        case p.DEADLINE_EXCEEDED:
          return e6.DEADLINE_EXCEEDED;
        case p.RESOURCE_EXHAUSTED:
          return e6.RESOURCE_EXHAUSTED;
        case p.INTERNAL:
          return e6.INTERNAL;
        case p.UNAVAILABLE:
          return e6.UNAVAILABLE;
        case p.UNAUTHENTICATED:
          return e6.UNAUTHENTICATED;
        case p.INVALID_ARGUMENT:
          return e6.INVALID_ARGUMENT;
        case p.NOT_FOUND:
          return e6.NOT_FOUND;
        case p.ALREADY_EXISTS:
          return e6.ALREADY_EXISTS;
        case p.PERMISSION_DENIED:
          return e6.PERMISSION_DENIED;
        case p.FAILED_PRECONDITION:
          return e6.FAILED_PRECONDITION;
        case p.ABORTED:
          return e6.ABORTED;
        case p.OUT_OF_RANGE:
          return e6.OUT_OF_RANGE;
        case p.UNIMPLEMENTED:
          return e6.UNIMPLEMENTED;
        case p.DATA_LOSS:
          return e6.DATA_LOSS;
        default:
          return e3();
    ...
    (((g = p || (p = {}))[(g.OK = 0)] = 'OK'),
      (g[(g.CANCELLED = 1)] = 'CANCELLED'),
      (g[(g.UNKNOWN = 2)] = 'UNKNOWN'),
      (g[(g.INVALID_ARGUMENT = 3)] = 'INVALID_ARGUMENT'),
      (g[(g.DEADLINE_EXCEEDED = 4)] = 'DEADLINE_EXCEEDED'),
      (g[(g.NOT_FOUND = 5)] = 'NOT_FOUND'),
      (g[(g.ALREADY_EXISTS = 6)] = 'ALREADY_EXISTS'),
      (g[(g.PERMISSION_DENIED = 7)] = 'PERMISSION_DENIED'),
      (g[(g.UNAUTHENTICATED = 16)] = 'UNAUTHENTICATED'),
      (g[(g.RESOURCE_EXHAUSTED = 8)] = 'RESOURCE_EXHAUSTED'),
      (g[(g.FAILED_PRECONDITION = 9)] = 'FAILED_PRECONDITION'),
      (g[(g.ABORTED = 10)] = 'ABORTED'),
      (g[(g.OUT_OF_RANGE = 11)] = 'OUT_OF_RANGE'),
      (g[(g.UNIMPLEMENTED = 12)] = 'UNIMPLEMENTED'),
      (g[(g.INTERNAL = 13)] = 'INTERNAL'),
      (g[(g.UNAVAILABLE = 14)] = 'UNAVAILABLE'),
      (g[(g.DATA_LOSS = 15)] = 'DATA_LOSS'));
    let nl = new i([0xffffffff, 0xffffffff], 0);
    function nh(e) {
    ...
    function nu(e) {
      let t = new DataView(e.buffer),
        ...
        s = t.getUint32(8, !0),
        a = t.getUint32(12, !0);
      return [new i([r, n], 0), new i([s, a], 0)];
    }
    class nc {
      Ee(e, t, r) {
        let n = e.add(t.multiply(i.fromNumber(r)));
        return (
          1 === n.compare(nl) && (n = new i([n.getBits(0), n.getBits(1)], 0)),
          n.modulo(this.Te).toNumber()
        );
      }
      de(e) {
      ...
      mightContain(e) {
        ...
        for (let e = 0; e < this.hashCount; e++) {
          let n = this.Ee(t, r, e);
          if (!this.de(n)) return !1;
        }
        return !0;
      }
      static create(e, t, r) {
        let n = new nc(new Uint8Array(Math.ceil(e / 8)), e % 8 == 0 ? 0 : 8 - (e % 8), t);
      ...
      constructor(e, t, r) {
        if (((this.bitmap = e), (this.padding = t), (this.hashCount = r), t < 0 || t >= 8))
          throw new nf('Invalid padding: '.concat(t));
        if (r < 0 || (e.length > 0 && 0 === this.hashCount))
          throw new nf('Invalid hash count: '.concat(r));
        if (0 === e.length && 0 !== t)
          throw new nf('Invalid padding when bitmap length is 0: '.concat(t));
        ((this.Ie = 8 * e.length - t), (this.Te = i.fromNumber(this.Ie)));
      }
    }
    ...
    class nd {
      static createSynthesizedRemoteEventForCurrentChange(e, t, r) {
        let n = new Map();
        return (
          n.set(e, np.createSynthesizedTargetChangeForCurrentChange(e, t, r)),
          new nd(th.min(), n, new tS(ta), rR, rU())
        );
      }
      constructor(e, t, r, n, i) {
    ...
    class ng {
      constructor(e, t, r, n) {
        ((this.Re = e), (this.removedTargetIds = t), (this.key = r), (this.Ve = n));
      }
    }
    class nm {
      constructor(e, t) {
    ...
    class ny {
      constructor(e, t, r = tR.EMPTY_BYTE_STRING, n = null) {
        ((this.state = e), (this.targetIds = t), (this.resumeToken = r), (this.cause = n));
      }
    }
    class nv {
      get current() {
      ...
      ve() {
        ...
        return (
          ...
          new np(this.pe, this.ye, e, t, r)
        );
      }
      Ce() {
        ((this.we = !1), (this.ge = nE()));
      }
      Fe(e, t) {
    ...
    class nw {
      Ke(e) {
        ...
        for (let t of e.removedTargetIds) this.Ue(t, e.key, e.Ve);
      }
      We(e) {
      ...
      He(e) {
        ...
        if (n) {
          ...
          if (rv(i))
            if (0 === r) {
              let e = new tp(i.path);
              this.Ue(t, e, t8.newNoDocument(e, th.min()));
            } else 1 === r || e3();
          else {
            let n = this.Ye(t);
            if (n !== r) {
      ...
      Ze(e) {
        ...
        try {
          ...
          return (
            e1(e instanceof nf ? 'BloomFilter error: ' : 'Applying bloom filter failed: ', e),
            null
          );
        }
      ...
      Xe(e, t, r) {
        return 2 * (t.me.count !== r - this.nt(e, t.targetId));
      }
      nt(e, t) {
        let r = this.Le.getRemoteKeysForTarget(t),
          n = 0;
        return (
          r.forEach((r) => {
            let i = this.Le.tt(),
              s = 'projects/'
                ...
                .concat(r.path.canonicalString());
            e.mightContain(s) || (this.Ue(t, r, null), n++);
          }),
          n
        );
      }
      rt(e) {
        ...
        this.Be.forEach((r, n) => {
          let i = this.Je(n);
          if (i) {
            if (r.current && rv(i.target)) {
              let t = new tp(i.target.path);
              null !== this.ke.get(t) || this.it(n, t) || this.Ue(n, t, t8.newNoDocument(t, e));
            }
            r.be && (t.set(n, r.ve()), r.Ce());
          }
        });
        let r = rU();
        (this.qe.forEach((e, t) => {
          ...
          (t.forEachWhile((e) => {
            let t = this.Je(e);
            return !t || 'TargetPurposeLimboResolution' === t.purpose || ((n = !1), !1);
          }),
            n && (r = r.add(e)));
        }),
          this.ke.forEach((t, r) => r.setReadTime(e)));
        let n = new nd(e, t, this.Qe, this.ke, r);
        return ((this.ke = rR), (this.qe = nb()), (this.Qe = new tS(ta)), n);
      }
      $e(e, t) {
        if (!this.ze(e)) return;
        let r = 2 * !!this.it(e, t.key);
      ...
      Ye(e) {
        let t = this.Ge(e).ve();
        return (
          this.Le.getRemoteKeysForTarget(e).size + t.addedDocuments.size - t.removedDocuments.size
        );
      }
      xe(e) {
        this.Ge(e).xe();
      ...
      Ge(e) {
        let t = this.Be.get(e);
        return (t || ((t = new nv()), this.Be.set(e, t)), t);
      }
      st(e) {
        let t = this.qe.get(e);
        return (t || ((t = new tD(ta)), (this.qe = this.qe.insert(e, t))), t);
      }
      ze(e) {
        let t = null !== this.Je(e);
        return (t || eZ('WatchChangeAggregator', 'Detected inactive target', e), t);
      }
      Je(e) {
        let t = this.Be.get(e);
    ...
    function nb() {
      return new tS(tp.comparator);
    }
    function nE() {
      return new tS(tp.comparator);
    }
    let n_ = { asc: 'ASCENDING', desc: 'DESCENDING' },
      nT = {
        '<': 'LESS_THAN',
        '<=': 'LESS_THAN_OR_EQUAL',
        '>': 'GREATER_THAN',
    ...
    function nN(e, t) {
      return nk(e, t).canonicalString();
    }
    function nk(e, t) {
      let r = new tc(['projects', e.projectId, 'databases', e.database]).child('documents');
      return void 0 === t ? r : r.child(t);
    }
    function nR(e) {
      let t = tc.fromString(e);
      return (nj(t) || e3(), t);
    }
    function nL(e, t) {
      return nN(e.databaseId, t.path);
    }
    function nO(e, t) {
      let r = nR(t);
    ...
    function nV(e) {
      return ((e.length > 4 && 'documents' === e.get(4)) || e3(), e.popFirst(5));
    }
    function nF(e, t, r) {
      return { name: nL(e, t), fields: r.value.mapValue.fields };
    }
    function nU(e) {
      return { fieldPath: e.canonicalString() };
    }
    function nB(e) {
      return td.fromServerFormat(e.fieldPath);
    }
    function nj(e) {
    ...
    class nq {
      ...
      constructor(e, t, r, n, i = th.min(), s = th.min(), a = tR.EMPTY_BYTE_STRING, o = null) {
        ((this.target = e),
          (this.targetId = t),
          (this.purpose = r),
    ...
    class nK {
      ...
      Tt(e, t) {
        ...
        else if ('integerValue' in e) (this.dt(t, 15), t.At(tM(e.integerValue)));
        else if ('doubleValue' in e) {
          let r = tM(e.doubleValue);
          isNaN(r) ? this.dt(t, 13) : (this.dt(t, 15), tE(r) ? t.At(0) : t.At(r));
        } else if ('timestampValue' in e) {
          let r = e.timestampValue;
          (this.dt(t, 20),
            'string' == typeof r && (r = tO(r)),
            t.Rt(''.concat(r.seconds || '')),
            t.At(r.nanos || 0));
        } else if ('stringValue' in e) (this.Vt(e.stringValue, t), this.ft(t));
        else if ('bytesValue' in e) (this.dt(t, 30), t.gt(tP(e.bytesValue)), this.ft(t));
      ...
      St(e, t) {
        let r = e.fields || {};
        for (let e of (this.dt(t, 55), Object.keys(r))) (this.Vt(e, t), this.Tt(r[e], t));
      }
      wt(e, t) {
        var r, n;
        let i = e.fields || {};
        ...
        let s = 'value',
          a =
            (null == (n = null == (r = i[s].arrayValue) ? void 0 : r.values) ? void 0 : n.length) ||
            0;
        (this.dt(t, 15), t.At(tM(a)), this.Vt(s, t), this.Tt(i[s], t));
      }
      bt(e, t) {
        let r = e.values || [];
    ...
    class nG {
      addToCollectionParentIndex(e, t) {
        return (this.un.add(t), tv.resolve());
      }
      getCollectionParents(e, t) {
        return tv.resolve(this.un.getEntries(t));
      }
      addFieldIndex(e, t) {
        return tv.resolve();
      }
    ...
    class nH {
      add(e) {
        let t = e.lastSegment(),
          r = e.popLast(),
          n = this.index[t] || new tD(tc.comparator),
          i = !n.has(r);
      ...
      getEntries(e) {
        return (this.index[e] || new tD(tc.comparator)).toArray();
      }
      constructor() {
        this.index = {};
      }
    ...
    class nQ {
      static withCacheSize(e) {
        return new nQ(
          e,
          nQ.DEFAULT_COLLECTION_PERCENTILE,
          nQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
        );
      }
      constructor(e, t, r) {
    ...
    ((nQ.DEFAULT_COLLECTION_PERCENTILE = 10),
      (nQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
      (nQ.DEFAULT = new nQ(
        0x2800000,
        nQ.DEFAULT_COLLECTION_PERCENTILE,
        nQ.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
      )),
      (nQ.DISABLED = new nQ(-1, 0, 0)));
    class nW {
      next() {
    ...
    class nX {
      ...
      removeEntry(e, t) {
        (this.assertNotApplied(), this.changes.set(e, t8.newInvalidDocument(e).setReadTime(t)));
      }
      getEntry(e, t) {
        this.assertNotApplied();
        let r = this.changes.get(t);
        return void 0 !== r ? tv.resolve(r) : this.getFromCache(e, t);
      }
      getEntries(e, t) {
    ...
    class nJ {
      getDocument(e, t) {
        ...
        return this.documentOverlayCache
          ...
          .next((e) => (null !== r && r6(r.mutation, e, tN.empty(), tl.now()), e));
      }
      getDocuments(e, t) {
        return this.remoteDocumentCache
          .getEntries(e, t)
          .next((t) => this.getLocalViewOfDocuments(e, t, rU()).next(() => t));
      }
      getLocalViewOfDocuments(e, t) {
        let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : rU(),
          n = rP();
      ...
      getOverlayedDocuments(e, t) {
        let r = rP();
        return this.populateOverlays(e, r, t).next(() => this.computeViews(e, t, r, rU()));
      }
      ...
      computeViews(e, t, r, n) {
        ...
        return (
          t.forEach((e, t) => {
            let a = r.get(t.key);
            n.has(t.key) && (void 0 === a || a.mutation instanceof r4)
              ? (i = i.insert(t.key, t))
              : void 0 !== a
                ? (s.set(t.key, a.mutation.getFieldMask()),
                  r6(a.mutation, t, a.mutation.getFieldMask(), tl.now()))
                : s.set(t.key, tN.empty());
          }),
          this.recalculateAndSaveOverlays(e, i).next(
            (e) => (
              ...
              t.forEach((e, t) => {
                var r;
                return a.set(e, new nY(t, null != (r = s.get(e)) ? r : null));
              }),
              a
            ),
          )
        ...
        return this.mutationQueue
          ...
          .next((e) => {
            for (let i of e)
              i.keys().forEach((e) => {
                let s = t.get(e);
                if (null === s) return;
                let a = r.get(e) || tN.empty();
                ((a = i.applyToLocalView(s, a)), r.set(e, a));
                let o = (n.get(i.batchId) || rU()).add(e);
          ...
          .next(() => {
            ...
            for (; a.hasNext(); ) {
              ...
              (l.forEach((e) => {
                if (!i.has(e)) {
                  let n = r3(t.get(e), r.get(e));
                  (null !== n && h.set(e, n), (i = i.add(e)));
                }
              }),
                s.push(this.documentOverlayCache.saveOverlays(e, o, h)));
            }
            return tv.waitFor(s);
          })
          .next(() => r);
      ...
      getDocumentsMatchingQuery(e, t, r, n) {
        return tp.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length
        ...
        return this.remoteDocumentCache.getAllFromCollectionGroup(e, t, r, n).next((i) => {
          ...
          return s.next((t) =>
            tv
              ...
              .next(() => this.computeViews(e, o, t, rU()))
              .next((e) => ({ batchId: a, changes: rM(e) })),
          );
        });
      }
      getDocumentsMatchingDocumentQuery(e, t) {
        return this.getDocument(e, new tp(t)).next((e) => {
          let t = rO();
      ...
      getDocumentsMatchingCollectionQuery(e, t, r, n) {
        ...
        return this.documentOverlayCache
          ...
          .next((s) => ((i = s), this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, r, i, n)))
          .next((e) => {
            i.forEach((t, r) => {
              let n = r.getKey();
              null === e.get(n) && (e = e.insert(n, t8.newInvalidDocument(n)));
            });
            let r = rO();
            return (
              e.forEach((e, n) => {
                let s = i.get(e);
                (void 0 !== s && r6(s.mutation, n, tN.empty(), tl.now()),
                  rx(t, n) && (r = r.insert(e, n)));
              }),
              r
            );
          });
    ...
    class n$ {
      getBundleMetadata(e, t) {
        return tv.resolve(this.hr.get(t));
      }
      saveBundleMetadata(e, t) {
        return (
          this.hr.set(t.id, { id: t.id, version: t.version, createTime: nx(t.createTime) }),
          tv.resolve()
        );
      }
      getNamedQuery(e, t) {
        return tv.resolve(this.Pr.get(t));
      }
      saveNamedQuery(e, t) {
        return (
          this.Pr.set(t.name, {
            ...
            query: (function (e) {
              let t = (function (e) {
                ...
                let r,
                  n = (function (e) {
                    let t = nR(e);
                    return 4 === t.length ? tc.emptyPath() : nV(t);
                  })(e.parent),
                  i = e.structuredQuery,
                ...
                i.where &&
                  (o = (function (e) {
                      ...
                      return void 0 !== t.unaryFilter
                        ? (function (e) {
                            switch (e.unaryFilter.op) {
                              case 'IS_NAN':
                                let t = nB(e.unaryFilter.field);
                                return rr.create(t, '==', { doubleValue: NaN });
                              case 'IS_NULL':
                                let r = nB(e.unaryFilter.field);
                                return rr.create(r, '==', { nullValue: 'NULL_VALUE' });
                              case 'IS_NOT_NAN':
                                let n = nB(e.unaryFilter.field);
                                return rr.create(n, '!=', { doubleValue: NaN });
                              case 'IS_NOT_NULL':
                                let i = nB(e.unaryFilter.field);
                                return rr.create(i, '!=', { nullValue: 'NULL_VALUE' });
                              default:
                                return e3();
                            }
                          })(t)
                    ...
                    return r instanceof rn && rs((t = r)) && ri(t) ? r.getFilters() : [r];
                  })(i.where));
                let l = [];
                i.orderBy &&
                  (l = i.orderBy.map(
                ...
                let h = null;
                i.limit &&
                  (h = null == (r = 'object' == typeof (t = i.limit) ? t.value : t) ? null : r);
                let u = null;
                i.startAt &&
                  (u = (function (e) {
                    let t = !!e.before;
                    return new t4(e.values || [], t);
                  })(i.startAt));
                let c = null;
                return (
                  i.endAt &&
                  ...
                  new rw(n, a, l, o, h, 'F', u, c)
                );
              })({ parent: e.parent, structuredQuery: e.structuredQuery });
              return 'LAST' === e.limitType ? rS(t, t.limit, 'L') : t;
            })(t.bundledQuery),
            readTime: nx(t.readTime),
          }),
          tv.resolve()
        );
      }
    ...
    class nZ {
      getOverlay(e, t) {
        return tv.resolve(this.overlays.get(t));
      }
      getOverlays(e, t) {
        let r = rP();
        return tv
      ...
      removeOverlaysForBatchId(e, t, r) {
        ...
        return (
          void 0 !== n &&
            (n.forEach((e) => (this.overlays = this.overlays.remove(e))), this.Ir.delete(r)),
          tv.resolve()
        );
      }
      ...
      getOverlaysForCollectionGroup(e, t, r, n) {
        ...
        for (; s.hasNext(); ) {
          ...
          if (e.getKey().getCollectionGroup() === t && e.largestBatchId > r) {
            ...
            (null === t && ((t = rP()), (i = i.insert(e.largestBatchId, t))), t.set(e.getKey(), e));
          }
        }
        let a = rP(),
          o = i.getIterator();
        for (
          ;
          o.hasNext() && (o.getNext().value.forEach((e, t) => a.set(e, t)), !(a.size() >= n));
      ...
      ht(e, t, r) {
        ...
        this.overlays = this.overlays.insert(r.key, new ns(t, r));
        let i = this.Ir.get(t);
        (void 0 === i && ((i = rU()), this.Ir.set(t, i)), this.Ir.set(t, i.add(r.key)));
      }
      constructor() {
        ((this.overlays = new tS(tp.comparator)), (this.Ir = new Map()));
      }
    }
    class n0 {
      getSessionToken(e) {
        return tv.resolve(this.sessionToken);
      }
      setSessionToken(e, t) {
        return ((this.sessionToken = t), tv.resolve());
      }
      constructor() {
    ...
    class n1 {
      ...
      constructor() {
        ((this.Tr = new tD(n2.Er)), (this.dr = new tD(n2.Ar)));
      }
    }
    class n2 {
      static Er(e, t) {
        return tp.comparator(e.key, t.key) || ta(e.wr, t.wr);
      }
      static Ar(e, t) {
        return ta(e.wr, t.wr) || tp.comparator(e.key, t.key);
      }
      constructor(e, t) {
    ...
    class n3 {
      checkEmpty(e) {
        return tv.resolve(0 === this.mutationQueue.length);
      }
      addMutationBatch(e, t, r, n) {
        let i = this.Sr;
        (this.Sr++,
          this.mutationQueue.length > 0 && this.mutationQueue[this.mutationQueue.length - 1]);
        let s = new nn(i, t, r, n);
        for (let t of (this.mutationQueue.push(s), n))
          ((this.br = this.br.add(new n2(t.key, i))),
            this.indexManager.addToCollectionParentIndex(e, t.key.path.popLast()));
        return tv.resolve(s);
      }
      lookupMutationBatch(e, t) {
        return tv.resolve(this.Dr(t));
      }
      getNextMutationBatchAfterBatchId(e, t) {
        let r = this.vr(t + 1),
          n = r < 0 ? 0 : r;
        return tv.resolve(this.mutationQueue.length > n ? this.mutationQueue[n] : null);
      }
      getHighestUnacknowledgedBatchId() {
        return tv.resolve(0 === this.mutationQueue.length ? -1 : this.Sr - 1);
      }
      getAllMutationBatches(e) {
        return tv.resolve(this.mutationQueue.slice());
      }
      ...
      getAllMutationBatchesAffectingQuery(e, t) {
        let r = t.path,
          n = r.length + 1,
          i = r;
        tp.isDocumentKey(i) || (i = i.child(''));
        let s = new n2(new tp(i), 0),
          a = new tD(ta);
        return (
          this.br.forEachWhile((e) => {
            let t = e.key.path;
            return !!r.isPrefixOf(t) && (t.length === n && (a = a.add(e.wr)), !0);
          }, s),
          tv.resolve(this.Cr(a))
        );
      }
      Cr(e) {
        let t = [];
      ...
      removeMutationBatch(e, t) {
        (0 === this.Fr(t.batchId, 'removed') || e3(), this.mutationQueue.shift());
        let r = this.br;
        return tv
          .forEach(t.mutations, (n) => {
            let i = new n2(n.key, t.batchId);
            return ((r = r.delete(i)), this.referenceDelegate.markPotentiallyOrphaned(e, n.key));
          })
          .next(() => {
            this.br = r;
          });
      ...
      containsKey(e, t) {
        ...
        return tv.resolve(t.isEqual(n && n.key));
      }
      performConsistencyCheck(e) {
        return (this.mutationQueue.length, tv.resolve());
      }
      Fr(e, t) {
        return this.vr(e);
      }
    ...
    class n6 {
      ...
      addEntry(e, t) {
        let r = t.key,
          ...
          s = this.Mr(t);
        return (
          (this.docs = this.docs.insert(r, { document: t.mutableCopy(), size: s })),
          (this.size += s - i),
      ...
      getEntry(e, t) {
        ...
        return tv.resolve(r ? r.document.mutableCopy() : t8.newInvalidDocument(t));
      }
      getEntries(e, t) {
        let r = rR;
        return (
          t.forEach((e) => {
            let t = this.docs.get(e);
            r = r.insert(e, t ? t.document.mutableCopy() : t8.newInvalidDocument(e));
          }),
          tv.resolve(r)
        );
      }
          ...
          e.path.length > s.length + 1 ||
            0 >=
              (function (e, t) {
                ...
                return 0 !== r || 0 !== (r = tp.comparator(e.documentKey, t.documentKey))
                  ? r
                  : ta(e.largestBatchId, t.largestBatchId);
              })(new tg(a.readTime, a.key, -1), r) ||
            ((n.has(a.key) || rx(t, a)) && (i = i.insert(a.key, a.mutableCopy())));
        }
        return tv.resolve(i);
      }
      ...
      Or(e, t) {
        return tv.forEach(this.docs, (e) => t(e));
      }
      newChangeBuffer(e) {
        return new n5(this);
      }
      getSize(e) {
        return tv.resolve(this.size);
      }
      constructor(e) {
        ((this.Mr = e), (this.docs = new tS(tp.comparator)), (this.size = 0));
      }
    }
    class n5 extends nX {
      applyChanges(e) {
        ...
        return (
          this.changes.forEach((r, n) => {
            n.isValidDocument() ? t.push(this.cr.addEntry(e, n)) : this.cr.removeEntry(r);
          }),
          tv.waitFor(t)
        );
      }
    ...
    class n8 {
      forEachTarget(e, t) {
        return (this.Nr.forEach((e, r) => t(r)), tv.resolve());
      }
      getLastRemoteSnapshotVersion(e) {
        return tv.resolve(this.lastRemoteSnapshotVersion);
      }
      getHighestSequenceNumber(e) {
        return tv.resolve(this.Lr);
      }
      allocateTargetId(e) {
        return ((this.highestTargetId = this.kr.next()), tv.resolve(this.highestTargetId));
      }
      ...
      Kn(e) {
        ...
        let t = e.targetId;
        (t > this.highestTargetId && ((this.kr = new nW(t)), (this.highestTargetId = t)),
          e.sequenceNumber > this.Lr && (this.Lr = e.sequenceNumber));
      }
      addTargetData(e, t) {
        return (this.Kn(t), (this.targetCount += 1), tv.resolve());
      }
      updateTargetData(e, t) {
        return (this.Kn(t), tv.resolve());
      }
        ...
        return (
          this.Nr.forEach((s, a) => {
            a.sequenceNumber <= t &&
              ...
              (this.Nr.delete(s), i.push(this.removeMatchingKeysForTargetId(e, a.targetId)), n++);
          }),
          tv.waitFor(i).next(() => n)
        );
      }
      getTargetCount(e) {
        return tv.resolve(this.targetCount);
      }
      getTargetData(e, t) {
      ...
      addMatchingKeys(e, t, r) {
        return (this.Br.Rr(t, r), tv.resolve());
      }
      ...
      removeMatchingKeysForTargetId(e, t) {
        return (this.Br.gr(t), tv.resolve());
      }
      ...
      containsKey(e, t) {
        return tv.resolve(this.Br.containsKey(t));
      }
      constructor(e) {
        ((this.persistence = e),
          (this.Nr = new rk((e) => rm(e), ry)),
          (this.lastRemoteSnapshotVersion = th.min()),
    ...
    class n4 {
      ...
      getDocumentOverlayCache(e) {
        ...
        return (t || ((t = new nZ()), (this.overlays[e.toKey()] = t)), t);
      }
      getMutationQueue(e, t) {
        let r = this.qr[e.toKey()];
        return (r || ((r = new n3(t, this.referenceDelegate)), (this.qr[e.toKey()] = r)), r);
      }
      getGlobalsCache() {
        return this.$r;
      }
      ...
      runTransaction(e, t, r) {
        eZ('MemoryPersistence', 'Starting transaction:', e);
        let n = new n7(this.Qr.next());
        return (
      ...
      Hr(e, t) {
        return tv.or(Object.values(this.qr).map((r) => () => r.containsKey(e, t)));
      }
      constructor(e, t) {
        ((this.qr = {}),
          (this.overlays = {}),
          ...
          (this.Ur = new n8(this)),
          (this.indexManager = new nG()),
          (this.remoteDocumentCache = new n6((e) => this.referenceDelegate.Wr(e))),
          (this.serializer = new nz(t)),
          (this.Gr = new n$(this.serializer)));
      }
    }
    class n7 extends tm {
      constructor(e) {
    ...
    class n9 {
      ...
      addReference(e, t, r) {
        return (this.Jr.addReference(r, t), this.Xr.delete(r.toString()), tv.resolve());
      }
      removeReference(e, t, r) {
        return (this.Jr.removeReference(r, t), this.Xr.add(r.toString()), tv.resolve());
      }
      markPotentiallyOrphaned(e, t) {
        return (this.Xr.add(t.toString()), tv.resolve());
      }
      removeTarget(e, t) {
      ...
      ei(e, t) {
        return tv.or([
          () => tv.resolve(this.Jr.containsKey(t)),
          () => this.persistence.getTargetCache().containsKey(e, t),
          () => this.persistence.Hr(e, t),
        ]);
      }
      constructor(e) {
        ((this.persistence = e), (this.Jr = new n1()), (this.Yr = null));
      }
    }
    class ie {
      static Wi(e, t) {
        ...
        return new ie(e, t.fromCache, r, n);
      }
      constructor(e, t, r, n) {
        ((this.targetId = e), (this.fromCache = t), (this.$i = r), (this.Ui = n));
      }
    }
    class it {
    ...
    class ir {
          ...
          : (e$() <= n.DEBUG &&
            ...
            r.documentReadCount > this.Hi * i
              ? (e$() <= n.DEBUG &&
                ...
                this.indexManager.createTargetIndexes(e, rT(t)))
              : tv.resolve());
      }
      Yi(e, t) {
        if (rb(t)) return tv.resolve(null);
        let r = rT(t);
        return this.indexManager.getIndexType(e, r).next((n) =>
          0 === n
            ? null
            : (null !== t.limit && 1 === n && (r = rT((t = rS(t, null, 'F')))),
                ...
                : (e$() <= n.DEBUG &&
                  ...
                  this.rs(
                    ...
                    (function (e, t) {
                      ...
                      return new tg(
                        th.fromTimestamp(1e9 === n ? new tl(r + 1, 0) : new tl(r, n)),
                        tp.empty(),
                        -1,
                      );
                    })(i, 0),
      ...
      Xi(e, t, r) {
        return (
          e$() <= n.DEBUG &&
            eZ('QueryEngine', 'Using full collection scan to execute query:', rD(t)),
          this.Ji.getDocumentsMatchingQuery(e, t, tg.min(), r)
        );
      }
      rs(e, t, r, n) {
      ...
      constructor() {
        ((this.Gi = !1),
          ...
          (this.Hi =
            !(function () {
              var t;
              let r = null == (t = C()) ? void 0 : t.forceEnvironment;
              if ('node' === r) return !0;
    ...
    async function is(e, t) {
      return await e.persistence.runTransaction('Handle user change', 'readonly', (r) => {
        ...
        return e.mutationQueue
          ...
          .next((i) => ((n = i), e.ls(t), e.mutationQueue.getAllMutationBatches(r)))
          .next((t) => {
            let i = [],
              s = [],
              a = rU();
            for (let e of n) for (let t of (i.push(e.batchId), e.mutations)) a = a.add(t.key);
            for (let e of t) for (let t of (s.push(e.batchId), e.mutations)) a = a.add(t.key);
    ...
    function ia(e) {
      return e.persistence.runTransaction('Get last remote snapshot version', 'readonly', (t) =>
        e.Ur.getLastRemoteSnapshotVersion(t),
      );
    }
    async function io(e, t, r) {
      ...
      try {
        ...
        if (!tw(e)) throw e;
        eZ('LocalStore', 'Failed to update sequence numbers for target '.concat(t, ': ').concat(e));
      }
      ((e.os = e.os.remove(t)), e._s.delete(n.target));
    }
    function il(e, t, r) {
      let n = th.min(),
        i = rU();
      return e.persistence.runTransaction('Execute query', 'readwrite', (s) =>
        (function (e, t, r) {
          let n = e._s.get(r);
          return void 0 !== n ? tv.resolve(e.os.get(n)) : e.Ur.getTargetData(t, r);
        })(e, s, rT(t))
          .next((t) => {
            if (t)
              return (
          ...
          .next(() => e.ss.getDocumentsMatchingQuery(s, t, r ? n : th.min(), r ? i : rU()))
          .next((r) => {
            var n, s, a;
            let o;
            return (
    ...
    class iu {
      ...
      start() {
        return ((this.so = new ih()), Promise.resolve());
      }
    ...
    class id {
      ...
      uo() {
        for (let e of (eZ('ConnectivityMonitor', 'Network connectivity changed: AVAILABLE'),
        this.ho))
          e(0);
      }
      lo() {
        for (let e of (eZ('ConnectivityMonitor', 'Network connectivity changed: UNAVAILABLE'),
        this.ho))
          e(1);
      }
      static D() {
    ...
    function ig() {
      return (
        null === ip ? (ip = 0x10000000 + Math.round(0x80000000 * Math.random())) : ip++,
        '0x' + ip.toString(16)
      );
    }
    let im = {
    ...
    class iw extends class {
      ...
      Mo(e, t, r, n, i) {
        ...
        eZ('RestConnection', "Sending RPC '".concat(e, "' ").concat(s, ':'), a, r);
        let o = { 'google-cloud-resource-prefix': this.vo, 'x-goog-request-params': this.Co };
        return (
          this.Oo(o, n, i),
          this.No(e, a, o, r).then(
            (t) => (eZ('RestConnection', "Received RPC '".concat(e, "' ").concat(s, ': '), t), t),
            (t) => {
              throw (
                e1(
                  'RestConnection',
                  "RPC '".concat(e, "' ").concat(s, ' failed with error: '),
                  t,
                  'url: ',
                  a,
                  'request:',
      ...
      xo(e, t) {
        let r = im[e];
        return ''.concat(this.Do, '/v1/').concat(t, ':').concat(r);
      }
      terminate() {}
      constructor(e) {
        ...
        ((this.Do = t + '://' + e.host),
          (this.vo = 'projects/'.concat(r, '/databases/').concat(n)),
          (this.Co =
            '(default)' === this.databaseId.database
              ? 'project_id='.concat(r)
              : 'project_id='.concat(r, '&database_id=').concat(n)));
      }
    } {
      No(e, t, r, n) {
        let i = ig();
              ...
              try {
                switch (u.getLastErrorCode()) {
                  case h.NO_ERROR:
                    ...
                    (eZ(
                      iv,
                      "XHR for RPC '".concat(e, "' ").concat(i, ' received:'),
                      JSON.stringify(t),
                    ),
                      s(t));
                    break;
                  case h.TIMEOUT:
                    (eZ(iv, "RPC '".concat(e, "' ").concat(i, ' timed out')),
                      o(new e5(e6.DEADLINE_EXCEEDED, 'Request time out')));
                    break;
                  case h.HTTP_ERROR:
                    let r = u.getStatus();
                    if (
                      ...
                      let e = u.getResponseJson();
                      Array.isArray(e) && (e = e[0]);
                      let t = null == e ? void 0 : e.error;
                      if (t && t.status && t.message) {
                        let e = (function (e) {
                          let t = e.toLowerCase().replace(/_/g, '-');
                          return Object.values(e6).indexOf(t) >= 0 ? t : e6.UNKNOWN;
                        })(t.status);
                        o(new e5(e, t.message));
                      } else o(new e5(e6.UNKNOWN, 'Server responded with status ' + u.getStatus()));
                    } else o(new e5(e6.UNAVAILABLE, 'Connection failed.'));
                    break;
                  default:
                    e3();
                }
              } finally {
                eZ(iv, "RPC '".concat(e, "' ").concat(i, ' completed.'));
              }
            }));
          let c = JSON.stringify(n);
          (eZ(iv, "RPC '".concat(e, "' ").concat(i, ' sending request:'), n),
      ...
      Bo(e, t, r) {
        let n = ig(),
          ...
          l = {
            ...
            messageUrlParams: {
              database: 'projects/'
                .concat(this.databaseId.projectId, '/databases/')
                .concat(this.databaseId.database),
            },
            sendRawJson: !0,
        ...
        (void 0 !== h && (l.longPollingTimeout = Math.round(1e3 * h)),
          this.useFetchStreams && (l.useFetchStreams = !0),
          this.Oo(l.initMessageHeaders, t, r),
          (l.encodeInitMessageHeaders = !0));
        let g = i.join('');
        eZ(iv, "Creating RPC '".concat(e, "' stream ").concat(n, ': ').concat(g), l);
          ...
          w = new iy({
            Io: (t) => {
              v
                ? eZ(
                    iv,
                    "Not sending because RPC '".concat(e, "' stream ").concat(n, ' is closed:'),
                    t,
                  )
                : (y ||
                    (eZ(iv, "Opening RPC '".concat(e, "' stream ").concat(n, ' transport.')),
                    m.open(),
                    (y = !0)),
                  eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' sending:'), t),
                  m.send(t));
            },
            To: () => m.close(),
          }),
        ...
        return (
          b(m, o.EventType.OPEN, () => {
            v || (eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' transport opened.')), w.yo());
          }),
          b(m, o.EventType.CLOSE, () => {
            v ||
              ((v = !0),
              eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' transport closed')),
              w.So());
          }),
          b(m, o.EventType.ERROR, (t) => {
            v ||
              ((v = !0),
              e1(iv, "RPC '".concat(e, "' stream ").concat(n, ' transport errored:'), t),
              w.So(new e5(e6.UNAVAILABLE, 'The operation could not be completed')));
          }),
          b(m, o.EventType.MESSAGE, (t) => {
            var r;
            if (!v) {
              let i = t.data[0];
              i || e3();
              let s = i.error || (null == (r = i[0]) ? void 0 : r.error);
              if (s) {
                eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' received error:'), s);
                let t = s.status,
                  r = (function (e) {
                    let t = p[e];
                    if (void 0 !== t) return no(t);
                  })(t),
                  i = s.message;
                (void 0 === r &&
                  ((r = e6.INTERNAL),
                  (i = 'Unknown error status: ' + t + ' with message ' + s.message)),
                  (v = !0),
                  w.So(new e5(r, i)),
                  m.close());
              } else (eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' received:'), i), w.bo(i));
            }
          }),
          b(a, c.STAT_EVENT, (t) => {
            t.stat === u.PROXY
              ? eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' detected buffering proxy'))
              : t.stat === u.NOPROXY &&
                eZ(iv, "RPC '".concat(e, "' stream ").concat(n, ' detected no buffering proxy'));
          }),
          setTimeout(() => {
            w.wo();
          }, 0),
    ...
    class iT {
      ...
      async close(e, t) {
        (this.u_(),
          ...
          4 !== e
            ? this.t_.reset()
            : t && t.code === e6.RESOURCE_EXHAUSTED
              ? (e0(t.toString()),
                e0('Using maximum backoff delay to prevent overloading the backend.'),
                this.t_.Wo())
              : t &&
                t.code === e6.UNAUTHENTICATED &&
                3 !== this.state &&
      ...
      auth() {
        ...
        Promise.all([
          ...
          (e) => {
            let [r, n] = e;
            this.Yo === t && this.P_(r, n);
          },
          (t) => {
            e(() => {
              let e = new e5(e6.UNKNOWN, 'Fetching auth token failed: ' + t.message);
              return this.I_(e);
            });
          },
        );
      ...
      P_(e, t) {
        ...
        ((this.stream = this.T_(e, t)),
          ...
          this.stream.onMessage((e) => {
            r(() => (1 == ++this.e_ ? this.E_(e) : this.onNext(e)));
          }));
      }
      i_() {
        ((this.state = 5),
      ...
      I_(e) {
        return (
          eZ('PersistentStream', 'close with error: '.concat(e)),
          (this.stream = null),
          this.close(4, e)
        );
      }
      h_(e) {
        return (t) => {
          this.ui.enqueueAndForget(() =>
            this.Yo === e
              ? t()
              : (eZ('PersistentStream', 'stream callback skipped by getCloseGuardedDispatcher.'),
                Promise.resolve()),
          );
        };
      }
    ...
    class iI extends iT {
      ...
      onNext(e) {
        ...
        let t = (function (e, t) {
            ...
            if ('targetChange' in t) {
              ...
              t.targetChange;
              let s =
                  'NO_CHANGE' === (n = t.targetChange.targetChangeType || 'NO_CHANGE')
                    ? 0
                    : 'ADD' === n
                      ? 1
                      : 'REMOVE' === n
                ...
                o =
                  ...
                  e.useProto3Json
                    ? (void 0 === i || 'string' == typeof i || e3(), tR.fromBase64String(i || ''))
                    : (void 0 === i || i instanceof ez.Buffer || i instanceof Uint8Array || e3(),
                      tR.fromUint8Array(i || new Uint8Array()))),
                l = t.targetChange.cause;
              r = new ny(
                s,
                a,
                o,
                (l && new e5(void 0 === l.code ? e6.UNKNOWN : no(l.code), l.message || '')) || null,
              );
            } else if ('documentChange' in t) {
              t.documentChange;
              let n = t.documentChange;
              (n.document, n.document.name, n.document.updateTime);
              let i = nO(e, n.document.name),
                s = nx(n.document.updateTime),
                a = n.document.createTime ? nx(n.document.createTime) : th.min(),
                o = new t5({ mapValue: { fields: n.document.fields } }),
                l = t8.newFoundDocument(i, s, a, o);
              r = new ng(n.targetIds || [], n.removedTargetIds || [], l.key, l);
            } else if ('documentDelete' in t) {
              t.documentDelete;
              let n = t.documentDelete;
              n.document;
              let i = nO(e, n.document),
                s = n.readTime ? nx(n.readTime) : th.min(),
                a = t8.newNoDocument(i, s);
              r = new ng([], n.removedTargetIds || [], a.key, a);
            } else if ('documentRemove' in t) {
              t.documentRemove;
              let n = t.documentRemove;
              n.document;
              let i = nO(e, n.document);
              r = new ng([], n.removedTargetIds || [], i, null);
            } else {
              if (!('filter' in t)) return e3();
              {
                t.filter;
                let e = t.filter;
                e.targetId;
                let { count: n = 0, unchangedNames: i } = e,
                  s = new na(n, i);
                r = new nm(e.targetId, s);
              }
            }
            return r;
          })(this.serializer, e),
          r = (function (e) {
            if (!('targetChange' in e)) return th.min();
      ...
      A_(e) {
        let t = {};
        ((t.database = nP(this.serializer)),
          (t.addTarget = (function (e, t) {
            let r,
              n = t.target;
            if (
              (((r = rv(n)
                ? { documents: { documents: [nM(e, n.path)] } }
                : {
                    query: (function (e, t) {
                      var r, n;
                      let i,
                          ...
                          return (function e(t) {
                            return t instanceof rr
                              ? (function (e) {
                                  if ('==' === e.op) {
                                    if (t0(e.value))
                                      return { unaryFilter: { field: nU(e.field), op: 'IS_NAN' } };
                                    if (tZ(e.value))
                                      return { unaryFilter: { field: nU(e.field), op: 'IS_NULL' } };
                                  } else if ('!=' === e.op) {
                                    if (t0(e.value))
                                      return {
                                        unaryFilter: { field: nU(e.field), op: 'IS_NOT_NAN' },
                                      };
                                    if (tZ(e.value))
                                      return {
                                        unaryFilter: { field: nU(e.field), op: 'IS_NOT_NULL' },
                                      };
                                  }
                                  return {
                                    fieldFilter: {
                              ...
                              : t instanceof rn
                                ? (function (t) {
                                    ...
                                    return 1 === r.length
                                      ? r[0]
                                      : { compositeFilter: { op: nI[t.op], filters: r } };
                                  })(t)
                                : e3();
                          })(rn.create(e, 'and'));
                      })(t.filters);
                      ...
                      let l = (function (e) {
                        if (0 !== e.length)
                          return e.map((e) => ({ field: nU(e.field), direction: n_[e.dir] }));
                      })(t.orderBy);
                      l && (s.structuredQuery.orderBy = l);
                      let h = nC(e, t.limit);
                      return (
                        null !== h && (s.structuredQuery.limit = h),
                        t.startAt &&
              ...
              r.resumeToken = nD(e, t.resumeToken);
              let n = nC(e, t.expectedCount);
              null !== n && (r.expectedCount = n);
            } else if (t.snapshotVersion.compareTo(th.min()) > 0) {
              r.readTime = nA(e, t.snapshotVersion.toTimestamp());
              let n = nC(e, t.expectedCount);
              null !== n && (r.expectedCount = n);
            }
            return r;
      ...
      R_(e) {
        let t = {};
        ((t.database = nP(this.serializer)), (t.removeTarget = e), this.a_(t));
      }
    ...
    class iS extends iT {
      ...
      E_(e) {
        return (
          ...
          e.writeResults && 0 !== e.writeResults.length && e3(),
          this.listener.f_()
        );
      }
      onNext(e) {
        var t, r;
        (e.streamToken || e3(), (this.lastStreamToken = e.streamToken), this.t_.reset());
        let n =
            ((t = e.writeResults),
            (r = e.commitTime),
            t && t.length > 0
              ? (void 0 !== r || e3(),
                t.map((e) => {
                  let t;
                  return (
                    (t = e.updateTime ? nx(e.updateTime) : nx(r)).isEqual(th.min()) && (t = nx(r)),
                    new rZ(t, e.transformResults || [])
                  );
                }))
              : []),
          i = nx(e.commitTime);
        return this.listener.g_(i, n);
      }
      p_() {
        let e = {};
        ((e.database = nP(this.serializer)), this.a_(e));
      }
      m_(e) {
        let t = {
          ...
          writes: e.map((e) =>
            (function (e, t) {
              var r;
              let n;
              if (t instanceof r8) n = { update: nF(e, t.key, t.value) };
              else if (t instanceof nt) n = { delete: nL(e, t.key) };
              else if (t instanceof r4)
                n = {
                  update: nF(e, t.key, t.data),
                ...
                t.fieldTransforms.length > 0 &&
                  (n.updateTransforms = t.fieldTransforms.map((e) =>
                    (function (e, t) {
                      ...
                      if (r instanceof rY)
                        return { fieldPath: t.field.canonicalString(), increment: r.Pe };
                      throw e3();
                    })(0, e),
                  )),
                t.precondition.isNone ||
                  (n.currentDocument =
                    void 0 !== (r = t.precondition).updateTime
                      ? { updateTime: nA(e, r.updateTime.toTimestamp()) }
                      : void 0 !== r.exists
                        ? { exists: r.exists }
                        : e3()),
                n
    ...
    class iC extends class {} {
      w_() {
        if (this.y_)
          throw new e5(e6.FAILED_PRECONDITION, 'The client has already been terminated.');
      }
      Mo(e, t, r, n) {
        return (
          this.w_(),
          Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()])
            .then((i) => {
              let [s, a] = i;
              return this.connection.Mo(e, nk(t, r), n, s, a);
            })
            .catch((e) => {
              throw 'FirebaseError' === e.name
                ? (e.code === e6.UNAUTHENTICATED &&
                    (this.authCredentials.invalidateToken(),
                    this.appCheckCredentials.invalidateToken()),
                  e)
                : new e5(e6.UNKNOWN, e.toString());
            })
        );
      }
      Lo(e, t, r, n, i) {
        return (
          ...
          Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()])
            .then((s) => {
              let [a, o] = s;
              return this.connection.Lo(e, nk(t, r), n, a, o, i);
            })
            .catch((e) => {
              throw 'FirebaseError' === e.name
                ? (e.code === e6.UNAUTHENTICATED &&
    ...
    class iA {
      ...
      M_(e) {
        'Online' === this.state
          ...
          : (this.S_++,
            this.S_ >= 1 &&
              (this.x_(),
              this.F_('Connection failed 1 times. Most recent error: '.concat(e.toString())),
              this.C_('Offline')));
      }
      set(e) {
      ...
      F_(e) {
        let t = 'Could not reach Cloud Firestore backend. '.concat(
          e,
          '\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.',
        );
        this.D_ ? (e0(t), (this.D_ = !1)) : eZ('OnlineStateTracker', t);
      }
      x_() {
        ...
        ((this.localStore = e),
          ...
          this.k_._o((e) => {
            r.enqueueAndForget(async () => {
              iV(this) &&
                (eZ('RemoteStore', 'Restarting streams for network reachability change.'),
                await (async function (e) {
                  (e.L_.add(4), await iN(e), e.q_.set('Unknown'), e.L_.delete(4), await ix(e));
                })(this));
            });
          }),
          (this.q_ = new iA(r, n)));
    ...
    async function ix(e) {
      if (iV(e)) for (let t of e.B_) await t(!0);
    }
    async function iN(e) {
      for (let t of e.B_) await t(!1);
    }
    function ik(e, t) {
      e.N_.has(t.targetId) || (e.N_.set(t.targetId, t), iP(e) ? iM(e) : iZ(e).r_() && iL(e, t));
    }
    function iR(e, t) {
      let r = iZ(e);
      (e.N_.delete(t),
        r.r_() && iO(e, t),
        0 === e.N_.size && (r.r_() ? r.o_() : iV(e) && e.q_.set('Unknown')));
    }
    function iL(e, t) {
      if (
        (e.Q_.xe(t.targetId),
        t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(th.min()) > 0)
      ) {
    ...
    function iP(e) {
      return iV(e) && !iZ(e).n_() && e.N_.size > 0;
    }
    function iV(e) {
      return 0 === e.L_.size;
    }
    ...
    async function iB(e, t) {
      ((e.Q_ = void 0), iP(e) ? (e.q_.M_(t), iM(e)) : e.q_.set('Unknown'));
    }
    async function ij(e, t, r) {
      if ((e.q_.set('Online'), t instanceof ny && 2 === t.state && t.cause))
        try {
          await (async function (e, t) {
            let r = t.cause;
            for (let n of t.targetIds)
              e.N_.has(n) &&
                (await e.remoteSyncer.rejectListen(n, r), e.N_.delete(n), e.Q_.removeTarget(n));
          })(e, t);
        } catch (r) {
          (eZ('RemoteStore', 'Failed to remove targets %s: %s ', t.targetIds.join(','), r),
            await iq(e, r));
        }
      else if (
        (t instanceof ng ? e.Q_.Ke(t) : t instanceof nm ? e.Q_.He(t) : e.Q_.We(t),
        !r.isEqual(th.min()))
      )
        try {
          let t = await ia(e.localStore);
          r.compareTo(t) >= 0 &&
            (await (function (e, t) {
              let r = e.Q_.rt(t);
              return (
                r.targetChanges.forEach((r, n) => {
                  if (r.resumeToken.approximateByteSize() > 0) {
                    let i = e.N_.get(n);
                    i && e.N_.set(n, i.withResumeToken(r.resumeToken, t));
                  }
                }),
                r.targetMismatches.forEach((t, r) => {
                  let n = e.N_.get(t);
                  if (!n) return;
                  (e.N_.set(t, n.withResumeToken(tR.EMPTY_BYTE_STRING, n.snapshotVersion)),
                    iO(e, t));
                  let i = new nq(n.target, t, r, n.sequenceNumber);
                  iL(e, i);
                }),
          ...
          (eZ('RemoteStore', 'Failed to raise snapshot:', t), await iq(e, t));
        }
    }
    async function iq(e, t, r) {
      ...
      (e.L_.add(1),
        ...
        e.asyncQueue.enqueueRetryable(async () => {
          (eZ('RemoteStore', 'Retrying IndexedDB access'), await r(), e.L_.delete(1), await ix(e));
        }));
    }
    function iz(e, t) {
      return t().catch((r) => iq(e, r, t));
    }
    async function iK(e) {
      var t;
      let r = i0(e),
        n = e.O_.length > 0 ? e.O_[e.O_.length - 1].batchId : -1;
      for (; iV((t = e)) && t.O_.length < 10; )
        try {
    ...
    function iG(e) {
      return iV(e) && !i0(e).n_() && e.O_.length > 0;
    }
    function iH(e) {
      i0(e).start();
    }
    ...
    async function iW(e) {
      let t = i0(e);
      for (let r of e.O_) t.m_(r.mutations);
    }
    async function iX(e, t, r) {
      let n = e.O_.shift(),
        i = ni.from(n, t, r);
      (await iz(e, () => e.remoteSyncer.applySuccessfulWrite(i)), await iK(e));
    }
          ...
          if (
            (function (e) {
              switch (e) {
                ...
                case e6.CANCELLED:
                case e6.UNKNOWN:
                case e6.DEADLINE_EXCEEDED:
                case e6.RESOURCE_EXHAUSTED:
                case e6.INTERNAL:
                case e6.UNAVAILABLE:
                case e6.UNAUTHENTICATED:
                  return !1;
                case e6.INVALID_ARGUMENT:
                case e6.NOT_FOUND:
                case e6.ALREADY_EXISTS:
                case e6.PERMISSION_DENIED:
                case e6.FAILED_PRECONDITION:
                case e6.ABORTED:
                case e6.OUT_OF_RANGE:
                case e6.UNIMPLEMENTED:
                case e6.DATA_LOSS:
                  return !0;
              }
            })((r = t.code)) &&
            ...
            let r = e.O_.shift();
            (i0(e).s_(),
              await iz(e, () => e.remoteSyncer.rejectFailedWrite(r.batchId, t)),
              await iK(e));
          }
        })(e, t)),
        iG(e) && iH(e));
    ...
    async function iJ(e, t) {
      (e.asyncQueue.verifyOperationInProgress(),
        eZ('RemoteStore', 'RemoteStore received new credentials'));
      let r = iV(e);
      (e.L_.add(3),
        await iN(e),
        r && e.q_.set('Unknown'),
    ...
    async function i$(e, t) {
      t ? (e.L_.delete(2), await ix(e)) : t || (e.L_.add(2), await iN(e), e.q_.set('Unknown'));
    }
    function iZ(e) {
      var t, r, n;
      return (
        e.K_ ||
          ...
          e.B_.push(async (t) => {
            t
              ? (e.K_.s_(), iP(e) ? iM(e) : e.q_.set('Unknown'))
            ...
            t
              ...
              : (await e.U_.stop(),
                e.O_.length > 0 &&
                  (eZ(
                    'RemoteStore',
                    'Stopping write stream with '.concat(e.O_.length, ' pending writes'),
                  ),
                  (e.O_ = [])));
          })),
        e.U_
    ...
    class i1 {
      ...
      static createAndSchedule(e, t, r, n, i) {
        let s = new i1(e, t, Date.now() + r, n, i);
        return (s.start(r), s);
      }
      start(e) {
      ...
      cancel(e) {
        null !== this.timerHandle &&
          (this.clearTimeout(),
          this.deferred.reject(new e5(e6.CANCELLED, 'Operation cancelled' + (e ? ': ' + e : ''))));
      }
      handleDelayElapsed() {
      ...
      constructor(e, t, r, n, i) {
        ((this.asyncQueue = e),
          ...
          (this.deferred = new e8()),
          (this.then = this.deferred.promise.then.bind(this.deferred.promise)),
          this.deferred.promise.catch((e) => {}));
      }
    }
    function i2(e, t) {
      if ((e0('AsyncQueue', ''.concat(t, ': ').concat(e)), tw(e)))
        return new e5(e6.UNAVAILABLE, ''.concat(t, ': ').concat(e));
      throw e;
    }
    class i3 {
      static emptySet(e) {
        return new i3(e.comparator);
      }
      has(e) {
      ...
      isEqual(e) {
        if (!(e instanceof i3) || this.size !== e.size) return !1;
      ...
      constructor(e) {
        ((this.comparator = e
          ? (t, r) => e(t, r) || tp.comparator(t.key, r.key)
          : (e, t) => tp.comparator(e.key, t.key)),
          (this.keyedMap = rO()),
          (this.sortedSet = new tS(this.comparator)));
      }
    }
    class i6 {
      track(e) {
    ...
    class i5 {
      static fromInitialDocuments(e, t, r, n, i) {
        ...
        return (
          ...
          new i5(e, t, i3.emptySet(t), s, r, n, !0, !1, i)
        );
      }
      get hasPendingWrites() {
    ...
    class i4 {
      terminate() {
        ...
        })(this, new e5(e6.ABORTED, 'Firestore shutting down'));
      }
      constructor() {
        ((this.queries = i7()), (this.onlineState = 'Unknown'), (this.Y_ = new Set()));
      }
    }
    function i7() {
      return new rk((e) => rA(e), rC);
    }
    async function i9(e, t) {
      let r = 3,
        n = t.query,
        i = e.queries.get(n);
      i ? !i.H_() && t.J_() && (r = 2) : ((i = new i8()), (r = +!t.J_()));
      try {
        switch (r) {
          case 0:
            i.z_ = await e.onListen(n, !0);
            break;
          case 1:
            i.z_ = await e.onListen(n, !1);
            break;
          case 2:
            await e.onFirstRemoteStoreListen(n);
        }
      } catch (r) {
        let e = i2(r, "Initialization of query '".concat(rD(t.query), "' failed"));
        return void t.onError(e);
      }
      (e.queries.set(n, i), i.j_.push(t), t.Z_(e.onlineState), i.z_ && t.X_(i.z_) && sn(e));
    }
    async function se(e, t) {
      ...
      if (i) {
        ...
        e >= 0 &&
          (i.j_.splice(e, 1), 0 === i.j_.length ? (n = +!t.J_()) : !i.H_() && t.J_() && (n = 2));
      }
      switch (n) {
        case 0:
    ...
    function sr(e, t, r) {
      ...
      if (n) for (let e of n.j_) e.onError(r);
      e.queries.delete(t);
    }
    function sn(e) {
      e.Y_.forEach((e) => {
    ...
    (((y = m || (m = {})).ea = 'default'), (y.Cache = 'cache'));
    class si {
      X_(e) {
      ...
      J_() {
        return this.options.source !== m.Cache;
      }
      constructor(e, t, r) {
        ((this.query = e),
          (this.ta = t),
    ...
    class so {
      ...
      ma(e, t) {
        ...
        if (
          (e.inorderTraversal((e, t) => {
            let h = n.get(e),
              u = rx(this.query, t) ? t : null,
              c = !!h && this.mutatedKeys.has(h.key),
              f =
                !!u &&
            ...
            (h && u
              ? h.data.isEqual(u.data)
                ? c !== f && (r.track({ type: 3, doc: u }), (d = !0))
                : this.ga(h, u) ||
                  (r.track({ type: 2, doc: u }),
                  (d = !0),
                  ((o && this.Aa(u, o) > 0) || (l && 0 > this.Aa(u, l))) && (a = !0))
              : !h && u
                ? (r.track({ type: 0, doc: u }), (d = !0))
                : h && !u && (r.track({ type: 1, doc: h }), (d = !0), (o || l) && (a = !0)),
              d &&
                (u
                  ? ((s = s.add(u)), (i = f ? i.add(e) : i.delete(e)))
          ...
          for (; s.size > this.query.limit; ) {
            ...
            ((s = s.delete(e.key)), (i = i.delete(e.key)), r.track({ type: 1, doc: e }));
          }
        return { Ra: s, fa: r, ns: a, mutatedKeys: i };
      }
      ga(e, t) {
      ...
      applyChanges(e, t, r, n) {
        ...
        (s.sort(
          ...
          (n = null != n && n));
        let a = t && !n ? this.ya() : [],
          o = 0 === this.da.size && this.current && !n ? 1 : 0,
          l = o !== this.Ea;
      ...
      Z_(e) {
        return this.current && 'Offline' === e
          ? ((this.current = !1),
            this.applyChanges(
              { Ra: this.Ra, fa: new i6(), mutatedKeys: this.mutatedKeys, ns: !1 },
              !1,
            ))
          : { wa: [] };
      }
      ...
      ya() {
        ...
        return (
          e.forEach((e) => {
            this.da.has(e) || t.push(new sa(e));
          }),
          this.da.forEach((r) => {
            e.has(r) || t.push(new ss(r));
          }),
          t
        );
      }
      ba(e) {
        ((this.Ta = e.Ts), (this.da = rU()));
        let t = this.ma(e.documents);
        return this.applyChanges(t, !0);
      }
      Da() {
        return i5.fromInitialDocuments(
          this.query,
          this.Ra,
          this.mutatedKeys,
          0 === this.Ea,
    ...
    class su {
      ...
      constructor(e, t, r, n, i, s) {
        ((this.localStore = e),
          ...
          (this.Ca = {}),
          (this.Fa = new rk((e) => rA(e), rC)),
          (this.Ma = new Map()),
          (this.xa = new Set()),
          (this.Oa = new tS(tp.comparator)),
          (this.Na = new Map()),
          (this.La = new n1()),
          (this.Ba = {}),
          (this.ka = new Map()),
    ...
    async function sc(e, t) {
      ...
      return (
        s
          ? (i.sharedClientState.addLocalQueryTarget(s.targetId), (r = s.view.Da()))
          : (r = await sd(i, t, n, !0)),
        r
      );
    }
      ...
      let a,
        ...
        i.persistence
          .runTransaction('Allocate target', 'readwrite', (e) => {
            let t;
            return i.Ur.getTargetData(e, s).next((r) =>
              r
                ? ((t = r), tv.resolve(t))
                : i.Ur.allocateTargetId(e).next(
                    (r) => (
                      (t = new nq(s, r, 'TargetPurposeListen', e.currentSequenceNumber)),
                      i.Ur.addTargetData(e, t).next(() => t)
                    ),
                  ),
            );
          })
          .then((e) => {
            let t = i.os.get(e.targetId);
            return (
              (null === t || e.snapshotVersion.compareTo(t.snapshotVersion) > 0) &&
                ((i.os = i.os.insert(e.targetId, e)), i._s.set(s, e.targetId)),
              e
            );
          })),
        l = o.targetId,
        h = e.sharedClientState.addLocalQueryTarget(l, r);
      return (
        n && (a = await sp(e, t, l, 'current' === h, o.resumeToken)),
        e.isPrimaryClient && r && ik(e.remoteStore, o),
        a
      );
    }
    async function sp(e, t, r, n, i) {
      e.Ka = (t, r, n) =>
        (async function (e, t, r, n) {
          let i = t.view.ma(r);
          i.ns &&
            (i = await il(e.localStore, t.query, !1).then((e) => {
              let { documents: r } = e;
              return t.view.ma(r, i);
            }));
          ...
          return (sA(e, t.targetId, o.wa), o.snapshot);
        })(e, t, r, n);
      let s = await il(e.localStore, t, !0),
        a = new so(t, s.Ts),
        o = a.ma(s.documents),
        l = np.createSynthesizedTargetChangeForCurrentChange(
          r,
          n && 'Offline' !== e.onlineState,
          i,
        ),
        h = a.applyChanges(o, e.isPrimaryClient, l);
      sA(e, r, h.wa);
      let u = new sl(t, r, a);
      return (e.Fa.set(t, u), e.Ma.has(r) ? e.Ma.get(r).push(t) : e.Ma.set(r, [t]), h.snapshot);
    }
    async function sg(e, t, r) {
      let n = e.Fa.get(t),
        i = e.Ma.get(n.targetId);
      if (i.length > 1)
        return (
          e.Ma.set(
            n.targetId,
      ...
      e.isPrimaryClient
        ? (e.sharedClientState.removeLocalQueryTarget(n.targetId),
          e.sharedClientState.isActiveQueryTarget(n.targetId) ||
            (await io(e.localStore, n.targetId, !1)
              .then(() => {
                (e.sharedClientState.clearQueryState(n.targetId),
                  r && iR(e.remoteStore, n.targetId),
                  sS(e, n.targetId));
              })
              .catch(ty)))
        : (sS(e, n.targetId), await io(e.localStore, n.targetId, !0));
    }
    async function sm(e, t) {
      let r = e.Fa.get(t),
        n = e.Ma.get(r.targetId);
      e.isPrimaryClient &&
        1 === n.length &&
        (e.sharedClientState.removeLocalQueryTarget(r.targetId), iR(e.remoteStore, r.targetId));
    }
    async function sy(e, t, r) {
      var n, i;
      let s =
        (((n = e).remoteStore.remoteSyncer.applySuccessfulWrite = sE.bind(null, n)),
        (n.remoteStore.remoteSyncer.rejectFailedWrite = s_.bind(null, n)),
        n);
      try {
        let e,
          n = await (function (e, t) {
            ...
            return e.persistence
                      ...
                      let t = (function (e, t) {
                        ...
                        for (let n of e.fieldTransforms) {
                          let e = t.data.field(n.field),
                            i = rK(n.transform, e || null);
                          null != i && (null === r && (r = t5.empty()), r.set(n.field, i));
                        }
                        return r || null;
              ...
              .then(() => ({ batchId: n.batchId, changes: rM(r) }));
          })(s.localStore, t);
        (s.sharedClientState.addPendingMutation(n.batchId),
          (i = n.batchId),
          (e = s.Ba[s.currentUser.toKey()]) || (e = new tS(ta)),
          (e = e.insert(i, r)),
          (s.Ba[s.currentUser.toKey()] = e),
          await sx(s, n.changes),
          await iK(s.remoteStore));
      } catch (t) {
        let e = i2(t, 'Failed to persist write');
        r.reject(e);
      }
    }
        ...
        let r = await (function (e, t) {
          ...
          return e.persistence
            .runTransaction('Apply remote event', 'readwrite-primary', (i) => {
              ...
              let l,
                h,
                u = e.cs.newChangeBuffer({ trackRemovals: !0 });
              n = e.os;
              let c = [];
              t.targetChanges.forEach((s, a) => {
                ...
                if (!l) return;
                c.push(
                  e.Ur.removeMatchingKeys(i, s.removedDocuments, a).next(() =>
                    e.Ur.addMatchingKeys(i, s.addedDocuments, a),
                  ),
                );
                let h = l.withSequenceNumber(i.currentSequenceNumber);
                (null !== t.targetMismatches.get(a)
                  ? (h = h
                      .withResumeToken(tR.EMPTY_BYTE_STRING, th.min())
                      .withLastLimboFreeSnapshotVersion(th.min()))
                  : s.resumeToken.approximateByteSize() > 0 &&
                    (h = h.withResumeToken(s.resumeToken, r)),
                  (n = n.insert(a, h)),
                  (o = h),
                  (0 === l.resumeToken.approximateByteSize() ||
                    o.snapshotVersion.toMicroseconds() - l.snapshotVersion.toMicroseconds() >=
                      3e8 ||
                    s.addedDocuments.size + s.modifiedDocuments.size + s.removedDocuments.size >
                      0) &&
                    c.push(e.Ur.updateTargetData(i, h)));
              });
              let f = rR,
                d = rU();
              if (
                (t.documentUpdates.forEach((r) => {
                  t.resolvedLimboDocuments.has(r) &&
                    c.push(e.persistence.referenceDelegate.updateLimboDocument(i, r));
                }),
                c.push(
                  ((s = i),
                  (a = u),
                  ...
                  a.getEntries(s, l).next((e) => {
                    ...
                    return (
                      o.forEach((r, n) => {
                        let i = e.get(r);
                        (n.isFoundDocument() !== i.isFoundDocument() && (h = h.add(r)),
                          n.isNoDocument() && n.version.isEqual(th.min())
                            ? (a.removeEntry(r, n.readTime), (t = t.insert(r, n)))
                            : !i.isValidDocument() ||
                                n.version.compareTo(i.version) > 0 ||
                                (0 === n.version.compareTo(i.version) && i.hasPendingWrites)
                ...
                let t = e.Ur.getLastRemoteSnapshotVersion(i).next((t) =>
                  e.Ur.setTargetsMetadata(i, i.currentSequenceNumber, r),
                );
                c.push(t);
              }
              return tv
                .waitFor(c)
                .next(() => u.apply(i))
                .next(() => e.localDocuments.getLocalViewOfDocuments(i, f, d))
                .next(() => f);
            })
            .then((t) => ((e.os = n), t));
        })(e.localStore, t);
          ...
          n &&
            ...
            t.addedDocuments.size > 0
              ...
              : t.modifiedDocuments.size > 0
                ? n.va || e3()
                : t.removedDocuments.size > 0 && (n.va || e3(), (n.va = !1)));
        }),
          await sx(e, r, t));
      } catch (e) {
        await ty(e);
    ...
    async function sb(e, t, r) {
      ...
      let n = e.Na.get(t),
        i = n && n.key;
      if (i) {
        let r = new tS(tp.comparator);
        r = r.insert(i, t8.newNoDocument(i, th.min()));
        let n = rU().add(i),
          s = new nd(th.min(), new Map(), new tS(ta), r, n);
        (await sv(e, s), (e.Oa = e.Oa.remove(i)), e.Na.delete(t), sD(e));
      } else
        await io(e.localStore, t, !1)
          .then(() => sS(e, t, r))
          .catch(ty);
    }
    async function sE(e, t) {
      ...
      try {
        ...
        r.persistence.runTransaction('Acknowledge batch', 'readwrite-primary', (e) => {
          let n = t.batch.keys(),
            i = r.cs.newChangeBuffer({ trackRemovals: !0 });
          return (function (e, t, r, n) {
            let i = r.batch,
              s = i.keys(),
              a = tv.resolve();
                  ...
                  .next((t) => {
                    ...
                    (null !== s || e3(),
                      0 > t.version.compareTo(s) &&
                        ...
                        t.isValidDocument() && (t.setReadTime(r.commitVersion), n.addEntry(t))));
                  });
              }),
            ...
            .next(() => r.documentOverlayCache.removeOverlaysForBatchId(e, n, t.batch.batchId))
            .next(() =>
    ...
    function sI(e, t, r) {
      let n = e.Ba[e.currentUser.toKey()];
      if (n) {
        let i = n.get(t);
        (i && (r ? i.reject(r) : i.resolve(), (n = n.remove(t))),
          (e.Ba[e.currentUser.toKey()] = n));
      }
    }
    function sS(e, t) {
      let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
      for (let n of (e.sharedClientState.removeLocalQueryTarget(t), e.Ma.get(t)))
        (e.Fa.delete(n), r && e.Ca.$a(n, r));
      (e.Ma.delete(t),
        e.isPrimaryClient &&
          e.La.gr(t).forEach((t) => {
            e.La.containsKey(t) || sC(e, t);
          }));
    }
    function sC(e, t) {
      e.xa.delete(t.path.canonicalString());
      let r = e.Oa.get(t);
      null !== r && (iR(e.remoteStore, r), (e.Oa = e.Oa.remove(t)), e.Na.delete(r), sD(e));
    }
    function sA(e, t, r) {
      for (let n of r)
        n instanceof ss
          ? (e.La.addReference(n.key, t),
            (function (e, t) {
              let r = t.key,
                n = r.path.canonicalString();
              e.Oa.get(r) ||
                e.xa.has(n) ||
                (eZ('SyncEngine', 'New document in limbo: ' + r), e.xa.add(n), sD(e));
            })(e, n))
          : n instanceof sa
            ? (eZ('SyncEngine', 'Document no longer in limbo: ' + n.key),
              e.La.removeReference(n.key, t),
              e.La.containsKey(n.key) || sC(e, n.key))
            : e3();
    }
    function sD(e) {
      for (; e.xa.size > 0 && e.Oa.size < e.maxConcurrentLimboResolutions; ) {
        ...
        e.xa.delete(t);
        let r = new tp(tc.fromString(t)),
          n = e.qa.next();
        (e.Na.set(n, new sh(r)),
          (e.Oa = e.Oa.insert(r, n)),
          ik(e.remoteStore, new nq(rT(new rw(r.path)), n, 'TargetPurposeLimboResolution', tb.oe)));
      }
    }
    async function sx(e, t, r) {
      ...
      e.Fa.isEmpty() ||
          ...
          s.push(
            e.Ka(o, t, r).then((t) => {
              ...
              if ((t || r) && e.isPrimaryClient) {
                let n = t
                  ? !t.fromCache
                  : null == (s = null == r ? void 0 : r.targetChanges.get(o.targetId))
                    ? void 0
                    : s.current;
        ...
        await (async function (e, t) {
          try {
            await e.persistence.runTransaction('notifyLocalViewChanges', 'readwrite', (r) =>
              tv.forEach(t, (t) =>
                tv
                  .forEach(t.$i, (n) =>
                    e.persistence.referenceDelegate.addReference(r, t.targetId, n),
                  )
                  .next(() =>
                    tv.forEach(t.Ui, (n) =>
                      e.persistence.referenceDelegate.removeReference(r, t.targetId, n),
                    ),
                  ),
              ),
            );
            ...
            if (!tw(e)) throw e;
            eZ('LocalStore', 'Failed to update sequence numbers: ' + e);
          }
          for (let r of t) {
            let t = r.targetId;
            if (!r.fromCache) {
    ...
    async function sN(e, t) {
      if (!e.currentUser.isEqual(t)) {
        eZ('SyncEngine', 'User change. New user:', t.toKey());
        let r = await is(e.localStore, t);
        ((e.currentUser = t),
          e.ka.forEach((e) => {
            e.forEach((e) => {
              e.reject(
    ...
    function sR(e) {
      return (
        (e.remoteStore.remoteSyncer.applyRemoteEvent = sv.bind(null, e)),
        (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = sk.bind(null, e)),
        (e.remoteStore.remoteSyncer.rejectListen = sb.bind(null, e)),
        (e.Ca.d_ = st.bind(null, e.eventManager)),
        (e.Ca.$a = sr.bind(null, e.eventManager)),
        e
      );
    }
    class sL {
      async initialize(e) {
        ((this.serializer = iE(e.databaseInfo.databaseId)),
      ...
      za(e) {
        ...
        return (
          (t = this.persistence),
          (r = new ir()),
          new ii(t, r, e.initialUser, this.serializer)
        );
      }
      Ga(e) {
        return new n4(n9.Zr, this.serializer);
      }
      Wa(e) {
        return new iu();
      }
    ...
    class sO {
      async initialize(e, t) {
        this.localStore ||
          ...
          (this.sharedClientState.onlineStateHandler = (e) => sw(this.syncEngine, e, 1)),
          (this.remoteStore.remoteSyncer.handleCredentialChange = sN.bind(null, this.syncEngine)),
          await i$(this.remoteStore, this.syncEngine.isPrimaryClient));
      }
      ...
      createDatastore(e) {
        var t;
        let r = iE(e.databaseInfo.databaseId),
          n = new iw(e.databaseInfo);
        return ((t = e.authCredentials), new iC(t, e.appCheckCredentials, n, r));
      }
      createRemoteStore(e) {
        var t, r;
        return (
          (t = this.localStore),
          (r = this.datastore),
          new iD(t, r, e.asyncQueue, (e) => sw(this.syncEngine, e, 0), id.D() ? new id() : new ic())
        );
      }
      createSyncEngine(e, t) {
        return (function (e, t, r, n, i, s, a) {
          let o = new su(e, t, r, n, i, s);
          return (a && (o.Qa = !0), o);
        })(
          this.localStore,
          this.remoteStore,
      ...
      async terminate() {
        var e, t;
        (await (async function (e) {
          (eZ('RemoteStore', 'RemoteStore shutting down.'),
            e.L_.add(5),
            await iN(e),
            e.k_.shutdown(),
            e.q_.set('Unknown'));
      ...
      error(e) {
        this.muted ||
          (this.observer.error
            ...
            : e0('Uncaught Error in snapshot listener:', e.toString()));
      }
      Za() {
        this.muted = !0;
      }
        ...
        return (
          this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
            try {
              ...
              let t = i2(r, 'Failed to shutdown persistence');
              e.reject(t);
            }
          }),
          e.promise
      ...
      constructor(e, t, r, n, i) {
        ((this.authCredentials = e),
          ...
          this.appCheckCredentials.start(
            r,
            (e) => (
              eZ('FirestoreClient', 'Received new app check token=', e),
    ...
    async function sV(e, t) {
      (e.asyncQueue.verifyOperationInProgress(),
        eZ('FirestoreClient', 'Initializing OfflineComponentProvider'));
      let r = e.configuration;
      await t.initialize(r);
      let n = r.initialUser;
      (e.setCredentialChangeListener(async (e) => {
        n.isEqual(e) || (await is(t.localStore, e), (n = e));
      }),
    ...
    async function sF(e, t) {
      e.asyncQueue.verifyOperationInProgress();
      let r = await sU(e);
      (eZ('FirestoreClient', 'Initializing OnlineComponentProvider'),
        await t.initialize(r, e.configuration),
        e.setCredentialChangeListener((e) => iJ(t.remoteStore, e)),
        e.setAppCheckTokenChangeListener((e, r) => iJ(t.remoteStore, r)),
        (e._onlineComponents = t));
    }
    async function sU(e) {
      if (!e._offlineComponents)
        if (e._uninitializedComponentsProvider) {
          eZ('FirestoreClient', 'Using user provided OfflineComponentProvider');
          try {
            await sV(e, e._uninitializedComponentsProvider._offline);
          } catch (t) {
            if (
              !('FirebaseError' === t.name
                ? t.code === e6.FAILED_PRECONDITION || t.code === e6.UNIMPLEMENTED
              ...
              throw t;
            (e1('Error using user provided cache. Falling back to memory cache: ' + t),
              await sV(e, new sL()));
          }
        } else
          (eZ('FirestoreClient', 'Using default OfflineComponentProvider'), await sV(e, new sL()));
      ...
      return (
        e._onlineComponents ||
          (e._uninitializedComponentsProvider
            ? (eZ('FirestoreClient', 'Using user provided OnlineComponentProvider'),
              await sF(e, e._uninitializedComponentsProvider._online))
            : (eZ('FirestoreClient', 'Using default OnlineComponentProvider'),
              await sF(e, new sO()))),
        e._onlineComponents
      );
    }
    async function sj(e) {
      let t = await sB(e),
        r = t.eventManager;
      return (
        (r.onListen = sc.bind(null, t.syncEngine)),
        (r.onUnlisten = sg.bind(null, t.syncEngine)),
        (r.onFirstRemoteStoreListen = sf.bind(null, t.syncEngine)),
        (r.onLastRemoteStoreUnlisten = sm.bind(null, t.syncEngine)),
        r
      );
    }
    function sq(e) {
    ...
    function sK(e, t, r) {
      if (!r)
        throw new e5(
          e6.INVALID_ARGUMENT,
          'Function '.concat(e, '() cannot be called with an empty ').concat(t, '.'),
        );
    }
    function sG(e) {
      if (!tp.isDocumentKey(e))
        throw new e5(
          e6.INVALID_ARGUMENT,
    ...
    function sQ(e) {
      ...
      if (null === e) return 'null';
      if ('string' == typeof e)
        return (e.length > 20 && (e = ''.concat(e.substring(0, 20), '...')), JSON.stringify(e));
      ...
      if ('object' == typeof e) {
        if (e instanceof Array) return 'an array';
        {
          ...
          return r ? 'a custom '.concat(r, ' object') : 'an object';
        }
      }
      return 'function' == typeof e ? 'a function' : e3();
    }
    function sW(e, t) {
      if (('_delegate' in e && (e = e._delegate), !(e instanceof t))) {
          ...
          );
        {
          ...
          throw new e5(
            e6.INVALID_ARGUMENT,
            "Expected type '".concat(t.name, "', but it was: ").concat(r),
          );
        }
      }
      return e;
    ...
    class sX {
      ...
      constructor(e) {
        ...
        if (void 0 === e.host) {
          if (void 0 !== e.ssl)
            throw new e5(e6.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        if (
          ...
          if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576)
            throw new e5(e6.INVALID_ARGUMENT, 'cacheSizeBytes must be at least 1048576');
          this.cacheSizeBytes = e.cacheSizeBytes;
        }
        ((function (e, t, r, n) {
          if (!0 === t && !0 === n)
            throw new e5(
              e6.INVALID_ARGUMENT,
              ''.concat(e, ' and ').concat(r, ' cannot be used together.'),
            );
        })(
          ...
          this.experimentalForceLongPolling
            ...
            : void 0 === e.experimentalAutoDetectLongPolling
              ...
              : (this.experimentalAutoDetectLongPolling = !!e.experimentalAutoDetectLongPolling),
          (this.experimentalLongPollingOptions = sq(
          ...
          (function (e) {
            if (void 0 !== e.timeoutSeconds) {
              ...
              if (e.timeoutSeconds < 5)
                throw new e5(
                  e6.INVALID_ARGUMENT,
                  'invalid long polling timeout: '.concat(
                    e.timeoutSeconds,
    ...
    class sY {
      ...
      _delete() {
        return (
          'notTerminated' === this._terminateTask && (this._terminateTask = this._terminate()),
          this._terminateTask
        );
      }
      async _restart() {
      ...
      _terminate() {
        return (
          (function (e) {
            let t = sz.get(e);
            t && (eZ('ComponentProvider', 'Removing Datastore'), sz.delete(e), t.terminate());
          })(this),
          Promise.resolve()
        );
      }
    ...
    class sJ {
      withConverter(e) {
        return new sJ(this.firestore, e, this._query);
      }
      constructor(e, t, r) {
    ...
    class s$ {
      ...
      get parent() {
        return new sZ(this.firestore, this.converter, this._key.path.popLast());
      }
      withConverter(e) {
        return new s$(this.firestore, e, this._key);
      }
      constructor(e, t, r) {
    ...
    class sZ extends sJ {
      ...
      get parent() {
        ...
        return e.isEmpty() ? null : new s$(this.firestore, null, new tp(e));
      }
      withConverter(e) {
        return new sZ(this.firestore, e, this._path);
      }
      constructor(e, t, r) {
        (super(e, t, new rw(r)), (this._path = r), (this.type = 'collection'));
      }
    }
    function s0(e, t) {
      for (var r = arguments.length, n = Array(r > 2 ? r - 2 : 0), i = 2; i < r; i++)
        n[i - 2] = arguments[i];
      if (((e = M(e)), sK('collection', 'path', t), e instanceof sY)) {
        let r = tc.fromString(t, ...n);
        return (sH(r), new sZ(e, null, r));
      }
      {
        if (!(e instanceof s$ || e instanceof sZ))
          throw new e5(
            e6.INVALID_ARGUMENT,
            'Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore',
          );
        let r = e._path.child(tc.fromString(t, ...n));
        return (sH(r), new sZ(e.firestore, null, r));
      }
    }
    class s1 {
      get isShuttingDown() {
      ...
      async pu() {
        if (0 !== this.Pu.length) {
          try {
            ...
            if (!tw(e)) throw e;
            eZ('AsyncQueue', 'Operation failed with retryable error: ' + e);
          }
      ...
      enqueueAfterDelay(e, t, r) {
        ...
        let n = i1.createAndSchedule(this, e, t, r, (e) => this.yu(e));
      ...
      bu(e) {
        return this.wu().then(() => {
          for (let t of (this.Tu.sort((e, t) => e.targetTimeMs - t.targetTimeMs), this.Tu))
      ...
      constructor(e = Promise.resolve()) {
        ((this.Pu = []),
          ...
          (this.Au = !1),
          (this.Ru = []),
          (this.t_ = new i_(this, 'async_queue_retry')),
          (this.Vu = () => {
            let e = ib();
            (e && eZ('AsyncQueue', 'Visibility state changed to ' + e.visibilityState),
              this.t_.jo());
          }),
          (this.mu = e));
        let t = ib();
    ...
    class s2 extends sY {
      async _terminate() {
        if (this._firestoreClient) {
          ...
          ((this._queue = new s1(e)), (this._firestoreClient = void 0), await e);
        }
      }
      constructor(e, t, r, n) {
        (super(e, t, r, n),
            ...
            let a = e._freezeSettings(),
              o =
                ...
                new tB(
                  ...
                  sq(a.experimentalLongPollingOptions),
                  a.useFetchStreams,
                ));
            (e._componentsProvider ||
              ((null == (r = a.localCache) ? void 0 : r._offlineComponentProvider) &&
                (null == (n = a.localCache) ? void 0 : n._onlineComponentProvider) &&
                (e._componentsProvider = {
                  _offline: a.localCache._offlineComponentProvider,
                  _online: a.localCache._onlineComponentProvider,
                })),
              (e._firestoreClient = new sP(
                e._authCredentials,
    ...
    class s6 {
      static fromBase64String(e) {
        try {
          return new s6(tR.fromBase64String(e));
        } catch (e) {
          throw new e5(e6.INVALID_ARGUMENT, 'Failed to construct data from Base64 string: ' + e);
        }
      }
      static fromUint8Array(e) {
        return new s6(tR.fromUint8Array(e));
      }
      toBase64() {
    ...
    class s4 {
      ...
      _compareTo(e) {
        return ta(this._lat, e._lat) || ta(this._long, e._long);
      }
      constructor(e, t) {
    ...
    class ae {
      toMutation(e, t) {
        return null !== this.fieldMask
          ? new r4(e, this.data, this.fieldMask, t, this.fieldTransforms)
          : new r8(e, this.data, t, this.fieldTransforms);
      }
      constructor(e, t, r) {
    ...
    class ar {
      ...
      Bu(e) {
        return ac(e, this.settings.methodName, this.settings.ku || !1, this.path, this.settings.qu);
      }
      contains(e) {
        return (
    ...
    class an {
      Qu(e, t, r) {
        ...
        return new ar(
          { Cu: e, methodName: t, qu: r, path: td.emptyPath(), xu: !1, ku: n },
          this.databaseId,
          this.serializer,
          this.ignoreUndefinedProperties,
        );
      ...
      constructor(e, t, r) {
        ((this.databaseId = e),
          ...
          (this.serializer = r || iE(e)));
      }
    }
    function ai(e) {
      let t = e._freezeSettings(),
        r = iE(e._databaseId);
      return new an(e._databaseId, !!t.ignoreUndefinedProperties, r);
    }
    function as(e, t) {
      if (ao((e = M(e)))) return (al('Unsupported field value:', t, e), aa(e, t));
      if (e instanceof s8)
        return (
          (function (e, t) {
            if (!at(t.Cu))
              throw t.Bu(''.concat(e._methodName, '() can only be used with update() and set()'));
            if (!t.path)
              throw t.Bu(''.concat(e._methodName, '() is not currently supported inside arrays'));
      ...
      return (function (e, t) {
        var r, n, i;
        if (null === (e = M(e))) return { nullValue: 'NULL_VALUE' };
        if ('number' == typeof e)
          return (
            (r = t.serializer),
            'number' == typeof (i = n = e) &&
        ...
        if (e instanceof Date) {
          let r = tl.fromDate(e);
          return { timestampValue: nA(t.serializer, r) };
        }
        if (e instanceof tl) {
          let r = new tl(e.seconds, 1e3 * Math.floor(e.nanoseconds / 1e3));
          return { timestampValue: nA(t.serializer, r) };
        }
        if (e instanceof s4)
          return { geoPointValue: { latitude: e.latitude, longitude: e.longitude } };
        if (e instanceof s6) return { bytesValue: nD(t.serializer, e._byteString) };
        if (e instanceof s$) {
          let r = t.databaseId,
          ...
          if (!n.isEqual(r))
            throw t.Bu(
              'Document reference is for database '
                .concat(n.projectId, '/')
                .concat(n.database, ' but should be for database ')
                .concat(r.projectId, '/')
                .concat(r.database),
            );
          return { referenceValue: nN(e.firestore._databaseId || t.databaseId, e._key.path) };
        }
        if (e instanceof s7)
          return {
            mapValue: {
        ...
        throw t.Bu('Unsupported field value: '.concat(sQ(e)));
      })(e, t);
    }
    function aa(e, t) {
      let r = {};
    ...
    function al(e, t, r) {
      if (
        ...
        'object' != typeof r ||
        null === r ||
        (Object.getPrototypeOf(r) !== Object.prototype && null !== Object.getPrototypeOf(r))
      ) {
        let n = sQ(r);
        throw 'an object' === n ? t.Bu(e + ' a custom object') : t.Bu(e + ' ' + n);
      }
    }
    let ah = RegExp('[~\\*/\\[\\]]');
    function au(e, t, r) {
      if (t.search(ah) >= 0)
        throw ac(
          'Invalid field path ('.concat(t, "). Paths must not contain '~', '*', '/', '[', or ']'"),
          e,
          !1,
          void 0,
          r,
      ...
      try {
        return new s5(...t.split('.'))._internalPath;
      } catch (n) {
        throw ac(
          'Invalid field path ('.concat(
            t,
    ...
    function ac(e, t, r, n, i) {
      ...
      return (
        (s || a) &&
          ((l += ' (found'),
          s && (l += ' in field '.concat(n)),
          a && (l += ' in document '.concat(i)),
          (l += ')')),
        new e5(e6.INVALID_ARGUMENT, o + e + l)
      );
    }
    class af {
      get id() {
      ...
      get ref() {
        return new s$(this._firestore, this._converter, this._key);
      }
      exists() {
      ...
      data() {
        if (this._document) {
          if (this._converter) {
            let e = new ad(this._firestore, this._userDataWriter, this._key, this._document, null);
      ...
      get(e) {
        if (this._document) {
          let t = this._document.data.field(ap('DocumentSnapshot.get', e));
    ...
    class ay extends am {
      ...
      _apply(e) {
        let t = this._parse(e);
        return (aE(e._query, t), new sJ(e.firestore, e.converter, rI(e._query, t)));
      }
      _parse(e) {
        let t = ai(e.firestore);
        return (function (e, t, r, n, i, s, a) {
          let o;
          if (i.isKeyField()) {
            if ('array-contains' === s || 'array-contains-any' === s)
              throw new e5(
                e6.INVALID_ARGUMENT,
                "Invalid Query. You can't perform '".concat(s, "' queries on documentId()."),
              );
            if ('in' === s || 'not-in' === s) {
              ab(a, s);
              let t = [];
              for (let r of a) t.push(aw(n, e, r));
              o = { arrayValue: { values: t } };
            } else o = aw(n, e, a);
          } else
            (('in' !== s && 'not-in' !== s && 'array-contains-any' !== s) || ab(a, s),
              (o = (function (e, t, r) {
                let n = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
                return as(r, e.Qu(n ? 4 : 3, t));
              })(r, t, a, 'in' === s || 'not-in' === s)));
          return rr.create(i, s, o);
    ...
    class av extends ag {
      ...
      _parse(e) {
        ...
        return 1 === t.length ? t[0] : rn.create(t, this._getOperator());
      }
      _apply(e) {
        let t = this._parse(e);
        return 0 === t.getFilters().length
          ...
          : ((function (e, t) {
              let r = e;
              for (let e of t.getFlattenedFilters()) (aE(r, e), (r = rI(r, e)));
            })(e._query, t),
            new sJ(e.firestore, e.converter, rI(e._query, t)));
      }
    ...
    function aw(e, t, r) {
      if ('string' == typeof (r = M(r))) {
        ...
        let n = t.path.child(tc.fromString(r));
        if (!tp.isDocumentKey(n))
          throw new e5(
            e6.INVALID_ARGUMENT,
            "Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '"
              .concat(n, "' is not because it has an odd number of segments (")
              .concat(n.length, ').'),
          );
        return tY(e, new tp(n));
      }
      if (r instanceof s$) return tY(e, r._key);
      throw new e5(
        e6.INVALID_ARGUMENT,
    ...
    function aE(e, t) {
      let r = (function (e, t) {
        for (let r of e)
          for (let e of r.getFlattenedFilters()) if (t.indexOf(e.op) >= 0) return e.op;
        return null;
      })(
        e.filters,
        (function (e) {
      ...
      if (null !== r)
        throw r === t.op
          ? new e5(
              e6.INVALID_ARGUMENT,
              "Invalid query. You cannot use more than one '".concat(t.op.toString(), "' filter."),
            )
          : new e5(
              e6.INVALID_ARGUMENT,
              "Invalid query. You cannot use '"
                .concat(t.op.toString(), "' filters with '")
                .concat(r.toString(), "' filters."),
            );
    }
    class a_ {
      convertValue(e) {
        ...
        switch (tz(e)) {
          ...
          case 6:
            return this.convertBytes(tP(e.bytesValue));
          case 7:
      ...
      convertVectorValue(e) {
        ...
        return new s7(
          null ==
          (n =
            null == (r = null == (t = e.fields) ? void 0 : t.value.arrayValue) ? void 0 : r.values)
            ? void 0
            : n.map((e) => tM(e.doubleValue)),
        );
      }
      convertGeoPoint(e) {
        return new s4(tM(e.latitude), tM(e.longitude));
      }
      convertArray(e, t) {
      ...
      convertDocumentKey(e, t) {
        let r = tc.fromString(e);
        nj(r) || e3();
        let n = new tj(r.get(1), r.get(3)),
          i = new tp(r.popFirst(5));
        return (
          n.isEqual(t) ||
            e0(
              'Document '
    ...
    class aI extends af {
      ...
      get(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (this._document) {
          let r = this._document.data.field(ap('DocumentSnapshot.get', e));
          if (null !== r) return this._userDataWriter.convertValue(r, t.serverTimestamps);
        }
      }
      constructor(e, t, r, n, i, s) {
        (super(e, t, r, n, s),
    ...
    class aC {
        ...
        this._snapshot.docs.forEach((r) => {
          e.call(
            ...
            new aS(
              ...
              r.key,
              r,
              new aT(this._snapshot.mutatedKeys.has(r.key), this._snapshot.fromCache),
              ...
              if (e._snapshot.oldDocs.isEmpty()) {
                ...
                return e._snapshot.docChanges.map((r) => {
                  let n = new aS(
                    ...
                    r.doc.key,
                    r.doc,
                    new aT(e._snapshot.mutatedKeys.has(r.doc.key), e._snapshot.fromCache),
                    e.query.converter,
                  );
                  return (r.doc, { type: 'added', doc: n, oldIndex: -1, newIndex: t++ });
                });
              }
              {
                ...
                return e._snapshot.docChanges
                  ...
                  .map((t) => {
                    let n = new aS(
                        ...
                        t.doc.key,
                        t.doc,
                        new aT(e._snapshot.mutatedKeys.has(t.doc.key), e._snapshot.fromCache),
                        e.query.converter,
                      ),
                      i = -1,
                      s = -1;
                    return (
                      0 !== t.type && ((i = r.indexOf(t.doc.key)), (r = r.delete(t.doc.key))),
      ...
      constructor(e, t, r, n) {
        ((this._firestore = e),
          (this._userDataWriter = t),
          (this._snapshot = n),
          (this.metadata = new aT(n.hasPendingWrites, n.fromCache)),
          (this.query = r));
      }
    }
    class aA extends a_ {
      ...
      convertReference(e) {
        ...
        return new s$(this.firestore, null, t);
      }
      constructor(e) {
    ...
    function aD(e, t) {
      var r;
      let n = sW(e.firestore, s2),
        i = (function (e, t) {
          for (var r = arguments.length, n = Array(r > 2 ? r - 2 : 0), i = 2; i < r; i++)
            n[i - 2] = arguments[i];
          if (
            ((e = M(e)),
            1 == arguments.length && (t = ts.newId()),
            sK('doc', 'path', t),
            e instanceof sY)
          ) {
            let r = tc.fromString(t, ...n);
            return (sG(r), new s$(e, null, new tp(r)));
          }
          {
            if (!(e instanceof s$ || e instanceof sZ))
              throw new e5(
            ...
            let r = e._path.child(tc.fromString(t, ...n));
            return (sG(r), new s$(e.firestore, e instanceof sZ ? e.converter : null, new tp(r)));
          }
        })(e),
      ...
      return (function (e, t) {
        ...
        return (
          r.asyncQueue.enqueueAndForget(async () =>
            sy(await sB(r).then((e) => e.syncEngine), t, n),
          ),
          n.promise
        );
      })(n, [
        (function (e, t, r, n, i) {
          let s,
            ...
            l = e.Qu(o.merge || o.mergeFields ? 2 : 0, t, r, i);
          al('Data must be an object, but it was:', l, n);
          let h = aa(n, l);
          if (o.merge) ((s = new tN(l.fieldMask)), (a = l.fieldTransforms));
          else if (o.mergeFields) {
            let e = [];
            for (let n of o.mergeFields) {
              let i = (function (e, t, r) {
                if ((t = M(t)) instanceof s5) return t._internalPath;
                if ('string' == typeof t) return au(e, t);
                throw ac('Field path arguments must be of type string or ', e, !1, void 0, r);
              })(t, n, r);
              if (!l.contains(i))
                throw new e5(
                  e6.INVALID_ARGUMENT,
            ...
            ((s = new tN(e)), (a = l.fieldTransforms.filter((e) => s.covers(e.field))));
          } else ((s = null), (a = l.fieldTransforms));
          return new ae(new t5(h), s, a);
        })(ai(e.firestore), 'addDoc', i._key, s, null !== e.converter, {}).toMutation(
          i._key,
          r0.exists(!1),
        ),
      ]).then(() => i);
        ...
        ((eY = eI),
          eg(
            new P(
              'firestore',
              (e, r) => {
                let { instanceIdentifier: n, options: i } = r,
                  s = e.getProvider('app').getImmediate(),
                  a = new s2(
                    new te(e.getProvider('auth-internal')),
                    new ti(e.getProvider('app-check-internal')),
                    (function (e, t) {
                      ...
                      return new tj(e.options.projectId, t);
                    })(s, n),
                    s,
                  );
    ...
    let ax = (function (e, t) {
        let r = em('object' == typeof e ? e : eA(), 'firestore').getImmediate({
          identifier: 'string' == typeof e ? e : '(default)',
        });
        if (!r._initialized) {
          let e = ((e) => {
            var t, r, n;
            let i =
              ((t = e), null == (n = null == (r = C()) ? void 0 : r.emulatorHosts) ? void 0 : n[t]);
            if (!i) return;
            let s = i.lastIndexOf(':');
            if (s <= 0 || s + 1 === i.length)
              throw Error('Invalid host '.concat(i, ' with no separate hostname and port!'));
            let a = parseInt(i.substring(s + 1), 10);
            return '[' === i[0] ? [i.substring(1, s - 1), a] : [i.substring(0, s), a];
          })('firestore');
          e &&
            (function (e, t, r) {
              var n;
              let i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                s = (e = sW(e, sY))._getSettings(),
                a = ''.concat(t, ':').concat(r);
              if (
                ...
                let t, r;
                if ('string' == typeof i.mockUserToken) ((t = i.mockUserToken), (r = eX.MOCK_USER));
                else {
                  t = (function (e, t) {
                    if (e.uid)
                      throw Error(
                    ...
                    let s = Object.assign(
                      {
                        iss: 'https://securetoken.google.com/'.concat(r),
                        aud: r,
                        iat: n,
                        exp: n + 3600,
                        auth_time: n,
                  ...
                  })(i.mockUserToken, null == (n = e._app) ? void 0 : n.options.projectId);
                  let s = i.mockUserToken.sub || i.mockUserToken.user_id;
                  if (!s)
                    throw new e5(
                      e6.INVALID_ARGUMENT,
                ...
                e._authCredentials = new e9(new e4(t, r));
              }
            })(r, ...e);
        }
        return r;
        ...
        eS({
          apiKey: 'AIzaSyDE6M33cqflIgyVaCpk4cMxxCiJX-rpeGo',
          authDomain: 'serenity-plus.firebaseapp.com',
          projectId: 'serenity-plus',
          storageBucket: 'serenity-plus.firebasestorage.app',
          messagingSenderId: '507577790139',
          appId: '1:507577790139:web:4fe33a001019a28269039e',
          measurementId: 'G-C1S7Q0427E',
        }),
      ),
      aN = async (e) => {
        try {
          let t = new Date(),
            r = await aD(s0(ax, 'users'), { ...e, createdAt: t, updatedAt: t });
          return (console.log('User created with ID:', r.id), r.id);
        } catch (e) {
      ...
      ak = async (e) => {
        try {
          let t = new Date(),
            r = await aD(s0(ax, 'partnerships'), { ...e, createdAt: t, updatedAt: t });
          return (console.log('Partnership created with ID:', r.id), r.id);
        } catch (e) {
          throw (console.error('Error creating partnership:', e), e);
        }
      },
      aR = async (e) => {
        try {
          let t = (function (e, t) {
              for (var r = arguments.length, n = Array(r > 2 ? r - 2 : 0), i = 2; i < r; i++)
                n[i - 2] = arguments[i];
              let s = [];
              for (let r of (t instanceof ag && s.push(t),
              (function (e) {
                let t = e.filter((e) => e instanceof av).length,
                  r = e.filter((e) => e instanceof ay).length;
                if (t > 1 || (t > 0 && r > 0))
                  throw new e5(
                    e6.INVALID_ARGUMENT,
              ...
              (function (e, t, r) {
                let n = ap('where', e);
                return ay._create(n, '==', r);
              })('userId', 0, e),
            ),
            r = await (function (e) {
              e = sW(e, sJ);
              let t = sW(e.firestore, s2),
                r = s3(t),
                n = new aA(t);
              return (
                (function (e) {
                    ...
                    e.asyncQueue.enqueueAndForget(async () =>
                      (function (e, t, r, n, i) {
                        let s = new sM({
                            next: (r) => {
                              (s.Za(),
                                t.enqueueAndForget(() => se(e, a)),
                                r.fromCache && 'server' === n.source
                                  ? i.reject(
                                      new e5(
                                        e6.UNAVAILABLE,
                          ...
                          a = new si(r, s, { includeMetadataChanges: !0, _a: !0 });
                        return i9(e, a);
                      })(await sj(e), e.asyncQueue, t, r, n),
                    ),
                    n.promise
                  );
                })(r, e._query).then((r) => new aC(t, n, e, r))
              );
            })(t),
            n = [];
          return (
          ...
          return (console.error('Error getting user partnerships:', e), []);
        }
      },
      aL = async (e, t) => {
        try {
          console.log('Creating partnerships for user:', e, 'with invite code:', t);
          let r = [];
          if (t) {
            let n = JSON.parse(localStorage.getItem('allUsers') || '[]').find(
              (e) => e.inviteCode === t,
            );
            if (n)
              if (
                (console.log('Found inviter user: '.concat(n.name, ' (').concat(n.id, ')')),
                (await aR(e)).some((e) => e.partnerId === n.id))
              )
                console.log('Partnership with inviter '.concat(n.name, ' already exists'));
              else {
                console.log('Creating partnership with inviter: '.concat(n.name));
                let t = {
                    userId: e,
                    partnerId: n.id,
                    partnerName: n.name,
                    partnerEmail: n.email,
                    partnerImage: n.image,
                    partnerWeeklyTarget: n.weeklyTarget,
                    userSits: 0,
                    partnerSits: 0,
                    weeklyGoal: n.weeklyTarget,
                    score: 0,
                    currentWeekStart: new Date(),
                  },
                  i = await ak(t),
                  s = { id: i, ...t };
                (r.push(s), console.log('Partnership created with inviter: '.concat(i)));
              }
            else console.log('No inviter found for invite code: '.concat(t));
          } else console.log('No invite code provided, no partnerships to create');
          return (console.log('Final partnerships created:', r), r);
        } catch (e) {
          return (console.error('Error creating partnerships for user:', e), []);
        }
      };
  },
]);
