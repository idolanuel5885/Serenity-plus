                ...
                switch (r) {
                  case 'then': {
                    ...
                    f.dynamicShouldError
                      ? (0, l.throwWithStaticGenerationBailoutErrorWithDynamicError)(f.route, e)
      ...
      if (t)
        switch (t.type) {
          ...
          case 'prerender-client':
            ...
            if (a) {
              for (let n in e)
                if (a.has(n)) return (0, s.makeHangingPromise)(t.renderSignal, r.route, '`params`');
            }
            break;
          case 'cache':
          case 'private-cache':
          ...
          if (o) {
            for (let i in e)
              if (o.has(i)) {
                ...
                if (o) return o;
                let i = new Proxy(
                  (0, s.makeHangingPromise)(c.renderSignal, a.route, '`params`'),
                  _,
                );
                return (P.set(n, i), i);
              }
