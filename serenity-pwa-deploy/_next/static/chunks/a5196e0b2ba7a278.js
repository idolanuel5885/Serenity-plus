  ...
  (e, t, r) => {
    ...
    function u(e) {
      ...
      return (
        ...
        a && '#' !== a[0] && (a = '#' + a),
        f && '?' !== f[0] && (f = '?' + f),
        '' + u + c + (i = i.replace(/[?#]/g, encodeURIComponent)) + (f = f.replace('#', '%23')) + a
      );
    }
    let i = [
      'auth',
    ...
    function g(e) {
      ...
      let w = u.default.useContext(a.AppRouterContext),
        ...
        { href: D, as: K } = u.default.useMemo(() => {
          let e = y(v);
          return { href: e, as: O ? y(O) : e };
        }, [v, O]);
      M && (n = u.default.Children.only(r));
      let B = M ? n && 'object' == typeof n && n.ref : L,
        z = u.default.useCallback(
          (e) => (
            null !== w && (P.current = (0, s.mountLinkInstance)(e, D, w, F, k, b)),
            () => {
              (P.current && ((0, s.unmountLinkForCurrentNavigation)(P.current), (P.current = null)),
        ...
        Q = {
          ...
          onMouseEnter(e) {
            (M || 'function' != typeof N || N(e),
              ...
              w && k && (0, s.onNavigationIntent)(e.currentTarget, !0 === U));
          },
      ...
      return (
        (0, c.isAbsoluteUrl)(K)
          ? (Q.href = K)
          : (M && !E && ('a' !== n.type || 'href' in n.props)) || (Q.href = (0, f.addBasePath)(K)),
        (i = M ? u.default.cloneElement(n, Q) : (0, o.jsx)('a', { ...I, ...Q, children: r })),
