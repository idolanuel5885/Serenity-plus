    ...
    function n() {
      ...
      return (
        (0, s.useEffect)(() => {
          ...
          e &&
            fetch('/api/invite?code='.concat(e))
              .then((e) => e.json())
              .then((e) => {
                e.success && l(e.invitation.inviter.name);
              })
              .catch(console.error);
        }, []),
        (0, t.jsxs)('div', {
            ...
            (0, t.jsxs)('div', {
              ...
              children: [
                (0, t.jsx)('h1', {
                  ...
                  children: 'How many times a week do you want to meditate?',
                }),
                (0, t.jsxs)('p', {
                  className: 'text-sm text-gray-600 mb-8',
                  children: [
                    'This will be your weekly commitment to yourself and to ',
                    r || 'your future meditation partner',
                  ],
                }),
                (0, t.jsxs)('form', {
                  onSubmit: (t) => {
                    (t.preventDefault(),
                      localStorage.setItem('weeklyTarget', e.toString()),
                      o.push('/meditation-length'));
                  },
                  className: 'space-y-6',
                  children: [
                    (0, t.jsx)('div', {
                      children: (0, t.jsx)('select', {
                        ...
                        children: [1, 2, 3, 4, 5, 6, 7].map((e) =>
                          (0, t.jsxs)(
                            ...
                            {
                              value: e,
                              children: [e, ' ', 1 === e ? 'time' : 'times', ' per week'],
                            },
                            e,
                          ),
                        ),
