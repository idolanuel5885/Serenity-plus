...
export default function LotusAnimation({ 
  ...
  // Update animation frame based on progress - only when progress changes significantly
  useEffect(() => {
  ...
  }, [progress, isActive, Math.floor(elapsed / 10) * 10]); // Only update every 10 seconds
