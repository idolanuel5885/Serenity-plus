    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Usual Sit Length */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Usual Sit Length</label>
            <select
              value={formData.usualSitLength}
              onChange={(e) =>
                setFormData({ ...formData, usualSitLength: parseInt(e.target.value) })
              }
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
          ...
          {/* Why I practice */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Why I practice</label>
            <textarea
